...
/** Hop Web (RAP) implementation of ContextDialogSvgFacade. */
public class ContextDialogSvgFacadeImpl extends ContextDialogSvgFacade {
  ...
  void registerInternal(Canvas canvas, ContextDialog dialog) {
    ContextDialogSvgRendererHandler.register(canvas, dialog);
  }

  @Override
  void unregisterInternal(Canvas canvas) {
    ContextDialogSvgRendererHandler.unregister(canvas);
  }

  @Override
  void renderAndPublishInternal(Canvas canvas, ContextDialog dialog) {
    ContextDialogSvgRendererHandler.renderAndPublish(canvas, dialog);
  }
}
