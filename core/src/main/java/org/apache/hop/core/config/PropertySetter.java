...
public class PropertySetter {
  ...
  public void setProperty( Object obj, String property, String value ) throws HopConfigException {
    String[] expression = value.split( ":" );
    Object val;

    if ( expression.length == 0 ) {
      throw new HopConfigException( "No value found for property ["
    ...
    try {
      ...
      throw new HopConfigException( e );
    }
