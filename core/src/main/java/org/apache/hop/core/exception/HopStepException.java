...
public class HopStepException extends HopPipelineException {
   ...
   */
  public HopStepException( String message ) {
    super( message );
  }
   ...
   */
  public HopStepException( Throwable cause ) {
    super( cause );
  }
   ...
   *                indicates that the cause is nonexistent or unknown.)
   */
  public HopStepException( String message, Throwable cause ) {
    super( message, cause );
  }
