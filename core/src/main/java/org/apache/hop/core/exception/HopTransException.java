 ...
 * @since 9-12-2004
 */
public class HopTransException extends HopException {
  public static final long serialVersionUID = 0x8D8EA0264F7A1C17L;

  /**
   * Constructs a new throwable with null as its detail message.
   */
  public HopTransException() {
    super();
  }
   ...
   */
  public HopTransException( String message ) {
    super( message );
  }
   ...
   */
  public HopTransException( Throwable cause ) {
    super( cause );
  }
   ...
   *                indicates that the cause is nonexistent or unknown.)
   */
  public HopTransException( String message, Throwable cause ) {
    super( message, cause );
  }
