...
public class HopJobException extends HopException {
   ...
   */
  public HopJobException( String message ) {
    super( message );
  }
   ...
   */
  public HopJobException( Throwable cause ) {
    super( cause );
  }
   ...
   *          indicates that the cause is nonexistent or unknown.)
   */
  public HopJobException( String message, Throwable cause ) {
    super( message, cause );
  }
