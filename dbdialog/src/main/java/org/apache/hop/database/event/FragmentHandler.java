...
public class FragmentHandler extends AbstractXulEventHandler {
  ...
  private String packagePath = "org/apache/hop/ui/database/";

  public FragmentHandler() {
  }

  public void loadDatabaseOptionsFragment( String fragmentUri ) throws XulException {
  ...
  public String getFragment( DatabaseInterface database, String dbName, String extension, String defaultFragment ) {
    String fragment;
