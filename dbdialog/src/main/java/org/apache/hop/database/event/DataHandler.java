...
package org.apache.hop.database.event;
...
import org.apache.hop.core.database.DatabaseConnectionPoolParameter;
...
import org.apache.hop.database.Messages;
...
public class DataHandler extends AbstractXulEventHandler {
  ...
  public DatabaseMeta cache = new DatabaseMeta();
  ...
  public XulTextbox hostNameBox;

  protected XulTextbox databaseNameBox;

  public XulTextbox portNumberBox;

  public XulTextbox userNameBox;

  public XulTextbox passwordBox;
...
/*    if ( useIntegratedSecurityCheck != null ) {
  ...
  public void showMessage( String message, boolean scroll ) {
    try {
  ...
  public abstract static class DatabaseTypeListener implements PluginTypeListener {
