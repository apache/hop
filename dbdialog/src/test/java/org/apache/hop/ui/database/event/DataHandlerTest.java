 ...
 *
 ******************************************************************************/
package org.apache.hop.ui.database.event;
...
public class DataHandlerTest {
  ...
  public void testGetSetData() throws Exception {
    ...
    props.put( BaseDatabaseMeta.ATTRIBUTE_PREFIX_EXTRA_OPTION + "HopThin.webappname", "foo" );
    ...
    assertFalse( props.containsKey( BaseDatabaseMeta.ATTRIBUTE_PREFIX_EXTRA_OPTION + "HopThin.webappname" ) );
