...
For the operator-facing volume layout, Compose example, and upgrade procedure, see xref:manual::hop-web-docker.adoc[Hop Web in Docker: persistence and upgrades].
