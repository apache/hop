...
If you want to re-color or create icons that fit the Hop look & feel, please refer to https://hop.apache.org/graphical_resources/brand_guideline_hop.pdf[Hop Branding guide] for some guidance.