...
*** xref:plugin-types/diagram-exporters.adoc[Diagram exporters]
** xref:ai-advisor-plugins.adoc[AI advisor plugins]
...
** xref:gui-design-patterns.adoc[GUI design patterns]
