...
|Home folder|The folder where the project is located. Paths starting with `~` (e.g. `~/my-project` or `~\my-project` on Windows) automatically resolve to the user's home directory (`{openvar}user.home{closevar}`).|Yes|No|
