...
This servlet supports variable resolution in file paths (e.g., `+${PROJECT_HOME}+`) and can pass parameters and variables to the pipeline.
...
This servlet supports variable resolution in file paths (e.g., `+${PROJECT_HOME}+`) and can pass parameters and variables to the workflow.
