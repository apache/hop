...
* Deploy Hop Server using one of the xref:hop-server/deploying.adoc[documented patterns]
* Schedule production runs with an xref:how-to-guides/scheduling-workflows-and-pipelines.adoc[external scheduler], not the Start action's repeat option
