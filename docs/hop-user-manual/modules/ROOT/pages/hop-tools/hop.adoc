...
The command list depends on the plugins in your installation; the sample below shows the common options and a typical set of commands.
...
Commands:
  ...
  xml-schema Generate and validate XML schemas
----
