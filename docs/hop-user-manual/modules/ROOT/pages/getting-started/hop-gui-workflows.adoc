...
* click on an action in your pipeline to open the '**click anywhere**' dialog. Click the 'Create hop' image:getting-started/icons/HOP.svg[Create hop, 25px, align="bottom"] button and select the action you want to create the hop to.
