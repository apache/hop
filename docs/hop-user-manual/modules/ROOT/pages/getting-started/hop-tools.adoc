...
The example command below prints the `hop-import` help. Check the xref:hop-vs-kettle/import-kettle-projects.adoc[] docs for more information.
...
Read more at xref:hop-vs-kettle/import-kettle-projects.adoc[Import Kettle (PDI) projects]
