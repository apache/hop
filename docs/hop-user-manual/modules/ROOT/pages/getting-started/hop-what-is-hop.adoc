...
* Data warehouse population with built-in support for Slowly Changing Dimensions (SCD), xref:how-to-guides/change-data-capture.adoc[Change Data Capture (CDC)], and surrogate key creation.
