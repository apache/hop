...
under the License.
////
:description: Hop integrates with tens if not hundreds of different technologies. A few are covered here.
...
* xref:technology/ai/index.adoc[AI]
* xref:technology/arrow/apache-arrow.adoc[Apache Arrow]
* xref:technology/calcite/index.adoc[Apache Calcite]
...
* xref:technology/openlineage/index.adoc[OpenLineage]
* xref:technology/redis/index.adoc[Redis]
