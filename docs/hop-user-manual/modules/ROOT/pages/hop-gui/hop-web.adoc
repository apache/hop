...
| *Admin*
| `hop-admin`, `admin`
| Full access, including future security administration.

| *User* (developer)
| `hop-user`, `user`, `apachehop`
| Create, edit, save, delete, execute, metadata CRUD. No security administration.

| *Operator*
| `hop-operator`, `operator`
| View and execute only. No save, edit, delete, or metadata write.
