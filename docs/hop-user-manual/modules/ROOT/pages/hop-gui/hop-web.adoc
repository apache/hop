...
* Marketplace install/uninstall and hop-env *Apply* also require Admin (`plugin.manage`) at the effective level.
...
*Install*, *Uninstall*, repository configuration, and hop-env *Apply* require the `plugin.manage` permission (built-in *Admin* role only).
