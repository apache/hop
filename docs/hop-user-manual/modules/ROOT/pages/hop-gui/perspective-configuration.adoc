...
|Tooltips
a|A group of its own in the *Pipeline and Workflow canvas* section: one checkbox per kind of tooltip the canvas shows when the mouse rests on something. Untick a kind to stop only that one; *Show tool tips?* on the General tab still switches all of them off at once.
