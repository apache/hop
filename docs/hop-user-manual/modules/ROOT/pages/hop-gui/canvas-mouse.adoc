...
The pipeline and workflow canvas react to where you click and with which button. This page is the reference for all of it. Two options in the xref:hop-gui/perspective-configuration.adoc[configuration perspective] (General tab, Canvas section) change the behaviour:
