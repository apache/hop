...
Use the Mail action to send a text or HTML email with optional file attachments.
This workflow action is used at the end of a workflow run in most instances.
