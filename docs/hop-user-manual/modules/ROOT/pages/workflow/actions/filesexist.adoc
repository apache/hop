...
|Files/Folders|Specify the files and folders full paths to verify, one per line. You can use variables like `{openvar}PROJECT_HOME{closevar}` in the path, and they will be resolved.
|===
