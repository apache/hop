...
Cypher statements that will be executed for creating or dropping indexes. This preview 
shows the exact `CREATE INDEX` or `DROP INDEX` statements before execution.
