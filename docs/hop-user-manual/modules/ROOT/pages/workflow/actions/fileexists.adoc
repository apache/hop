...
You do not want to start the workflow until this is done, so you put the workflow on a xref:how-to-guides/scheduling-workflows-and-pipelines.adoc[scheduler].
