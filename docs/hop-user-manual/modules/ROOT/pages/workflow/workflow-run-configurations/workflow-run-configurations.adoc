...
* xref:workflow/workflow-run-configurations/native-load-balancing-workflow-engine.adoc[Load-balancing workflow engine]: this configuration assigns each workflow execution to one Hop Server from a group.
|===
