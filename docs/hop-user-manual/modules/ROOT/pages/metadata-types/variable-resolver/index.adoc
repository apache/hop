...
* xref:metadata-types/variable-resolver/aws-secrets-manager-variable-resolver.adoc[AWS Secrets Manager variable resolver]
...
* xref:metadata-types/variable-resolver/hop-password-variable-resolver.adoc[Hop Password variable resolver]
