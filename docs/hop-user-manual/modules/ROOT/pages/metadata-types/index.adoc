...
* xref:metadata-types/mail-server-connection.adoc[Mail Server Connection]: Defines a connection to an email server.
...
* xref:metadata-types/rest-connection.adoc[REST Connection]: Describes a base connection to a REST api endpoint
