...
*** Transforms: xref:pipeline/transforms/googlesheetsinput.adoc[Google Sheets Input], xref:pipeline/transforms/google-sheets-input.adoc[Google Sheets Output], Google Analytics
