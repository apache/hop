...
|Length|Length of the output field.
See xref:pipeline/formatting-values.adoc[Formatting numbers and dates].
|Precision|Precision of the output field.
See xref:pipeline/formatting-values.adoc[Formatting numbers and dates].
...
NOTE: This is the Rhino *JavaScript* transform.
The GraalVM / JSR-223 *Script* transform has an extra *Script result?* column; see xref:pipeline/transforms/script.adoc#fields-table[Script — Fields table].
