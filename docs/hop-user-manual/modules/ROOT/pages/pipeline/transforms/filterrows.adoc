...
The Filter Rows transform allows you to filter rows based on conditions and comparisons and affects workflow because of the downstream true or false hops (forked workflow options).
