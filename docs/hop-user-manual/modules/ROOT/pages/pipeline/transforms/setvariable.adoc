...
This transform allows you to set variables in a workflow or in the virtual machine.
It accepts one (and only one) row of data to set the value of a variable.
