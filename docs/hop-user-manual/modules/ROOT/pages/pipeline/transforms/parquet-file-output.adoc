...
Every field is written as an optional column of the https://parquet.apache.org/docs/file-format/types/logicaltypes/[Parquet type] below.
...
A value with more digits before the decimal point than the column holds stops the transform with an error.
