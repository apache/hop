...
|Keep the field to split|When enabled, the original field is kept and the new fields are appended at the end of the field list. When disabled (default), the original field is replaced in place by the new fields.
