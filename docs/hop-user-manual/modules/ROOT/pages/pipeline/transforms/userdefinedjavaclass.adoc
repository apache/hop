...
The Code Snippets folder contains ready to use fragments for the most common User Defined Java Class operations, grouped by category.
Click a snippet to insert it at the cursor position in the active class tab, or right-click it and pick Show Sample to open it in a read-only tab for reference.
