...
|By default, Hop checks whether there is an 'unknown' record available at ID 0 or 1.
If no such record is present in the dimension table, this transform adds it.
If you check this option you indicate that you take responsibility for adding this record yourself.
|===
