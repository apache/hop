...
For Hop types of *Date* and *Timestamp*, use the *Format* column to specify the incoming format. For example, for Date: `yyyy-MM-dd`. You can select a format from the dropdown or enter format text directly.
See xref:pipeline/formatting-values.adoc[Formatting numbers and dates].
