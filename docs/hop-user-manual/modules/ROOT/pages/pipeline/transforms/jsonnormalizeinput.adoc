...
Pipeline unit tests in `integration-tests/json/` (`0008`–`0011`) exercise these scenarios in CI, including `0011-json-normalize-hop-config-layers.hpl` for `+${HOP_CONFIG_FOLDER}/hop-config.json+` with parallel branches.
