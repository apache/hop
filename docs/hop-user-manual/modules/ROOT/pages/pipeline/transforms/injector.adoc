...
Pipeline unit tests replace a transform that has an input data set attached with an Injector, and inject the static data set rows instead of executing the original transform.
