...
* xref:pipeline/transforms/joinrows.adoc[Join Rows (cartesian product)] — add the same constant field to both inputs and use xref:pipeline/transforms/mergejoin.adoc[Merge Join] on that field instead
