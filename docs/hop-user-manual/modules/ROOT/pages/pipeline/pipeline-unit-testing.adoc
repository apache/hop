...
* Data set : A set of rows with a certain layout stored in a database table. When used as input we call it an input data set. When used to validate a transform's output we call it a _golden_ data set.
