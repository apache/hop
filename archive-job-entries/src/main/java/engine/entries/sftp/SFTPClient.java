...
public class SFTPClient {
  ...
  public void login( String password ) throws HopJobException {
  ...
  public void chdir( String dirToChangeTo ) throws HopJobException {
    try {
  ...
  public String[] dir() throws HopJobException {
  ...
  public void get( FileObject localFile, String remoteFile ) throws HopJobException {
  ...
  public String pwd() throws HopJobException {
    try {
      return c.pwd();
    } catch ( SftpException e ) {
      throw new HopJobException( e );
  ...
  public void put( FileObject fileObject, String remoteFile ) throws HopJobException {
    int mode = ChannelSftp.OVERWRITE;
  ...
  public void put( InputStream inputStream, String remoteFile ) throws HopJobException {
    int mode = ChannelSftp.OVERWRITE;
  ...
  public void delete( String file ) throws HopJobException {
    try {
      c.rm( file );
    } catch ( SftpException e ) {
      throw new HopJobException( e );
   ...
   */
  public void createFolder( String path ) throws HopJobException {
    try {
   ...
   * Rename the file.
   */
  public void renameFile( String sourcefilename, String destinationfilename ) throws HopJobException {
    try {
  ...
  public FileType getFileType( String filename ) throws HopJobException {
    try {
      ...
      if ( ( attrs.getFlags() & SftpATTRS.SSH_FILEXFER_ATTR_PERMISSIONS ) == 0 ) {
        throw new HopJobException( "Unknown permissions error" );
      }
  ...
  public void setProxy( String host, String port, String user, String pass, String proxyType ) throws HopJobException {

    if ( Utils.isEmpty( host ) || Const.toInt( port, 0 ) == 0 ) {
      throw new HopJobException( "Proxy server name must be set and server port must be greater than zero." );
    }
    Proxy proxy = null;
