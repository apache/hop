...
package org.apache.hop.ui.pipeline.steps.stepsmetrics;
...
import org.apache.hop.pipeline.steps.stepsmetrics.StepsMetrics;
import org.apache.hop.pipeline.steps.stepsmetrics.StepsMetricsMeta;
...
public class StepsMetricsDialog extends BaseStepDialog implements StepDialogInterface {
  private static Class<?> PKG = StepsMetrics.class; // for i18n purposes, needed by Translator!!
  ...
  public StepsMetricsDialog( Shell parent, Object in, PipelineMeta tr, String sname ) {
  ...
  public String open() {
    ...
    wStepnameField = new TextVar( pipelineMeta, wFieldsComp, SWT.SINGLE | SWT.LEFT | SWT.BORDER );
    ...
    wStepidField = new TextVar( pipelineMeta, wFieldsComp, SWT.SINGLE | SWT.LEFT | SWT.BORDER );
  ...
  private void setStepNames() {
    previousSteps = pipelineMeta.getStepNames();
    String[] nextSteps = pipelineMeta.getNextStepNames( stepMeta );
  ...
  private void getInfo( StepsMetricsMeta in ) {
    ...
    for ( int i = 0; i < nrsteps; i++ ) {
      ...
      StepMeta tm = pipelineMeta.findStep( ti.getText( 1 ) );
