...
package org.apache.hop.ui.pipeline.steps.userdefinedjavaclass;
...
import org.apache.hop.pipeline.steps.userdefinedjavaclass.FieldHelper;
import org.apache.hop.pipeline.steps.userdefinedjavaclass.InfoStepDefinition;
import org.apache.hop.pipeline.steps.userdefinedjavaclass.TargetStepDefinition;
import org.apache.hop.pipeline.steps.userdefinedjavaclass.UsageParameter;
import org.apache.hop.pipeline.steps.userdefinedjavaclass.UserDefinedJavaClassDef;
import org.apache.hop.pipeline.steps.userdefinedjavaclass.UserDefinedJavaClassDef.ClassType;
import org.apache.hop.pipeline.steps.userdefinedjavaclass.UserDefinedJavaClassMeta;
import org.apache.hop.pipeline.steps.userdefinedjavaclass.UserDefinedJavaClassMeta.FieldInfo;
...
import org.apache.hop.ui.pipeline.steps.userdefinedjavaclass.UserDefinedJavaClassCodeSnippits.Category;
import org.apache.hop.ui.pipeline.steps.userdefinedjavaclass.UserDefinedJavaClassCodeSnippits.Snippit;
...
public class UserDefinedJavaClassDialog extends BaseStepDialog implements StepDialogInterface {
  ...
  public String open() {
    ...
    prevStepNames = pipelineMeta.getPrevStepNames( stepMeta );
    nextStepNames = pipelineMeta.getNextStepNames( stepMeta );
    ...
    final Runnable runnable = new Runnable() {
      public void run() {
        ...
        if ( stepMeta != null ) {
          try {
            inputRowMeta = pipelineMeta.getPrevStepFields( stepMeta );
            infoRowMeta = pipelineMeta.getPrevInfoFields( stepMeta );
            outputRowMeta = pipelineMeta.getThisStepFields( stepMeta, null, inputRowMeta.clone() );
            populateFieldsTree();
  ...
  private void getInfo( UserDefinedJavaClassMeta meta ) {
    ...
    for ( int i = 0; i < nrInfos; i++ ) {
      ...
      stepDefinition.stepMeta = pipelineMeta.findStep( item.getText( colNr++ ) );
