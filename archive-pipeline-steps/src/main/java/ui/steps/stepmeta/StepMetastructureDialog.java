...
package org.apache.hop.ui.pipeline.steps.stepmeta;
...
import org.apache.hop.pipeline.steps.stepmeta.StepMetastructureMeta;
...
public class StepMetastructureDialog extends BaseStepDialog implements StepDialogInterface {
  private static Class<?> PKG = StepMetastructureMeta.class; // for i18n purposes, needed by Translator!!
  ...
  public StepMetastructureDialog( Shell parent, Object in, PipelineMeta tr, String sname ) {
