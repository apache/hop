...
package org.apache.hop.ui.pipeline.steps.scriptvalues_mod;
...
import org.apache.hop.pipeline.steps.scriptvalues_mod.ScriptValuesAddedFunctions;
import org.apache.hop.pipeline.steps.scriptvalues_mod.ScriptValuesMetaMod;
import org.apache.hop.pipeline.steps.scriptvalues_mod.ScriptValuesModDummy;
import org.apache.hop.pipeline.steps.scriptvalues_mod.ScriptValuesScript;
  ...
  private boolean test( boolean getvars, boolean popup ) {
    ...
    try {
      ...
      if ( rowMeta != null ) {
        ...
        ScriptValuesModDummy dummyStep = new ScriptValuesModDummy( rowMeta, pipelineMeta.getStepFields( stepname ) );
