...
package org.apache.hop.ui.pipeline.steps.selectvalues;
...
import org.apache.hop.pipeline.steps.selectvalues.SelectMetadataChange;
import org.apache.hop.pipeline.steps.selectvalues.SelectValuesMeta;
...
public class SelectValuesDialog extends BaseStepDialog implements StepDialogInterface {
  ...
  private void generateMappings() {
    ...
    try {
      nextStepRequiredFields = stepMetaInterface.getRequiredFields( pipelineMeta );
    } catch ( HopException e ) {
