...
package org.apache.hop.pipeline.steps.tablecompare;
...
public class TableCompare extends BaseStep implements StepInterface {
  ...
  public TableCompare( StepMeta stepMeta, StepDataInterface stepDataInterface, int copyNr, PipelineMeta pipelineMeta,
                       Pipeline pipeline ) {
