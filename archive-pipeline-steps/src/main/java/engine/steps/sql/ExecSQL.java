...
public class ExecSQL extends BaseStep implements StepInterface {
  ...
  public ExecSQL( StepMeta stepMeta, StepDataInterface stepDataInterface, int copyNr, PipelineMeta pipelineMeta,
                  Pipeline pipeline ) {
  ...
  public boolean processRow( StepMetaInterface smi, StepDataInterface sdi ) throws HopException {
    ...
    try {
      ...
      if ( getStepMeta().isDoingErrorHandling() ) {
        ...
        throw new HopStepException( BaseMessages.getString( PKG, "ExecSQL.Log.ErrorInStep" ), e );
      }
