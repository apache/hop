...
package org.apache.hop.pipeline.steps.sasinput;
...
public class SasInput extends BaseStep implements StepInterface {
  ...
  public SasInput( StepMeta stepMeta, StepDataInterface stepDataInterface, int copyNr, PipelineMeta pipelineMeta,
                   Pipeline pipeline ) {
