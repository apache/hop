...
public class DatabaseLookup extends BaseStep implements StepInterface {
  ...
  public DatabaseLookup( StepMeta stepMeta, StepDataInterface stepDataInterface, int copyNr, PipelineMeta pipelineMeta,
                         Pipeline pipeline ) {
   ...
   * (@see org.apache.hop.pipeline.steps.databaselookup.PDI5436Test)
   */
