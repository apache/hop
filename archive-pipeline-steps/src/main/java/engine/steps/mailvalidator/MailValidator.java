...
package org.apache.hop.pipeline.steps.mailvalidator;
...
public class MailValidator extends BaseStep implements StepInterface {
  ...
  public MailValidator( StepMeta stepMeta, StepDataInterface stepDataInterface, int copyNr, PipelineMeta pipelineMeta,
                        Pipeline pipeline ) {
