...
public class ZipFileMeta extends BaseStepMeta implements StepMetaInterface {
  ...
  private void readData( Node stepnode ) throws HopXMLException {
    try {
      ...
      throw new HopXMLException( BaseMessages.getString( PKG, "ZipFileMeta.Exception.UnableToReadStepInfo" ), e );
    }
  }
  ...
  public StepInterface getStep( StepMeta stepMeta, StepDataInterface stepDataInterface, int cnr,
    ...
    return new ZipFile( stepMeta, stepDataInterface, cnr, pipelineMeta, pipeline );
  }
