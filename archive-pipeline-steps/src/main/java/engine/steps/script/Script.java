...
package org.apache.hop.pipeline.steps.script;
...
public class Script extends BaseStep implements StepInterface {
  ...
  public Script( StepMeta stepMeta, StepDataInterface stepDataInterface, int copyNr, PipelineMeta pipelineMeta,
                 Pipeline pipeline ) {
  ...
  private boolean addValues( RowMetaInterface rowMeta, Object[] row ) throws HopException {
    if ( first ) {
      ...
      //
      data.scope.put( "_PipelineName_", this.getStepname() );
      ...
      try {
        ...
        // src/org.apache.hop/pipeline/steps/scriptvalues_mod/ScriptValuesMod.java
