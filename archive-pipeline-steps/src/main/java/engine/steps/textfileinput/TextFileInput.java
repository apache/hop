...
import org.apache.hop.pipeline.step.errorhandling.AbstractFileErrorHandler;
...
public class TextFileInput extends BaseStep implements StepInterface {
  ...
  public TextFileInput( StepMeta stepMeta, StepDataInterface stepDataInterface, int copyNr, PipelineMeta pipelineMeta,
                        Pipeline pipeline ) {
