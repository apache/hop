...
package org.apache.hop.pipeline.steps.writetolog;
...
public class WriteToLog extends BaseStep implements StepInterface {
  ...
  public WriteToLog( StepMeta stepMeta, StepDataInterface stepDataInterface, int copyNr, PipelineMeta pipelineMeta,
                     Pipeline pipeline ) {
