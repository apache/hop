...
package org.apache.hop.pipeline.steps.rssinput;
...
public class RssInput extends BaseStep implements StepInterface {
  ...
  public RssInput( StepMeta stepMeta, StepDataInterface stepDataInterface, int copyNr, PipelineMeta pipelineMeta,
                   Pipeline pipeline ) {
    ...
    if ( meta.urlInField() ) {
      ...
      if ( first ) {
        ...
        if ( Utils.isEmpty( meta.getUrlFieldname() ) ) {
          ...
          throw new HopException( BaseMessages.getString( PKG, "RssInput.Log.UrlFieldNameMissing" ) );
        }
        ...
        if ( data.indexOfUrlField < 0 ) {
          ...
          if ( data.indexOfUrlField < 0 ) {
            ...
            throw new HopException( BaseMessages.getString( PKG, "RssInput.Exception.ErrorFindingField", meta
              .getUrlFieldname() ) );
          }
        }
