...
public class TeraFast extends AbstractStep implements StepInterface {
   ...
   * {@inheritDoc}
   *
   * @see org.apache.hop.pipeline.step.BaseStep#processRow(org.apache.hop.pipeline.step.StepMetaInterface,
   * org.apache.hop.pipeline.step.StepDataInterface)
   */
  @Override
  public boolean processRow( final StepMetaInterface smi, final StepDataInterface sdi ) throws HopException {
    ...
    if ( this.first ) {
      ...
      RowMetaInterface streamRowMeta = this.getPipelineMeta().getPrevStepFields( this.getStepMeta() );
