...
package org.apache.hop.pipeline.steps.rowsfromresult;
...
public class RowsFromResult extends BaseStep implements StepInterface {
  ...
  public RowsFromResult( StepMeta stepMeta, StepDataInterface stepDataInterface, int copyNr, PipelineMeta pipelineMeta,
                         Pipeline pipeline ) {
  ...
  public boolean processRow( StepMetaInterface smi, StepDataInterface sdi ) throws HopException {
    ...
    // We don't get the meta-data from the previous steps (there aren't any) but from the previous pipeline or job
    //
