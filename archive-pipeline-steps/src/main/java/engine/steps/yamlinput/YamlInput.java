...
package org.apache.hop.pipeline.steps.yamlinput;
...
public class YamlInput extends BaseStep implements StepInterface {
  ...
  public YamlInput( StepMeta stepMeta, StepDataInterface stepDataInterface, int copyNr, PipelineMeta pipelineMeta,
                    Pipeline pipeline ) {
  ...
  private boolean readNextString() {
    ...
    try {
      ...
      if ( meta.getIsAFile() ) {
        ...
        data.yaml.loadFile( HopVFS.getFileObject( Fieldvalue, getPipelineMeta() ) );
