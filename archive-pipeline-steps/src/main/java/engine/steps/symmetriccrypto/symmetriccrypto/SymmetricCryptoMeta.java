 ...
 * @since 5-apr-2003
 */
public class SymmetricCryptoPipelineMeta extends BaseStepMeta implements StepMetaInterface {
  ...
  private void readData( Node stepnode ) throws HopXMLException {
    try {
      ...
      throw new HopXMLException( BaseMessages.getString(
        PKG, "SymmetricCryptoMeta.Exception.UnableToLoadStepInfoFromXML" ), e );
    }
  }
  ...
  public void check( List<CheckResultInterface> remarks, PipelineMeta pipelineMeta, StepMeta stepinfo,
    ...
    if ( prev != null && prev.size() > 0 ) {
      cr =
        new CheckResult(
          ...
          PKG, "SymmetricCryptoMeta.CheckResult.ConnectedStepOK", String.valueOf( prev.size() ) ),
          stepinfo );
    } else {
      cr =
        new CheckResult( CheckResult.TYPE_RESULT_ERROR, BaseMessages.getString(
          PKG, "SymmetricCryptoMeta.CheckResult.NoInputReceived" ), stepinfo );
    ...
    if ( getResultfieldname() == null ) {
      ...
      cr =
        new CheckResult( CheckResult.TYPE_RESULT_ERROR, BaseMessages.getString(
          PKG, "SymmetricCryptoMeta.CheckResult.ErrorResultFieldNameMissing" ), stepinfo );
      remarks.add( cr );
  ...
  public StepInterface getStep( StepMeta stepMeta, StepDataInterface stepDataInterface, int cnr,
    ...
    return new SymmetricCrypto( stepMeta, stepDataInterface, cnr, pipelineMeta, pipeline );
