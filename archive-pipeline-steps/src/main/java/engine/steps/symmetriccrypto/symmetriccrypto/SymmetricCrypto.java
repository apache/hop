 ...
 * @since 5-apr-2003
 */
public class SymmetricCrypto extends BaseStep implements StepInterface {
  ...
  public SymmetricCrypto( StepMeta stepMeta, StepDataInterface stepDataInterface, int copyNr,
  ...
  public boolean processRow( StepMetaInterface smi, StepDataInterface sdi ) throws HopException {
    ...
    try {
      ...
      if ( getStepMeta().isDoingErrorHandling() ) {
        ...
        logError( BaseMessages.getString( PKG, "SymmetricCrypto.Log.ErrorInStepRunning" ), e );
