...
package org.apache.hop.pipeline.steps.symmetriccrypto.symmetricalgorithm;
...
public class SymmetricCryptoMeta {
  ...
  private static Class<?> PKG = SymmetricCryptoMeta.class; // for i18n purposes, needed by Translator!!
