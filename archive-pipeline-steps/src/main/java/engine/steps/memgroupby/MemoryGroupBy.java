...
import org.apache.hop.pipeline.steps.memgroupby.MemoryGroupByData.HashEntry;
...
public class MemoryGroupBy extends BaseStep implements StepInterface {
  ...
  public MemoryGroupBy( StepMeta stepMeta, StepDataInterface stepDataInterface, int copyNr, PipelineMeta pipelineMeta,
                        Pipeline pipeline ) {
  ...
  public boolean processRow( StepMetaInterface smi, StepDataInterface sdi ) throws HopException {
    ...
    if ( first ) {
      ...
      if ( data.inputRowMeta == null ) {
        data.inputRowMeta = getPipelineMeta().getPrevStepFields( getStepMeta() );
      }
