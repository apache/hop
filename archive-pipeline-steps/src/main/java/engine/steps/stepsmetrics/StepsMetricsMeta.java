...
public class StepsMetricsMeta extends BaseStepMeta implements StepMetaInterface {
  ...
  public StepInterface getStep( StepMeta stepMeta, StepDataInterface stepDataInterface, int cnr, PipelineMeta tr,
                                Pipeline pipeline ) {
    return new StepsMetrics( stepMeta, stepDataInterface, cnr, tr, pipeline );
  }
  ...
  @Override
  public PipelineMeta.TransformationType[] getSupportedTransformationTypes() {
    return new PipelineMeta.TransformationType[] { PipelineMeta.TransformationType.Normal };
  }
}
