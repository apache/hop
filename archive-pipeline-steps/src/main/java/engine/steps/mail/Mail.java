...
package org.apache.hop.pipeline.steps.mail;
...
public class Mail extends BaseStep implements StepInterface {
  ...
  public Mail( StepMeta stepMeta, StepDataInterface stepDataInterface, int copyNr, PipelineMeta pipelineMeta, Pipeline pipeline ) {
