...
public class SQLFileOutputMeta extends BaseStepMeta implements StepMetaInterface {
  ...
  public StepInterface getStep( StepMeta stepMeta, StepDataInterface stepDataInterface, int cnr,
    ...
    return new SQLFileOutput( stepMeta, stepDataInterface, cnr, pipelineMeta, pipeline );
  }
  ...
  public void analyseImpact( List<DatabaseImpact> impact, PipelineMeta pipelineMeta, StepMeta stepMeta,
    ...
    if ( truncateTable ) {
      DatabaseImpact ii =
        new DatabaseImpact(
          DatabaseImpact.TYPE_IMPACT_TRUNCATE, pipelineMeta.getName(), stepMeta.getName(), databaseMeta
    ...
    if ( prev != null ) {
      for ( int i = 0; i < prev.size(); i++ ) {
        ...
        DatabaseImpact ii =
          new DatabaseImpact(
            DatabaseImpact.TYPE_IMPACT_WRITE, pipelineMeta.getName(), stepMeta.getName(), databaseMeta
