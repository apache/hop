...
package org.apache.hop.pipeline.steps.sqlfileoutput;
...
public class SQLFileOutput extends BaseStep implements StepInterface {
  ...
  public SQLFileOutput( StepMeta stepMeta, StepDataInterface stepDataInterface, int copyNr, PipelineMeta pipelineMeta,
                        Pipeline pipeline ) {
  ...
  public boolean processRow( StepMetaInterface smi, StepDataInterface sdi ) throws HopException {
    ...
    try {
      ...
      throw new HopStepException( e.getMessage() );
    }
    ...
    if ( super.init( smi, sdi ) ) {
      try {
        if ( meta.getDatabaseMeta() == null ) {
          throw new HopStepException( "The connection is not defined (empty)" );
        }
        if ( meta.getDatabaseMeta() == null ) {
