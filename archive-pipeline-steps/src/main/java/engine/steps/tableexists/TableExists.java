...
package org.apache.hop.pipeline.steps.tableexists;
...
public class TableExists extends BaseStep implements StepInterface {
  ...
  public TableExists( StepMeta stepMeta, StepDataInterface stepDataInterface, int copyNr, PipelineMeta pipelineMeta,
                      Pipeline pipeline ) {
