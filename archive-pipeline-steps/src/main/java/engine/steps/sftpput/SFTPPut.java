...
package org.apache.hop.pipeline.steps.sftpput;
...
public class SFTPPut extends BaseStep implements StepInterface {
  ...
  public SFTPPut( StepMeta stepMeta, StepDataInterface stepDataInterface, int copyNr, PipelineMeta pipelineMeta,
                  Pipeline pipeline ) {
  ...
  public boolean processRow( StepMetaInterface smi, StepDataInterface sdi ) throws HopException {
    ...
    try {
      if ( Utils.isEmpty( sourceData ) ) {
        ...
        throw new HopStepException( BaseMessages.getString( PKG, "SFTPPut.Error.SourceDataEmpty" ) );
      }
      ...
      if ( meta.isInputStream() ) {
        ...
        if ( data.indexOfRemoteFilename == -1 ) {
          ...
          throw new HopStepException( BaseMessages.getString( PKG, "SFTPPut.Error.RemoteFilenameFieldMissing" ) );
        }
        ...
        if ( !file.exists() ) {
          ...
          throw new HopStepException( BaseMessages.getString( PKG, "SFTPPut.Error.CanNotFindField", sourceData ) );
        }
  ...
  @VisibleForTesting
  void checkSourceFileField( String sourceFilenameFieldName, SFTPPutData data ) throws HopStepException {
    ...
    if ( Utils.isEmpty( sourceFilenameFieldName ) ) {
      ...
      throw new HopStepException( BaseMessages.getString( PKG, "SFTPPut.Error.SourceFileNameFieldMissing" ) );
    }
  ...
  @VisibleForTesting
  void checkRemoteFoldernameField( String remoteFoldernameFieldName, SFTPPutData data ) throws HopStepException {
    ...
    if ( Utils.isEmpty( remoteFoldernameFieldName ) ) {
      ...
      throw new HopStepException( BaseMessages.getString( PKG, "SFTPPut.Error.RemoteFolderNameFieldMissing" ) );
    }
  ...
  @VisibleForTesting
  void checkDestinationFolderField( String realDestinationFoldernameFieldName, SFTPPutData data ) throws HopStepException {
        ...
        default:
          if ( meta.isAddFilenameResut() ) {
            ...
            ResultFile resultFile =
              new ResultFile( ResultFile.FILE_TYPE_GENERAL, file, getPipelineMeta().getName(), getStepname() );
