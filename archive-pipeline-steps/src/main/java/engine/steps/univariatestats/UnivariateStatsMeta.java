...
public class UnivariateStatsMeta extends BaseStepMeta implements StepMetaInterface {
   ...
   */
  @Override
  public void check( List<CheckResultInterface> remarks, PipelineMeta transmeta, StepMeta stepMeta, RowMetaInterface prev,
  ...
  public StepInterface getStep( StepMeta stepMeta, StepDataInterface stepDataInterface, int cnr, PipelineMeta tr,
                                Pipeline pipeline ) {
    return new UnivariateStats( stepMeta, stepDataInterface, cnr, tr, pipeline );
  }
