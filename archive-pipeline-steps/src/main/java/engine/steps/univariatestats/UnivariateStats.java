...
package org.apache.hop.pipeline.steps.univariatestats;
...
public class UnivariateStats extends BaseStep implements StepInterface {
   ...
   */
  public UnivariateStats( StepMeta stepMeta, StepDataInterface stepDataInterface, int copyNr, PipelineMeta pipelineMeta,
                          Pipeline pipeline ) {
  ...
  public boolean processRow( StepMetaInterface smi, StepDataInterface sdi ) throws HopException {
    ...
    if ( first ) {
      ...
      m_meta.getFields( m_data.getOutputRowMeta(), getStepname(), null, null, this, metaStore );
