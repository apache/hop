...
package org.apache.hop.pipeline.steps.samplerows;
...
public class SampleRows extends BaseStep implements StepInterface {
  ...
  public SampleRows( StepMeta stepMeta, StepDataInterface stepDataInterface, int copyNr, PipelineMeta pipelineMeta,
                     Pipeline pipeline ) {
