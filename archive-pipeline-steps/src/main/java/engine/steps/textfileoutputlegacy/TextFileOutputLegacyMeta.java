 ...
 *
 * @deprecated use {@link org.apache.hop.pipeline.steps.textfileoutput.TextFileOutputMeta} instead.
 */
@Deprecated
public class TextFileOutputLegacyMeta extends TextFileOutputMeta {
  ...
  public StepInterface getStep( StepMeta stepMeta, StepDataInterface stepDataInterface, int cnr, PipelineMeta pipelineMeta,
                                Pipeline pipeline ) {
    return new TextFileOutputLegacy( stepMeta, stepDataInterface, cnr, pipelineMeta, pipeline );
  }
