...
public class AddSequence extends BaseStep implements StepInterface {
  ...
  public AddSequence( StepMeta stepMeta, StepDataInterface stepDataInterface, int copyNr, PipelineMeta pipelineMeta,
                      Pipeline pipeline ) {
  ...
  public Object[] addSequence( RowMetaInterface inputRowMeta, Object[] inputRowData ) throws HopException {
    ...
    if ( meta.isCounterUsed() ) {
      ...
      throw new HopStepException( BaseMessages.getString( PKG, "AddSequence.Exception.NoSpecifiedMethod" ) );
    }
