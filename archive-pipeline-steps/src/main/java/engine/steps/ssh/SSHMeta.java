...
package org.apache.hop.pipeline.steps.ssh;
...
public class SSHMeta extends BaseStepMeta implements StepMetaInterface {
  ...
  private void readData( Node stepnode ) throws HopXMLException {
    try {
      ...
      throw new HopXMLException( BaseMessages.getString( PKG, "SSHMeta.Exception.UnableToReadStepInfo" ), e );
    }
  }
  ...
  public StepInterface getStep( StepMeta stepMeta, StepDataInterface stepDataInterface, int cnr,
    ...
    return new SSH( stepMeta, stepDataInterface, cnr, pipelineMeta, pipeline );
  }
