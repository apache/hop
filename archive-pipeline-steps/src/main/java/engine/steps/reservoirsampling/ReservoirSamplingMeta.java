...
package org.apache.hop.pipeline.steps.reservoirsampling;
...
public class ReservoirSamplingMeta extends BaseStepMeta implements StepMetaInterface {
  ...
  public void check( List<CheckResultInterface> remarks, PipelineMeta transmeta, StepMeta stepMeta,
  ...
  public StepInterface getStep( StepMeta stepMeta, StepDataInterface stepDataInterface, int cnr, PipelineMeta tr,
                                Pipeline pipeline ) {
    return new ReservoirSampling( stepMeta, stepDataInterface, cnr, tr, pipeline );
  }
