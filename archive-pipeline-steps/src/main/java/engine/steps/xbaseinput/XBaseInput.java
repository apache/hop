...
public class XBaseInput extends BaseStep implements StepInterface {
  ...
  public XBaseInput( StepMeta stepMeta, StepDataInterface stepDataInterface, int copyNr, PipelineMeta pipelineMeta,
                     Pipeline pipeline ) {
  ...
  private void openNextFile() throws HopException {
    ...
    try {
      ...
      ResultFile resultFile =
        new ResultFile( ResultFile.FILE_TYPE_GENERAL, data.file_dbf, getPipelineMeta().getName(), getStepname() );
