...
package org.apache.hop.pipeline.steps.ldapinput;
...
public class LDAPInput extends BaseStep implements StepInterface {
  ...
  public LDAPInput( StepMeta stepMeta, StepDataInterface stepDataInterface, int copyNr, PipelineMeta pipelineMeta,
                    Pipeline pipeline ) {
