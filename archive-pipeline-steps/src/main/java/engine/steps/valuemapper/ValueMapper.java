...
package org.apache.hop.pipeline.steps.valuemapper;
...
public class ValueMapper extends BaseStep implements StepInterface {
  ...
  public ValueMapper( StepMeta stepMeta, StepDataInterface stepDataInterface, int copyNr, PipelineMeta pipelineMeta,
                      Pipeline pipeline ) {
