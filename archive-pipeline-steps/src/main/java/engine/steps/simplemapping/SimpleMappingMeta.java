...
import org.apache.hop.pipeline.steps.mappinginput.MappingInputMeta;
import org.apache.hop.pipeline.steps.mappingoutput.MappingOutputMeta;
...
public class SimpleMappingMeta extends StepWithMappingMeta implements StepMetaInterface, ISubPipelineAwareMeta {
  ...
  public void loadXML( Node stepnode, IMetaStore metaStore ) throws HopXMLException {
    try {
      ...
      throw new HopXMLException( BaseMessages.getString(
        PKG, "SimpleMappingMeta.Exception.ErrorLoadingPipelineStepFromXML" ), e );
    }
  }
  ...
  public void getFields( RowMetaInterface row, String origin, RowMetaInterface[] info, StepMeta nextStep,
    ...
    if ( mappingParameters != null && mappingPipelineMeta != null ) {
      ...
      //
      StepWithMappingMeta.activateParams( mappingPipelineMeta, mappingPipelineMeta, space, mappingPipelineMeta.listParameters(),
    ...
    // input steps in the sub- pipeline about the data coming in...
    //
    ...
    //
    StepMeta mappingInputStep = mappingPipelineMeta.findMappingInputStep( null );
    ...
    StepMeta mappingOutputStep = mappingPipelineMeta.findMappingOutputStep( null );
    ...
    //
    RowMetaInterface mappingOutputRowMeta = mappingPipelineMeta.getStepFields( mappingOutputStep );
  ...
  public StepInterface getStep( StepMeta stepMeta, StepDataInterface stepDataInterface, int cnr, PipelineMeta tr,
                                Pipeline pipeline ) {
    return new SimpleMapping( stepMeta, stepDataInterface, cnr, tr, pipeline );
  }
