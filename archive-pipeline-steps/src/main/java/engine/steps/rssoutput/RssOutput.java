...
package org.apache.hop.pipeline.steps.rssoutput;
...
public class RssOutput extends BaseStep implements StepInterface {
  ...
  public RssOutput( StepMeta stepMeta, StepDataInterface stepDataInterface, int copyNr, PipelineMeta pipelineMeta,
                    Pipeline pipeline ) {
  ...
  public String buildFilename() throws HopStepException {
