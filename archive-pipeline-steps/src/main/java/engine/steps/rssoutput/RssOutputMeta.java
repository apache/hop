...
public class RssOutputMeta extends BaseStepMeta implements StepMetaInterface {
  ...
  public String[] getFiles( VariableSpace space ) throws HopStepException {
    int copies = 1;
    int parts = 1;
  ...
  private String getFilename( VariableSpace space ) throws HopStepException {
  ...
  public String buildFilename( VariableSpace space, int stepnr ) throws HopStepException {
  ...
  public StepInterface getStep( StepMeta stepMeta, StepDataInterface stepDataInterface, int cnr, PipelineMeta tr,
                                Pipeline pipeline ) {
    return new RssOutput( stepMeta, stepDataInterface, cnr, tr, pipeline );
  }
}
