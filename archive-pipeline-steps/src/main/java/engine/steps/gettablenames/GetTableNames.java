...
package org.apache.hop.pipeline.steps.gettablenames;
...
public class GetTableNames extends BaseStep implements StepInterface {
  ...
  public GetTableNames( StepMeta stepMeta, StepDataInterface stepDataInterface, int copyNr, PipelineMeta pipelineMeta,
                        Pipeline pipeline ) {
  ...
  private void processIncludeSynonym( Object[] outputRow )
    throws HopDatabaseException, HopStepException, HopValueException {
