...
package org.apache.hop.pipeline.steps.setvariable;
...
public class SetVariable extends BaseStep implements StepInterface {
  ...
  public SetVariable( StepMeta stepMeta, StepDataInterface stepDataInterface, int copyNr, PipelineMeta pipelineMeta,
                      Pipeline pipeline ) {
  ...
  private void setValue( Object[] rowData, int i, boolean usedefault ) throws HopException {
    ...
    // We always set the variable in this step and in the parent pipeline...
    //
    ...
    switch ( meta.getVariableType()[ i ] ) {
      ...
      case SetVariableMeta.VARIABLE_TYPE_GRAND_PARENT_JOB:
        ...
        if ( parentJob != null ) {
          ...
          throw new HopStepException( "Can't set variable ["
