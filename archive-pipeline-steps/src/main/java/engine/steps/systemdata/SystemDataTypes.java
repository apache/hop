...
public enum SystemDataTypes {
  ...
  TYPE_SYSTEM_INFO_HOP_VERSION( "kettle version", "HopVersion" ),
  TYPE_SYSTEM_INFO_HOP_BUILD_VERSION( "kettle build version", "HopBuildVersion" ),
  TYPE_SYSTEM_INFO_HOP_BUILD_DATE( "kettle build date", "HopBuildDate" ),
