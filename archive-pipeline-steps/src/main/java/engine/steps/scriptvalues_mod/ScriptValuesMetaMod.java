 ...
 *
 */
@Step( id = "ScriptValuesMod", i18nPackageName = "org.apache.hop.pipeline.steps.scriptvalues_mod",
...
public class ScriptValuesMetaMod extends BaseStepMeta implements StepMetaInterface {
  ...
  public void check( List<CheckResultInterface> remarks, PipelineMeta pipelineMeta, StepMeta stepMeta,
    ...
    if ( prev != null && strActiveScript.length() > 0 ) {
      ...
      try {
        ScriptValuesModDummy dummyStep = new ScriptValuesModDummy( prev, pipelineMeta.getStepFields( stepMeta ) );
  ...
  public StepInterface getStep( StepMeta stepMeta, StepDataInterface stepDataInterface, int cnr,
    ...
    return new ScriptValuesMod( stepMeta, stepDataInterface, cnr, pipelineMeta, pipeline );
  }
  ...
  public String getDialogClassName() {
    return "org.apache.hop.ui.pipeline.steps.scriptvalues_mod.ScriptValuesModDialog";
  }
