...
public class UserDefinedJavaClassDef implements Cloneable {
  ...
  public String getChecksum() throws HopStepException {
    ...
    try {
      ...
      throw new HopStepException( "Unable to obtain checksum of UDJC - " + this.className );
    }
  }
  ...
  public String getTransformedSource() throws HopStepException {
  ...
  private static final String CONSTRUCTOR =
    "\n\npublic %s(UserDefinedJavaClass parent, UserDefinedJavaClassMeta meta, UserDefinedJavaClassData data) "
      + "throws HopStepException { super(parent,meta,data);}";
