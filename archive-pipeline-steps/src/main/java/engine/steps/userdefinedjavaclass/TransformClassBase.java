...
public abstract class TransformClassBase {
  ...
  public TransformClassBase( UserDefinedJavaClass parent, UserDefinedJavaClassMeta meta,
    ...
    try {
      data.inputRowMeta = getPipelineMeta().getPrevStepFields( getStepMeta() ).clone();
      data.outputRowMeta = getPipelineMeta().getThisStepFields( getStepMeta(), null, data.inputRowMeta.clone() );
  ...
  public Object[] getRow() throws HopException {
    ...
    if ( updateRowMeta ) {
      ...
      data.outputRowMeta =
        inputRowMeta == null ? null : getPipelineMeta().getThisStepFields(
  ...
  public FieldHelper get( Fields type, String name ) throws HopStepException {
    FieldHelper fh;
    switch ( type ) {
      case In:
      ...
      case Info:
        ...
        if ( fh == null ) {
          RowMetaInterface rmi = getPipelineMeta().getPrevInfoFields( getStepname() );
          try {
