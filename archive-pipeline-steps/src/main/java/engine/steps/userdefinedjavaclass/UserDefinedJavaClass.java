...
package org.apache.hop.pipeline.steps.userdefinedjavaclass;
...
public class UserDefinedJavaClass extends BaseStep implements StepInterface {
  ...
  public RowSet findInputRowSetImpl( String sourceStep ) throws HopStepException {
  ...
  public RowSet findOutputRowSetImpl( String targetStep ) throws HopStepException {
  ...
  public Object[] getRowFromImpl( RowSet rowSet ) throws HopStepException {
  ...
  public void initBeforeStartImpl() throws HopStepException {
  ...
  public void openRemoteInputStepSocketsOnce() throws HopStepException {
    if ( child == null ) {
  ...
  public void openRemoteInputStepSocketsOnceImpl() throws HopStepException {
    super.openRemoteInputStepSocketsOnce();
  }

  public void openRemoteOutputStepSocketsOnce() throws HopStepException {
    if ( child == null ) {
  ...
  public void openRemoteOutputStepSocketsOnceImpl() throws HopStepException {
  ...
  public void putRow( RowMetaInterface row, Object[] data ) throws HopStepException {
    if ( child == null ) {
      putRowImpl( row, data );
    } else {
  ...
  public void putRowImpl( RowMetaInterface row, Object[] data ) throws HopStepException {
  ...
  public void putRowToImpl( RowMetaInterface rowMeta, Object[] row, RowSet rowSet ) throws HopStepException {
  ...
  public void stopRunningImpl( StepMetaInterface stepMetaInterface, StepDataInterface stepDataInterface ) throws HopException {
