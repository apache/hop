...
public class Denormaliser extends BaseStep implements StepInterface {
  ...
  public Denormaliser( StepMeta stepMeta, StepDataInterface stepDataInterface, int copyNr, PipelineMeta pipelineMeta,
                       Pipeline pipeline ) {
  ...
  private boolean processFirstRow() throws HopStepException {
