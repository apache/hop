...
package org.apache.hop.pipeline.steps.ldifinput;
...
public class LDIFInput extends BaseStep implements StepInterface {
  ...
  public LDIFInput( StepMeta stepMeta, StepDataInterface stepDataInterface, int copyNr, PipelineMeta pipelineMeta,
                    Pipeline pipeline ) {
