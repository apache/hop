...
package org.apache.hop.pipeline.steps.webservices;
...
import org.apache.hop.pipeline.steps.webservices.wsdl.Wsdl;
import org.apache.hop.pipeline.steps.webservices.wsdl.WsdlOpParameter;
import org.apache.hop.pipeline.steps.webservices.wsdl.WsdlOpParameterList;
import org.apache.hop.pipeline.steps.webservices.wsdl.WsdlOperation;
import org.apache.hop.pipeline.steps.webservices.wsdl.XsdType;
...
public class WebService extends BaseStep implements StepInterface {
  ...
  public WebService( StepMeta aStepMeta, StepDataInterface aStepData, int value, PipelineMeta aPipelineMeta, Pipeline aPipeline ) {
    super( aStepMeta, aStepData, value, aPipelineMeta, aPipeline );
  ...
  public boolean processRow( StepMetaInterface metaInterface, StepDataInterface dataInterface ) throws HopException {
    ...
    if ( rowMeta != null ) {
      for ( WebServiceField curField : meta.getFieldsIn() ) {
        ...
        if ( index >= 0 ) {
          ...
          throw new HopException( "Required input field ["
  ...
  private synchronized void requestSOAP( Object[] rowData, RowMetaInterface rowMeta ) throws HopException {
    ...
    try {
      ...
      if ( responseCode == HttpStatus.SC_OK ) {
        ...
        throw new HopStepException( BaseMessages.getString( PKG, "WebServices.ERROR0011.Authentication",
          cachedURLService ) );
      ...
      throw new HopStepException( BaseMessages.getString( PKG, "WebServices.ERROR0002.InvalidURI",
        cachedURLService ), e );
    } finally {
  ...
  private void initWsdlEnv() throws HopException {
    ...
    try {
      ...
      throw new HopStepException( BaseMessages.getString( PKG, "WebServices.ERROR0013.ExceptionLoadingWSDL" ), e );
    }
  ...
  private String readStringFromInputStream( InputStream is, String encoding ) throws HopStepException {
    ...
    try {
      ...
      throw new HopStepException( "Unable to read web service response data from input stream", e );
    }
                ...
                if ( processing ) {
                  ...
                  if ( meta.getFieldsOut().size() == 1 && field != null ) {
                    ...
                    try {
                      ...
                      throw new HopStepException( "Unable to get value for field ["
                        + field.getName()
  ...
  private boolean getNodeValue( Object[] outputRowData, Node node, WebServiceField field, Transformer transformer,
                                boolean singleRowScenario ) throws HopException {
    ...
    if ( node.getNodeType() == Node.TEXT_NODE || !field.isComplex() ) {
      ...
      try {
        ...
        throw new HopException( "Unable to convert value ["
