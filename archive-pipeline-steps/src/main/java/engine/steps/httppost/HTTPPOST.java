...
import static org.apache.hop.pipeline.steps.httppost.HTTPPOSTMeta.DEFAULT_ENCODING;
      ...
      if ( meta.isUrlInField() ) {
        ...
        if ( data.indexOfUrlField < 0 ) {
          ...
          if ( data.indexOfUrlField < 0 ) {
            ...
            throw new HopException( BaseMessages.getString( PKG, "HTTPPOST.Exception.ErrorFindingField",
              realUrlfieldName ) );
          }
        }
      } else {
        ...
        for ( int i = 0; i < nrargs; i++ ) {
          ...
          if ( fieldIndex < 0 ) {
            logError( BaseMessages.getString( PKG, "HTTPPOST.Log.ErrorFindingField" ) + meta.getArgumentField()[ i ]
              + "]" );
            throw new HopStepException( BaseMessages.getString( PKG, "HTTPPOST.Exception.CouldnotFindField", meta
              .getArgumentField()[ i ] ) );
          }
          if ( meta.getArgumentHeader()[ i ] ) {
