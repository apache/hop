...
package org.apache.hop.pipeline.steps.parallelgzipcsv;
...
public class ParGzipCsvInput extends BaseStep implements StepInterface {
  ...
  public ParGzipCsvInput( StepMeta stepMeta, StepDataInterface stepDataInterface, int copyNr, PipelineMeta pipelineMeta,
                          Pipeline pipeline ) {
