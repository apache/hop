...
package org.apache.hop.pipeline.steps.randomccnumber;
...
public class RandomCreditCardNumberGenerator {
  ...
  public static String[] GenerateCreditCardNumbers( int cardType, int size, int howMany ) throws HopException {
    String[] cards = null;
    switch ( cardType ) {
