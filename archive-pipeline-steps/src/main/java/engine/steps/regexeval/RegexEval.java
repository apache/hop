...
public class RegexEval extends BaseStep implements StepInterface {
  ...
  public RegexEval( StepMeta stepMeta, StepDataInterface stepDataInterface, int copyNr, PipelineMeta pipelineMeta,
                    Pipeline pipeline ) {
  ...
  public boolean processRow( StepMetaInterface smi, StepDataInterface sdi ) throws HopException {
    ...
    if ( first ) { // we just got started
      ...
      if ( meta.getMatcher() == null ) {
        ...
        throw new HopStepException( BaseMessages.getString( PKG, "RegexEval.Exception.ErrorMatcherMissing" ) );
      }
      ...
      if ( data.indexOfFieldToEvaluate < 0 ) {
        ...
        throw new HopStepException( BaseMessages.getString( PKG, "RegexEval.Exception.CouldnotFindField", meta
          .getMatcher() ) );
      }
    ...
    try {
      ...
      if ( getStepMeta().isDoingErrorHandling() ) {
        ...
        throw new HopStepException( BaseMessages.getString( PKG, "RegexEval.Log.ErrorInStep" ), e );
      }
