...
public class ScriptTest {
  ...
  public void testOutputDoneIfInputEmpty() throws Exception {
    Script step = new Script( helper.stepMeta, helper.stepDataInterface, 1, helper.pipelineMeta, helper.pipeline );
    ...
    PipelineTestingUtil.execute( step, helper.processRowsStepMetaInterface, helper.processRowsStepDataInterface, 0, true );
    rs.getRow();
  }
