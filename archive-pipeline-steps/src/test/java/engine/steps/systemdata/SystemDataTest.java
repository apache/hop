...
public class SystemDataTest {
  private class SystemDataHandler extends SystemData {
    ...
    public SystemDataHandler( StepMeta stepMeta, StepDataInterface stepDataInterface, int copyNr, PipelineMeta pipelineMeta,
                              Pipeline pipeline ) {
  ...
  public void setUp() throws Exception {
    ...
    verify( stepMockHelper.pipeline, never() ).stopAll();
  }
  ...
  public void testProcessRow() throws Exception {
    ...
    SystemDataHandler systemData =
      new SystemDataHandler( stepMockHelper.stepMeta, stepMockHelper.stepDataInterface, 0, stepMockHelper.pipelineMeta,
