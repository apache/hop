...
public class TableInputTest {
  ...
  public void setUp() {
    ...
    when( mockPipelineMeta.findStep( anyString() ) ).thenReturn( mockStepMeta );
    ...
    mockTableInput = spy( new TableInput( mockStepMeta, mockStepDataInterface, 1, mockPipelineMeta, mockPipeline ) );
  }
