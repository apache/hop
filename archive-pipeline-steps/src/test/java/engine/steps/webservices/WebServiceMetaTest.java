...
public class WebServiceMetaTest {
  ...
  public void testCheck() throws Exception {
    ...
    webServiceMeta.check(
      remarks, pipelineMeta, stepMeta, null, input, null, info, new Variables(), metastore );
    ...
    webServiceMeta.check(
      remarks, pipelineMeta, stepMeta, prev, new String[] {}, null, info, new Variables(), metastore );
    assertEquals( 2, remarks.size() );
