...
import org.apache.hop.pipeline.steps.PDI_11948_StepsTestsParent;
 ...
 * @see org.apache.hop.pipeline.steps.mapping.Mapping
 * @see org.apache.hop.pipeline.steps.simplemapping.SimpleMapping
 * @see org.apache.hop.pipeline.steps.pipelineexecutor.PipelineExecutor
 * @see org.apache.hop.pipeline.steps.singlethreader.SingleThreader
 */
public class PDI_11948_MappingTest extends PDI_11948_StepsTestsParent<Mapping, MappingData> {
  ...
  public void testMappingStep() throws HopException {
    ...
    when( stepDataMock.getMappingPipeline() ).thenReturn( transMock );

    // stubbing methods for null-checking
    when( stepMock.getPipeline() ).thenReturn( transMock );
