...
public class MappingParametersTest {
  ...
  public void testOverrideMappingParameters() throws HopException {
    ...
    StepWithMappingMeta
      .activateParams( pipeline, pipeline, step, pipelineMeta.listParameters(), param.getVariable(), param.getInputField(), param.isInheritingAllVariables() );
  ...
  public void testDoNotOverrideMappingParametes() throws HopException {
    ...
    Mockito.verify( pipelineMeta, never() ).copyVariablesFrom( Mockito.any( VariableSpace.class ) );
  }
