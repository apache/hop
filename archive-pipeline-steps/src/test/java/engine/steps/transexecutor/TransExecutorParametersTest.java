...
public class PipelineExecutorParametersTest {

  @Test
  public void testClone() throws Exception {
    PipelineExecutorParameters meta = new PipelineExecutorParameters();
    meta.setField( new String[] { "field1", "field2" } );
    meta.setVariable( new String[] { "var1", "var2" } );
    meta.setInput( new String[] { "input1", "input2" } );

    PipelineExecutorParameters cloned = (PipelineExecutorParameters) meta.clone();
