...
public class PipelineExecutorMetaTest {
  ...
  public void testRemoveHopFrom() throws Exception {
    ...
    pipelineExecutorMeta.setExecutionResultTargetStepMeta( new StepMeta() );
    pipelineExecutorMeta.setOutputRowsSourceStepMeta( new StepMeta() );
    pipelineExecutorMeta.setResultFilesTargetStepMeta( new StepMeta() );
    pipelineExecutorMeta.setExecutorsOutputStepMeta( new StepMeta() );

    pipelineExecutorMeta.cleanAfterHopFromRemove();

    assertNull( pipelineExecutorMeta.getExecutionResultTargetStepMeta() );
    assertNull( pipelineExecutorMeta.getOutputRowsSourceStepMeta() );
    assertNull( pipelineExecutorMeta.getResultFilesTargetStepMeta() );
    assertNull( pipelineExecutorMeta.getExecutorsOutputStepMeta() );
  }
