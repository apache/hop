...
public class IfNullTest {
  ...
  private IfNullMeta mockProcessRowMeta() throws HopStepException {
  ...
  public void testString_emptyIsNull() throws HopException {
    ...
    IfNull step = new IfNull( smh.stepMeta, smh.stepDataInterface, 0, smh.pipelineMeta, smh.pipeline );
