...
import org.apache.hop.pipeline.steps.file.IBaseFileInputReader;
import org.apache.hop.pipeline.steps.file.IBaseFileInputStepControl;
...
public class TextFileInputTest {
  ...
  public static class TestTextFileInput extends TextFileInput {
    public TestTextFileInput( StepMeta stepMeta, StepDataInterface stepDataInterface, int copyNr, PipelineMeta pipelineMeta,
                              Pipeline pipeline ) {
