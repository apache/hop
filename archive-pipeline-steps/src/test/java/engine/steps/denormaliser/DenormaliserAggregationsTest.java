...
public class DenormaliserAggregationsTest {
  ...
  public void setUp() throws Exception {
    ...
    step = new Denormaliser( mockHelper.stepMeta, data, 0, mockHelper.pipelineMeta, mockHelper.pipeline );
  }
  ...
  public void testDenormalizeMinValueN() throws HopValueException {
    step.setVariable( Const.HOP_AGGREGATION_MIN_NULL_IS_VALUED, "N" );
