...
public class PDI5436Test {
  ...
  private DatabaseLookupMeta mockStepMeta() throws HopStepException {
  ...
  public void testCacheAllTable() throws HopException {
    DatabaseLookup stepSpy =
      spy( new DatabaseLookup( smh.stepMeta, smh.stepDataInterface, 0, smh.pipelineMeta, smh.pipeline ) );
