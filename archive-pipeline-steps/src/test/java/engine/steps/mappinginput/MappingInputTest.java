...
package org.apache.hop.pipeline.steps.mappinginput;
...
import org.apache.hop.pipeline.steps.validator.Validator;
import org.apache.hop.pipeline.steps.validator.ValidatorData;
...
public class MappingInputTest {
  ...
  public void testSetConnectorSteps() throws Exception {
    ...
    Validator previousStep =
      new Validator( stepMockHelper.stepMeta, validatorData, 0, stepMockHelper.pipelineMeta, stepMockHelper.pipeline );
  ...
  public void testSetConnectorStepsWithNullArguments() throws Exception {
    try {
      ...
      final MappingInput mappingInput =
        new MappingInput( stepMockHelper.stepMeta, mappingInputData, 0, stepMockHelper.pipelineMeta,
