...
package org.apache.hop.pipeline.steps.stringoperations;
...
public class StringOperationsTest {
  ...
  private boolean verifyOutput( Object[][] expectedRows, RowSet outputRowSet ) throws HopValueException {
  ...
  public void testProcessBinaryInput() throws HopException {
    StringOperations step = new StringOperations( smh.stepMeta, smh.stepDataInterface, 0, smh.pipelineMeta, smh.pipeline );
