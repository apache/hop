...
public class UnivariateStatsMetaTest {
  ...
  public void testLegacyLoadXml() throws IOException, HopXMLException {
    String legacyXml =
      IOUtils.toString( UnivariateStatsMetaTest.class.getClassLoader().getResourceAsStream(
              "org/apache/hop/pipeline/steps/univariatestats/legacyUnivariateStatsMetaTest.xml") );
  ...
  public void testGetStep() {
    ...
    when( mockPipelineMeta.findStep( "testName" ) ).thenReturn( mockStepMeta );
    StepInterface step =
      new UnivariateStatsMeta().getStep( mockStepMeta, mockStepDataInterface, cnr, mockPipelineMeta, mockPipeline );
