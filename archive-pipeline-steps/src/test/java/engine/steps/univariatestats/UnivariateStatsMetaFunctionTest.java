  ...
  public void testNodeConstructor() throws IOException, HopXMLException {
    String functionXml =
      IOUtils.toString( UnivariateStatsMetaTest.class.getClassLoader().getResourceAsStream(
              "org/apache/hop/pipeline/steps/univariatestats/trueValuesUnivariateStatsMetaFunctionNode.xml") );
    UnivariateStatsMetaFunction function =
    ...
    functionXml =
      IOUtils.toString( UnivariateStatsMetaTest.class.getClassLoader().getResourceAsStream(
              "org/apache/hop/pipeline/steps/univariatestats/falseValuesUnivariateStatsMetaFunctionNode.xml") );
