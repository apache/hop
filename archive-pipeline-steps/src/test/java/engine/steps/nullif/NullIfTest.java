...
package org.apache.hop.pipeline.steps.nullif;
...
import org.apache.hop.pipeline.steps.nullif.NullIfMeta.Field;
...
public class NullIfTest {
  ...
  private NullIfMeta mockProcessRowMeta() throws HopStepException {
  ...
  public void test() throws HopException {
    ...
    NullIf step = new NullIf( smh.stepMeta, smh.stepDataInterface, 0, smh.pipelineMeta, smh.pipeline );
