...
import org.apache.hop.pipeline.PipelineTestFactory;
...
public class NormaliserTest {
  ...
  public void testNormaliserProcessRowsWikiData() throws Exception {
    ...
    PipelineMeta pipelineMeta = PipelineTestFactory.generateTestTransformation( null, stepMeta, stepName );
    List<RowMetaAndData> inputList = getWikiInputRowMetaAndData();
    List<RowMetaAndData> outputList = PipelineTestFactory.executeTestTransformation( pipelineMeta, PipelineTestFactory.INJECTOR_STEPNAME, stepName, PipelineTestFactory.DUMMY_STEPNAME, inputList );
