...
public class ValidatorTest {
  ...
  public void setUp() throws Exception {
    ...
    validator =
      spy( new Validator(
        mockHelper.stepMeta, mockHelper.stepDataInterface, 0, mockHelper.pipelineMeta, mockHelper.pipeline ) );
  }
  ...
  public void readSourceValuesFromInfoStepsTest() throws Exception {
    ...
    mockHelper.pipelineMeta.setStep( 0, stepMeta );
    Mockito.when( mockHelper.pipelineMeta.findStep( Mockito.eq( name ) ) ).thenReturn( stepMeta );
