...
import org.apache.hop.pipeline.steps.mailinput.MailInput.MessageParser;
...
public class ParseMailInputTest {
  ...
  public void beforeTest() throws MessagingException, IOException, HopException {
    ...
    mailInput = new MailInput( stepMockHelper.stepMeta, data, 0, stepMockHelper.pipelineMeta, stepMockHelper.pipeline );
