...
public class GroupByTest {
  ...
  public void testProcessRow() throws HopException {
    ...
    when( mockHelper.pipelineMeta.getPrevStepFields( mockHelper.stepMeta ) ).thenReturn( new RowMeta() );
  ...
  public void testAddToBuffer() throws HopException, FileSystemException {
    ...
    GroupBy groupBySpy = Mockito.spy(
      new GroupBy( mockHelper.stepMeta, groupByData, 0, mockHelper.pipelineMeta, mockHelper.pipeline ) );
