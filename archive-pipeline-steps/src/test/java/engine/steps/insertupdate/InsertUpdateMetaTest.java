...
import org.apache.hop.pipeline.steps.loadsave.validator.BooleanLoadSaveValidator;
import org.apache.hop.pipeline.steps.loadsave.validator.DatabaseMetaLoadSaveValidator;
import org.apache.hop.pipeline.steps.loadsave.validator.FieldLoadSaveValidator;
import org.apache.hop.pipeline.steps.loadsave.validator.PrimitiveBooleanArrayLoadSaveValidator;
...
public class InsertUpdateMetaTest {
  ...
  public void setUp() {
    ...
    upd = new InsertUpdate( stepMeta, ud, 1, pipelineMeta, pipeline );
  ...
  public void testErrorProcessRow() throws HopException {
    ...
    InsertUpdate insertUpdateStep =
      new InsertUpdate( mockHelper.stepMeta, mockHelper.stepDataInterface, 0, mockHelper.pipelineMeta, mockHelper.pipeline );
    ...
    Mockito.doThrow( new HopStepException( "Test exception" ) ).when( insertUpdateStep ).putRow( Mockito.any(), Mockito.any() );
