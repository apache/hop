...
set _HOP_OPTIONS=%_HOP_OPTIONS% -DHOP_PLATFORM_RUNTIME=Export
...
echo ===[Environment Settings - hop-export.bat]===================================
echo.
...
:Run
echo Command to start HopExport will be:
echo %_HOP_JAVA% -classpath %CLASSPATH% -Djava.library.path=%LIBSPATH% %_HOP_OPTIONS% org.apache.hop.diagram.command.DiagramExportCommand %_cmdline%
echo.
echo ===[Starting HopExport]=========================================================

%_HOP_JAVA% -classpath %CLASSPATH% -Djava.library.path=%LIBSPATH% %_HOP_OPTIONS% org.apache.hop.diagram.command.DiagramExportCommand %_cmdline%
