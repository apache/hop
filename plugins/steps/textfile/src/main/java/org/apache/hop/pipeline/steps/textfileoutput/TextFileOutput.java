...
public class TextFileOutput extends BaseStep implements StepInterface {
  ...
  public TextFileOutput( StepMeta stepMeta, StepDataInterface stepDataInterface, int copyNr, PipelineMeta pipelineMeta,
                         Pipeline pipeline ) {
  ...
  private CompressionProvider getCompressionProvider() throws HopException {
  ...
  public void writeRow( RowMetaInterface rowMeta, Object[] r ) throws HopStepException {
    try {
      ...
      throw new HopStepException( "Error writing line", e );
    }
  }
  ...
  private byte[] getBinaryString( String string ) throws HopStepException {
    try {
      if ( data.hasEncoding ) {
  ...
  private void writeField( ValueMetaInterface v, Object valueData, byte[] nullString ) throws HopStepException {
    try {
      byte[] str;
      ...
      throw new HopStepException( "Error writing field content to file", e );
    }
  }
