...
import org.apache.hop.pipeline.steps.fileinput.TextFileInputData;
...
public class PDI_2875_Test {
  ...
  public void testVariableSubstitution() {
    ...
    TextFileInput step = spy( new TextFileInput( smh.stepMeta, smh.stepDataInterface, 0, smh.pipelineMeta, smh.pipeline ) );
