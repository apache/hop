...
@Step(
        ...
        i18nPackageName = "i18n:org.apache.hop.pipeline.steps.fieldsplitter",
        name = "BaseStep.TypeLongDesc.SplitFields",
        description = "BaseStep.TypeTooltipDesc.SplitFields",
...
public class FieldSplitterMeta extends BaseStepMeta implements StepMetaInterface {
  ...
  public StepInterface getStep( StepMeta stepMeta, StepDataInterface stepDataInterface, int cnr,
    ...
    return new FieldSplitter( stepMeta, stepDataInterface, cnr, pipelineMeta, pipeline );
  }
