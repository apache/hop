 ...
 * @since 27-jan-2009
 */
@Step( id = "AnalyticQuery", i18nPackageName = "org.apache.hop.trans.steps.analyticquery",
  name = "AnalyticQuery.Name", description = "AnalyticQuery.Description",
  categoryDescription = "i18n:org.apache.hop.trans.step:BaseStep.Category.Statistics" )
...
public class AnalyticQueryMeta extends BaseStepMeta implements StepMetaInterface {
  private static final Class<?> PKG = AnalyticQuery.class; // for i18n purposes, needed by Translator2!!
