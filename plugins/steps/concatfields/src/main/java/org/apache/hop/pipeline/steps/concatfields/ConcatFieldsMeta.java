...
public class ConcatFieldsMeta extends TextFileOutputMeta implements StepMetaInterface {
  ...
  private static final Class<?> PKG = ConcatFieldsMeta.class; // for i18n purposes, needed by Translator!!
  ...
  public StepInterface getStep( StepMeta stepMeta, StepDataInterface stepDataInterface, int cnr,
    ...
    return new ConcatFields( stepMeta, stepDataInterface, cnr, pipelineMeta, pipeline );
  }
