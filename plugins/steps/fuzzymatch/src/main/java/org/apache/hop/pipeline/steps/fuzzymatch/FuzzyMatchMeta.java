...
@Step(
        ...
        i18nPackageName = "i18n:org.apache.hop.pipeline.steps.fuzzymatch",
        name = "BaseStep.TypeLongDesc.FuzzyMatch",
        description = "BaseStep.TypeTooltipDesc.FuzzyMatch",
...
public class FuzzyMatchMeta extends BaseStepMeta implements StepMetaInterface {
  ...
  public StepInterface getStep( StepMeta stepMeta, StepDataInterface stepDataInterface, int cnr,
    ...
    return new FuzzyMatch( stepMeta, stepDataInterface, cnr, pipelineMeta, pipeline );
  }
