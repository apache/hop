...
public class FuzzyMatchTest {
  ...
  private class FuzzyMatchHandler extends FuzzyMatch {
    ...
    public FuzzyMatchHandler( StepMeta stepMeta, StepDataInterface stepDataInterface, int copyNr, PipelineMeta pipelineMeta,
                              Pipeline pipeline ) {
  ...
  public void testProcessRow() throws Exception {
    fuzzyMatch =
      new FuzzyMatchHandler( mockHelper.stepMeta, mockHelper.stepDataInterface, 0, mockHelper.pipelineMeta,
        mockHelper.pipeline );
