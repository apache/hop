...
public class TeraFast extends AbstractStep implements StepInterface {
   ...
   * {@inheritDoc}
   *
   * @see org.apache.hop.pipeline.step.BaseStep#init(StepMetaInterface,
   * StepDataInterface)
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * @see org.apache.hop.pipeline.step.BaseStep#processRow(StepMetaInterface,
   * StepDataInterface)
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * @see org.apache.hop.pipeline.step.BaseStep#dispose(StepMetaInterface,
   * StepDataInterface)
   */
  @Override
