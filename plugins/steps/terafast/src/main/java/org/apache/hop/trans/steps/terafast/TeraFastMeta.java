...
public class TeraFastMeta extends AbstractStepMeta {
   ...
   * {@inheritDoc}
   *
   * @see org.apache.hop.trans.step.StepMetaInterface#check(List, TransMeta,
   ...
   * {@inheritDoc}
   *
   * @see org.apache.hop.trans.step.StepMetaInterface#getStep(StepMeta,
   * StepDataInterface, int, TransMeta, Trans)
   */
   ...
   * {@inheritDoc}
   *
   * @see org.apache.hop.trans.step.StepMetaInterface#setDefault()
   */
   ...
   * {@inheritDoc}
   *
   * @see org.apache.hop.trans.step.BaseStepMeta#getFields(RowMetaInterface, String,
   ...
   * {@inheritDoc}
   *
   * @see org.apache.hop.trans.step.BaseStepMeta#getRequiredFields(VariableSpace)
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * @see org.apache.hop.trans.step.BaseStepMeta#clone()
   */
  @Override
  public Object clone() {
    return super.clone();
