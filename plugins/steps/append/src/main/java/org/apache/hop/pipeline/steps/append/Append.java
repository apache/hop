...
public class Append extends BaseStep implements StepInterface {
  ...
  public Append( StepMeta stepMeta, StepDataInterface stepDataInterface, int copyNr, PipelineMeta pipelineMeta,
                 Pipeline pipeline ) {
  ...
  public boolean init( StepMetaInterface smi, StepDataInterface sdi ) {
    ...
    if ( super.init( smi, sdi ) ) {
      ...
      if ( meta.headStepname != null ) {
        headStream.setStepMeta( getPipelineMeta().findStep( meta.headStepname ) );
      }
      if ( meta.tailStepname != null ) {
        tailStream.setStepMeta( getPipelineMeta().findStep( meta.tailStepname ) );
      }
