...
public class SelectValuesTest {
  ...
  public void testPDI16368() throws Exception {
    ...
    //
    step2 = new SelectValuesHandler( helper.stepMeta, helper.stepDataInterface, 1, helper.pipelineMeta, helper.pipeline );
    step2 = spy( step2 );
  ...
  public class SelectValuesHandler extends SelectValues {
    ...
    public SelectValuesHandler( StepMeta stepMeta, StepDataInterface stepDataInterface, int copyNr, PipelineMeta pipelineMeta,
                                Pipeline pipeline ) {
