...
package org.apache.hop.pipeline.steps.fileexists;
...
@Step(
        ...
        i18nPackageName = "i18n:org.apache.hop.pipeline.steps.fileexists",
        name = "BaseStep.TypeLongDesc.FileExists",
        description = "BaseStep.TypeTooltipDesc.FileExists",
...
public class FileExistsMeta extends BaseStepMeta implements StepMetaInterface {
  ...
  public StepInterface getStep( StepMeta stepMeta, StepDataInterface stepDataInterface, int cnr,
    ...
    return new FileExists( stepMeta, stepDataInterface, cnr, pipelineMeta, pipeline );
  }
