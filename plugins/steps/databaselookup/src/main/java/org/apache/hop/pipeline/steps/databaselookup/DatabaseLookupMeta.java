...
@Step(
        ...
        i18nPackageName = "org.apache.hop.pipeline.steps.databaselookup",
...
public class DatabaseLookupMeta extends BaseStepMeta implements StepMetaInterface,
  ...
  public StepInterface getStep( StepMeta stepMeta, StepDataInterface stepDataInterface, int cnr,
    ...
    return new DatabaseLookup( stepMeta, stepDataInterface, cnr, pipelineMeta, pipeline );
  }
  ...
  @Override
  public void analyseImpact( List<DatabaseImpact> impact, PipelineMeta pipelineMeta, StepMeta stepinfo,
    ...
    for ( int i = 0; i < streamKeyField1.length; i++ ) {
      ...
      DatabaseImpact ii =
        new DatabaseImpact(
          DatabaseImpact.TYPE_IMPACT_READ, pipelineMeta.getName(), stepinfo.getName(), databaseMeta
    ...
    for ( int i = 0; i < returnValueField.length; i++ ) {
      DatabaseImpact ii =
        new DatabaseImpact(
          DatabaseImpact.TYPE_IMPACT_READ, pipelineMeta.getName(), stepinfo.getName(),
