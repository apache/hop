...
package org.apache.hop.pipeline.steps.sql;
...
@Step(
  ...
  i18nPackageName = "org.apache.hop.pipeline.steps.sql",
  name = "BaseStep.TypeLongDesc.ExecSQLRow",
  description = "BaseStep.TypeTooltipDesc.ExecuteSQL",
  categoryDescription = "i18n:org.apache.hop.pipeline.step:BaseStep.Category.Scripting"
)
...
public class ExecSQLMeta extends BaseStepMeta implements StepMetaInterface {
  ...
  public void setConnection( String connectionName ) {
    databaseMeta = DatabaseMeta.findDatabase( getParentStepMeta().getParentPipelineMeta().getDatabases(), connectionName );
  }
  ...
  public StepInterface getStep( StepMeta stepMeta, StepDataInterface stepDataInterface, int cnr,
    ...
    return new ExecSQL( stepMeta, stepDataInterface, cnr, pipelineMeta, pipeline );
  }
  ...
  public void analyseImpact( List<DatabaseImpact> impact, PipelineMeta pipelineMeta, StepMeta stepMeta, RowMeta prev,
                             String[] input, String[] output, RowMeta info ) throws HopStepException {
    DatabaseImpact ii =
      new DatabaseImpact(
        DatabaseImpact.TYPE_IMPACT_READ_WRITE, pipelineMeta.getName(), stepMeta.getName(),
