...
package org.apache.hop.pipeline.steps.getfilesrowcount;
...
@Step(
        ...
        i18nPackageName = "i18n:org.apache.hop.pipeline.steps.getfilesrowcount",
        name = "BaseStep.TypeLongDesc.GetFilesRowsCount",
        description = "BaseStep.TypeTooltipDesc.GetFilesRowsCount",
...
public class GetFilesRowsCountMeta extends BaseStepMeta implements StepMetaInterface {
  ...
  public StepInterface getStep( StepMeta stepMeta, StepDataInterface stepDataInterface, int cnr, PipelineMeta tr,
                                Pipeline pipeline ) {
    return new GetFilesRowsCount( stepMeta, stepDataInterface, cnr, tr, pipeline );
  }
