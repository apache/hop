...
package org.apache.hop.pipeline.steps.combinationlookup;
...
@Step(
  ...
  name = "CombinationLookup.Name",
  description = "CombinationLookup.Description",
  categoryDescription = "BaseStep.Category.DataWarehouse",
  i18nPackageName = "org.apache.hop.pipeline.step"
)
...
public class CombinationLookupMeta extends BaseStepMeta implements StepMetaInterface,
  ...
  public StepInterface getStep( StepMeta stepMeta, StepDataInterface stepDataInterface, int cnr,
    ...
    return new CombinationLookup( stepMeta, stepDataInterface, cnr, pipelineMeta, pipeline );
  }
  ...
  public void analyseImpact( List<DatabaseImpact> impact, PipelineMeta pipelineMeta, StepMeta stepMeta,
    ...
    for ( int i = 0; i < keyField.length; i++ ) {
      ...
      DatabaseImpact ii =
        new DatabaseImpact(
          DatabaseImpact.TYPE_IMPACT_READ_WRITE, pipelineMeta.getName(), stepMeta.getName(), databaseMeta
