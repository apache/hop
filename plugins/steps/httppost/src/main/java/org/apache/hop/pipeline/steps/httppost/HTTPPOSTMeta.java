...
package org.apache.hop.pipeline.steps.httppost;
...
@Step(
        id = "HTTPPOST",
        image = "ui/images/HTP.svg",
        i18nPackageName = "i18n:org.apache.hop.pipeline.steps.httppost",
        name = "BaseStep.TypeLongDesc.HTTPPOST",
        description = "BaseStep.TypeTooltipDesc.HTTPPOST",
...
public class HTTPPOSTMeta extends BaseStepMeta implements StepMetaInterface {
  ...
  public StepInterface getStep( StepMeta stepMeta, StepDataInterface stepDataInterface, int cnr,
    ...
    return new HTTPPOST( stepMeta, stepDataInterface, cnr, pipelineMeta, pipeline );
  }
  ...
  public String getDialogClassName(){
    return HTTPPOSTDialog.class.getName();
  }
}
