...
@Step( id = "ChangeFileEncoding", i18nPackageName = "org.apache.hop.pipeline.steps.changefileencoding",
...
public class ChangeFileEncodingMeta extends BaseStepMeta implements StepMetaInterface {
  ...
  public StepInterface getStep( StepMeta stepMeta, StepDataInterface stepDataInterface, int cnr, PipelineMeta pipelineMeta,
                                Pipeline pipeline ) {
    return new ChangeFileEncoding( stepMeta, stepDataInterface, cnr, pipelineMeta, pipeline );
  }
