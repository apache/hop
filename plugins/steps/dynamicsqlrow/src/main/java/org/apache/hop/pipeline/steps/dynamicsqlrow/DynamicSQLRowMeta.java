...
package org.apache.hop.pipeline.steps.dynamicsqlrow;
...
@Step(
        ...
        i18nPackageName = "org.apache.hop.pipeline.steps.dynamicsqlrow",
...
public class DynamicSQLRowMeta extends BaseStepMeta implements StepMetaInterface {
  ...
  public StepInterface getStep( StepMeta stepMeta, StepDataInterface stepDataInterface, int cnr, PipelineMeta tr,
                                Pipeline pipeline ) {
    return new DynamicSQLRow( stepMeta, stepDataInterface, cnr, tr, pipeline );
  }
