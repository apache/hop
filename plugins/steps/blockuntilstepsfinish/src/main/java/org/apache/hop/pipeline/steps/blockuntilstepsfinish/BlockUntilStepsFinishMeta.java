...
@Step(
        id = "BlockUntilStepsFinish",
        image = "ui/images/WFS.svg",
        i18nPackageName = "i18n:org.apache.hop.pipeline.steps.blockuntilstepsfinish",
        name = "BaseStep.TypeLongDesc.BlockUntilStepsFinish",
        description = "BaseStep.TypeLongDesc.BlockUntilStepsFinish",
...
public class BlockUntilStepsFinishMeta extends BaseStepMeta implements StepMetaInterface {
  ...
  public StepInterface getStep( StepMeta stepMeta, StepDataInterface stepDataInterface, int cnr, PipelineMeta tr,
                                Pipeline pipeline ) {
    return new BlockUntilStepsFinish( stepMeta, stepDataInterface, cnr, tr, pipeline );
  }
  ...
  public String getDialogClassName(){
    return BlockUntilStepsFinishDialog.class.getName();
  }
