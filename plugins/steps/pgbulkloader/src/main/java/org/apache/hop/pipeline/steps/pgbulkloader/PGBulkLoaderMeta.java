...
@Step(
  id = "PGBulkLoader",
  i18nPackageName = "org.apache.hop.pipeline.steps.pgbulkloader",
...
public class PGBulkLoaderMeta extends BaseStepMeta implements StepMetaInterface,
  ...
  @Override
  public void analyseImpact( List<DatabaseImpact> impact, PipelineMeta pipelineMeta, StepMeta stepMeta, RowMetaInterface prev, String[] input, String[] output, RowMetaInterface info, IMetaStore metaStore )
  ...
  public StepInterface getStep( StepMeta stepMeta, StepDataInterface stepDataInterface, int cnr,
    ...
    return new PGBulkLoader( stepMeta, stepDataInterface, cnr, pipelineMeta, pipeline );
  }
