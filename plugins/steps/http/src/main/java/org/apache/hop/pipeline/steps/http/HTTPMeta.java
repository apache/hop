...
@Step(
        ...
        i18nPackageName = "i18n:org.apache.hop.pipeline.steps.http",
        name = "BaseStep.TypeLongDesc.HTTP",
        description = "BaseStep.TypeTooltipDesc.HTTP",
...
public class HTTPMeta extends BaseStepMeta implements StepMetaInterface {
  ...
  public StepInterface getStep( StepMeta stepMeta, StepDataInterface stepDataInterface, int cnr,
    ...
    return new HTTP( stepMeta, stepDataInterface, cnr, pipelineMeta, pipeline );
  }
