...
public class ExcelWriterStep_StyleFormatTest {
  ...
  private void testStyleFormat( String fileType ) throws Exception {
    ...
    // We do not run pipeline or executing the whole step
   ...
   * @throws HopException
   */
  private void createStepMeta( String fileType ) throws HopException {
   ...
   * @throws HopException
   */
  private void createStepData( String fileType ) throws HopException {
    ...
    // we don't run pipeline so ExcelWriterStep.processRow() doesn't get executed
  ...
  private void setupStepMock( String fileType ) throws Exception {
    step =
      new ExcelWriterStep(
        stepMockHelper.stepMeta, stepMockHelper.stepDataInterface, 0, stepMockHelper.pipelineMeta, stepMockHelper.pipeline );
