...
package org.apache.hop.pipeline.steps.exceloutput;
...
public class ExcelOutput extends BaseStep implements StepInterface {
  ...
  public ExcelOutput( StepMeta stepMeta, StepDataInterface stepDataInterface, int copyNr, PipelineMeta pipelineMeta, Pipeline pipeline ) {
  ...
  private void addFilenameToResult() throws HopException {
    try {
      ...
      throw new HopException( "Unable to add filename to the result", e );
    }
  }
