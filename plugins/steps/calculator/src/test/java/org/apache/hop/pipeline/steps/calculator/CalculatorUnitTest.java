...
public class CalculatorUnitTest {
  ...
  public void testMissingFile() throws HopException {
    ...
    Calculator calculator = spy( new Calculator( smh.stepMeta, smh.stepDataInterface, 0, smh.pipelineMeta, smh.pipeline ) );
  ...
  public void testAddSeconds() throws HopException {
    ...
    Calculator calculator = new Calculator( smh.stepMeta, smh.stepDataInterface, 0, smh.pipelineMeta, smh.pipeline );
    calculator.addRowSetToInputRowSets( inputRowSet );
    calculator.setInputRowMeta( inputRowMeta );
    calculator.init( smh.initStepMetaInterface, smh.initStepDataInterface );
