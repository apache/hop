...
package org.apache.hop.pipeline.steps.denormaliser;
...
/**
 * The Denormaliser pipeline step meta-data
 *
 * @author Matt
 * @since 17-jan-2006
 */
...
@Step(
        ...
        i18nPackageName = "org.apache.hop.pipeline.steps.denormaliser",
...
public class DenormaliserMeta extends BaseStepMeta implements StepMetaInterface {
  ...
  public StepInterface getStep( StepMeta stepMeta, StepDataInterface stepDataInterface, int cnr,
    ...
    return new Denormaliser( stepMeta, stepDataInterface, cnr, pipelineMeta, pipeline );
  }
