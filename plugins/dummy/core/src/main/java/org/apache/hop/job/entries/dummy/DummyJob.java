...
public class DummyJob {
  ...
  public long process() throws HopJobException, FileNotFoundException {
  ...
  public File getDir( String dirname ) throws HopJobException {
    File fl = new File( dirname );
    if ( !fl.isDirectory() ) {
      throw new HopJobException( "'" + dirname + "' is not a directory" );
    }
    return fl;
  }
