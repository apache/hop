...
public class GitRepositoryEditor extends MetadataEditor<GitRepository> {
   ...
   */
  public GitRepositoryEditor(HopGui hopGui, MetadataManager<GitRepository> manager, GitRepository metadata) {
  ...
  public void createControl(Composite parent) {
	  ...
	  directoryButton.addSelectionListener( new SelectionAdapter() {
	      ...
	      public void widgetSelected( SelectionEvent e ) {
	        String filterPath = BaseDialog.presentDirectoryDialog( getShell(), getMetadataManager().getVariables() );
	        if (filterPath!=null) {
