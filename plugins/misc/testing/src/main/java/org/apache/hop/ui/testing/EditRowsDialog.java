...
public class EditRowsDialog {
  private static final Class<?> PKG = EditRowsDialog.class; // for i18n purposes, needed by Translator2!!
  ...
  private Object[] getRowForData( TableItem item, int rowNr ) throws HopException {
    try {
      ...
      throw new HopException( BaseMessages.getString( PKG, "EditRowsDialog.Error.ErrorGettingRowForData",
