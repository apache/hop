...
class MailInputMetaTest implements IInitializer<ITransformMeta> {
  ...
  void setUpLoadSave() throws Exception {
    ...
    ListLoadSaveValidator<MailInputField> inputFieldsValidator =
        new ListLoadSaveValidator<>(new MailInputFieldLoadSaveValidator());
    attrValidatorMap.put("inputFields", inputFieldsValidator);
    ...
    attrValidatorMap.put("valueImapList", new IntLoadSaveValidator(1));
