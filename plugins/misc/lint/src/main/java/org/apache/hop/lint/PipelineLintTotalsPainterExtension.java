 ...
 */
@ExtensionPoint(
    id = "PipelineLintTotalsPainterExtension",
    extensionPointId = "PipelinePainterEnd",
    description = "Draws lint totals as a pipeline canvas overlay")
public class PipelineLintTotalsPainterExtension implements IExtensionPoint<PipelinePainter> {

  private static final int SCREEN_X = 10;
  private static final int SCREEN_Y = 10;

  @Override
  public void callExtensionPoint(ILogChannel log, IVariables variables, PipelinePainter painter)
      throws HopException {
    ...
    try {
      ...
      String filePath = LintPathUtils.normalizePath(pipelineMeta.getFilename());
      ...
      log.logError("Error drawing pipeline lint totals overlay: " + e.getMessage(), e);
    }
  }
}
