...
@ExtensionPoint(
    id = "PipelineAfterOpenLintExtension",
    extensionPointId = "PipelineAfterOpen",
    description = "Attaches lint problems bar when a pipeline is opened")
public class PipelineAfterOpenLintExtension implements IExtensionPoint<PipelineMeta> {
