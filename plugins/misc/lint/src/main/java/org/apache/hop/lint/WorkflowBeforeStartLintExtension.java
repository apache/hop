...
/**
 * When a workflow starts, leave the lint Problems tab and show the log instead.
 *
 ...
 */
@ExtensionPoint(
    id = "WorkflowBeforeStartLintExtension",
    extensionPointId = "HopGuiWorkflowBeforeStart",
    description = "Moves the execution panel off the lint Problems tab when a workflow starts")
public class WorkflowBeforeStartLintExtension implements IExtensionPoint<Object> {
  ...
  public void callExtensionPoint(ILogChannel log, IVariables variables, Object object)
    ...
    try {
      ...
      HopGuiWorkflowGraph graph = HopGui.getActiveWorkflowGraph();
