...
public class ProjectDialog extends Dialog {
  ...
  public String open() {
    ...
    wVariables = new TableView( new Variables(), shell, SWT.NONE, columnInfo, project.getDescribedVariables().size(), null, props );
  ...
  private void getInfo( Project project, ProjectConfig projectConfig ) throws HopException {
    ...
    for ( int i = 0; i < wVariables.nrNonEmpty(); i++ ) {
      ...
      DescribedVariable variable = new DescribedVariable(
        item.getText( 1 ), // name
