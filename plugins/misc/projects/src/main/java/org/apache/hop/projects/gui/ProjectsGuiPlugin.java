...
public class ProjectsGuiPlugin {
    ...
    try {
      ...
      if ( projectName != null ) {
        ...
        if ( !localFound ) {
          ...
          box.setMessage( "Do you want to have a local workflow run configuration for this project?" );
          int anwser = box.open();
          if ( ( anwser & SWT.YES ) != 0 ) {
        ...
        box.setMessage( "If this project is part of a lifecyle then perhaps you want to add it to a lifecycle environment?" + Const.CR +
  ...
  public void selectEnvironment() {
    ...
    try {
      ...
      new ErrorDialog( hopGui.getShell(), "Error", "Error changing project to '" + environmentName, e );
    }
  }
  ...
  public static final void enableHopGuiProject( String projectName, Project project, LifecycleEnvironment environment ) throws HopException {
    try {
      HopGui hopGui = HopGui.getInstance();
      ...
      //
      AuditEvent prjUsedEvent = new AuditEvent(
