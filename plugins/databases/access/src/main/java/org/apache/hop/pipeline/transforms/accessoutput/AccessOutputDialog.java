...
public class AccessOutputDialog extends BaseTransformDialog implements ITransformDialog {
  ...
  private void onSelectFileName() {
    BaseDialog.presentFileDialog(false, shell, wFileName, variables,
        new String[] {"*.mdb;*.MDB;*.accdb;*.ACCDB", "*"},
        new String[] {BaseMessages.getString(PKG, "AccessOutputDialog.FileType.AccessFiles"),
    ...
    try {
      ...
      if ( !file.exists() || !file.isFile() ) {
        throw new HopException( BaseMessages.getString(
          PKG, "AccessOutputMeta.Exception.FileDoesNotExist", fileName ) );
      }
