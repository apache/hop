...
public class AccessDatabaseMeta extends BaseDatabaseMeta implements IDatabase {
  ...
  @Override
  public String getFieldDefinition(IValueMeta valueMeta, String tk, String pk, boolean useAutoinc,
  ...
  /**
   * Get the maximum length of a TEXT field for this database connection. If this size is
   * exceeded use a MEMO.
   *
