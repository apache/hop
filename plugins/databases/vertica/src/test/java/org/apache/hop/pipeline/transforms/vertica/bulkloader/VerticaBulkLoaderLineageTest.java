...
/** Checks the relational lineage the Vertica bulk loader declares on its metadata. */
class VerticaBulkLoaderLineageTest {

  private static VerticaBulkLoaderMeta meta() {
    ...
    meta.setFields(List.of(new VerticaBulkLoaderField("order_id", "id")));
    return meta;
  }
  ...
  void declaresAWriteToTheTargetTable() {
    ...
    assertNotNull(declaration, "VerticaBulkLoader should declare relational lineage");
