...
/** Checks the relational lineage the MySQL bulk loader declares on its metadata. */
class MySqlBulkLoaderLineageTest {

  private static MySqlBulkLoaderMeta meta() {
    ...
    field.setFieldTable("order_id");
    field.setFieldStream("id");
  ...
  void declaresAWriteToTheTargetTable() {
    ...
    assertNotNull(declaration, "MySqlBulkLoader should declare relational lineage");
