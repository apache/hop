...
/** The date handling that used to be an isTeradataVariant() branch in core. */
class TeradataTypeRulesTest {
  ...
  @Test
  void datesCarryHopsPrecisionOfOneMarker() throws Exception {
    IValueMeta valueMeta =
        DatabaseTypeMapper.getValueMeta(
            new Variables(),
            meta(new TeradataDatabaseMeta()),
            column(Types.DATE, "DATE", 0, 0),
            false,
            false);
