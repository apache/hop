...
@Action(
  id = "TRUNCATE_TABLES",
  i18nPackageName = "org.apache.hop.workflow.actions.truncatetables",
  name = "ActionTruncateTables.Name",
  description = "ActionTruncateTables.Description",
...
public class ActionTruncateTables extends ActionBase implements Cloneable, IAction {
  ...
  public Result execute( Result previousResult, int nr ) {
    ...
    if ( argFromPrevious ) {
      if ( log.isDetailed() ) {
        logDetailed( BaseMessages.getString( PKG, "ActionTruncateTables.FoundPreviousRows", String
            ...
            if ( !Utils.isEmpty( tableNamePrevious ) ) {
              if ( log.isDetailed() ) {
                logDetailed( BaseMessages.getString(
                  PKG, "ActionTruncateTables.ProcessingRow", tableNamePrevious, schemaNamePrevious ) );
              }
