...
/**
 * This dialog allows you to edit the Column Exists action settings. (select the connection and the table to be
...
public class ActionColumnsExistDialog extends ActionDialog implements IActionDialog {
  ...
  public IAction open() {
    ...
    wbdFilename.setToolTipText( BaseMessages.getString( PKG, "ActionColumnsExist.FilenameDelete.Tooltip" ) );
    ...
    ColumnInfo[] colinf =
      new ColumnInfo[] { new ColumnInfo( BaseMessages.getString(
        PKG, "ActionColumnsExist.Fields.Argument.Label" ), ColumnInfo.COLUMN_TYPE_TEXT, false ), };
      ...
      if ( databaseMeta != null ) {
        ...
        try {
          ...
          new ErrorDialog( shell, BaseMessages.getString( PKG, "System.Dialog.Error.Title" ), BaseMessages
            .getString( PKG, "ActionColumnsExist.ConnectionError2.DialogMessage", wTablename.getText() ), e );
        } finally {
          database.disconnect();
        }
      }
