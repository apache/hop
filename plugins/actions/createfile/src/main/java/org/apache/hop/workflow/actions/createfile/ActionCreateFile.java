...
/**
 * This defines a 'create file' action. Its main use would be to create empty trigger files that can be used to
...
@Action(
  id = "CREATE_FILE",
  i18nPackageName = "org.apache.hop.workflow.actions.createfile",
  name = "ActionCreateFile.Name",
  description = "ActionCreateFile.Description",
