...
public class WorkflowEntryHTTP_PDI208_Test {
  ...
  public static void setupBeforeClass() throws HopException, IOException {
    ...
    WorkflowEntryHTTP_PDI208_Test.startHTTPServer();
  }

  @AfterClass
  public static void tearDown() {
    WorkflowEntryHTTP_PDI208_Test.stopHTTPServer();
  }
  ...
  private static void startHTTPServer() throws IOException {
    httpServer = HttpServer.create( new InetSocketAddress( WorkflowEntryHTTP_PDI208_Test.HTTP_HOST, WorkflowEntryHTTP_PDI208_Test.HTTP_PORT ), 10 );
