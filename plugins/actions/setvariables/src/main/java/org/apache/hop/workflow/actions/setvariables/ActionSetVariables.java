...
@Action(
  id = "SET_VARIABLES",
  i18nPackageName = "org.apache.hop.workflow.actions.setvariables",
  name = "ActionSetVariables.Name",
...
public class ActionSetVariables extends ActionBase implements Cloneable, IAction {
  ...
  public Result execute( Result result, int nr ) throws HopException {
    ...
    try {
      ...
      // if parentWorkflow exists - clear/reset all entrySetVariables before applying the actual ones
        ...
        switch ( type ) {
          ...
          case VARIABLE_TYPE_CURRENT_WORKFLOW:
            ...
            if ( parentWorkflow != null ) {
              ...
              throw new HopWorkflowException( BaseMessages.getString(
