...
:language: en_US
:page-alternativeEditUrl: https://github.com/apache/incubator-hop/edit/master/workflow/actions/copymoveresultfilenames/src/main/doc/copymoveresultfilenames.adoc
