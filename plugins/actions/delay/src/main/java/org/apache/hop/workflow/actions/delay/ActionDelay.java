...
@Action(
  id = "DELAY",
  i18nPackageName = "org.apache.hop.workflow.actions.delay",
  name = "ActionDelay.Name",
  description = "ActionDelay.Description",
  image = "Delay.svg",
  ...
  public Result execute( Result previousResult, int nr ) {
    ...
    try {
      ...
      if ( iMaximumTimeout < 0 ) {
        ...
        logBasic( BaseMessages.getString( PKG, "ActionDelay.MaximumTimeReset.Label", String
