...
/**
 * This defines a 'delete file' action. Its main use would be to delete trigger files, but it will delete any file.
 *
 * @author Sven Boden
 * @since 10-02-2007
 */
...
@Action(
  id = "DELETE_FILE",
  i18nPackageName = "org.apache.hop.workflow.actions.deletefile",
  name = "ActionDeleteFile.Name",
  description = "ActionDeleteFile.Description",
  ...
  public void loadXml( Node entrynode,
    ...
    try {
      ...
      throw new HopXmlException( BaseMessages.getString(
        PKG, "ActionDeleteFile.Error_0001_Unable_To_Load_Job_From_Xml_Node" ), xe );
    }
  }
  ...
  public Result execute( Result previousResult, int nr ) {
    ...
    if ( filename != null ) {
      ...
      try {
        ...
        logError( BaseMessages.getString(
          PKG, "ActionDeleteFile.ERROR_0006_Exception_Deleting_File", realFilename, e.getMessage() ), e );
        result.setResult( false );
        result.setNrErrors( 1 );
      } finally {
        if ( fileObject != null ) {
