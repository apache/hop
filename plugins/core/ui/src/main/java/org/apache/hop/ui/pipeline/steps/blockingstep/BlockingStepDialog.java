...
package org.apache.hop.ui.pipeline.steps.blockingstep;
...
import org.apache.hop.pipeline.steps.blockingstep.BlockingStepMeta;
...
public class BlockingStepDialog extends BaseStepDialog implements StepDialogInterface {
  private static Class<?> PKG = BlockingStepDialog.class; // for i18n purposes, needed by Translator!!
  ...
  public BlockingStepDialog( Shell parent, Object in, PipelineMeta pipelineMeta, String sname ) {
