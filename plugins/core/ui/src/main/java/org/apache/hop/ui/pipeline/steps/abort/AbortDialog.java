...
package org.apache.hop.ui.pipeline.steps.abort;
...
import org.apache.hop.pipeline.steps.abort.AbortMeta;
...
@PluginDialog( id = "Abort", image = "ABR.svg", pluginType = PluginDialog.PluginType.STEP,
  documentationUrl = "Products/Data_Integration/Pipeline_Step_Reference/Abort" )
public class AbortDialog extends BaseStepDialog implements StepDialogInterface {
  private static Class<?> PKG = AbortDialog.class; // for i18n purposes, needed by Translator!!
