...
package org.apache.hop.ui.pipeline.steps.analyticquery;
...
import org.apache.hop.pipeline.steps.analyticquery.AnalyticQueryMeta;
...
public class AnalyticQueryDialog extends BaseStepDialog implements StepDialogInterface {
  private static Class<?> PKG = AnalyticQueryDialog.class; // for i18n purposes, needed by Translator!!
