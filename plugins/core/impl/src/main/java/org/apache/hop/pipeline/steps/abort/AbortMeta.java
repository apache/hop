 ...
 */
@Step( id = "Abort", i18nPackageName = "org.apache.hop.pipeline.steps.abort",
...
public class AbortMeta extends BaseStepMeta implements StepMetaInterface {
  private static Class<?> PKG = AbortMeta.class; // for i18n purposes, needed by Translator!!
  ...
  public StepInterface getStep( StepMeta stepMeta, StepDataInterface stepDataInterface, int copyNr,
    ...
    return new Abort( stepMeta, stepDataInterface, copyNr, pipelineMeta, pipeline );
  }
