...
package org.apache.hop.pipeline.steps.columnexists;
...
@Step( id = "ColumnExists", i18nPackageName = "org.apache.hop.pipeline.steps.columnexists", name = "ColumnExists.Name",
...
public class ColumnExistsMeta extends BaseStepMeta implements StepMetaInterface {
  private static Class<?> PKG = ColumnExistsMeta.class; // for i18n purposes, needed by Translator!!
  ...
  public StepInterface getStep( StepMeta stepMeta, StepDataInterface stepDataInterface, int cnr, PipelineMeta pipelineMeta,
                                Pipeline pipeline ) {
    return new ColumnExists( stepMeta, stepDataInterface, cnr, pipelineMeta, pipeline );
  }
