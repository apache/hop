...
import org.apache.hop.pipeline.transforms.mailvalidator.MailValidation;
import org.apache.hop.pipeline.transforms.mailvalidator.MailValidationResult;
...
@JobEntry(
  id = "MAIL_VALIDATOR",
  i18nPackageName = "org.apache.hop.job.entries.mailvalidator",
  name = "JobEntryMailValidator.Name",
  description = "JobEntryMailValidator.Description",
