...
public class JobEntryCreateFileDialog extends JobEntryDialog implements IJobEntryDialog {
  ...
  public JobEntryCreateFileDialog( Shell parent, IJobEntry jobEntryInt, JobMeta jobMeta ) {
