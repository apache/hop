...
@JobEntry(
  id = "SYSLOG",
  i18nPackageName = "org.apache.hop.job.entries.syslog",
  name = "JobEntrySyslog.Name",
  description = "JobEntrySyslog.Description",
  image = "Syslog.svg",
    ...
    try {
      ...
      if ( isAddTimestamp() ) {
        ...
        if ( Utils.isEmpty( pattern ) ) {
          ...
          throw new HopException( BaseMessages.getString( PKG, "JobEntrySyslog.DatePatternEmpty" ) );
        }
