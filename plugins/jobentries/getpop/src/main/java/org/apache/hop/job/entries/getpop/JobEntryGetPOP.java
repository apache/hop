...
@JobEntry(
  id = "GET_POP",
  i18nPackageName = "org.apache.hop.job.entries.getpop",
  name = "JobEntryGetPOP.Name",
  description = "JobEntryGetPOP.Description",
  image = "GetPOP.svg",
  categoryDescription = "i18n:org.apache.hop.job:JobCategory.Category.Mail"
)
public class JobEntryGetPOP extends JobEntryBase implements Cloneable, IJobEntry {
  ...
  public void loadXML( Node entrynode,
    ...
    try {
      ...
      throw new HopXMLException( "Unable to load job entry of type 'get pop' from XML node", xe );
    }
  }
