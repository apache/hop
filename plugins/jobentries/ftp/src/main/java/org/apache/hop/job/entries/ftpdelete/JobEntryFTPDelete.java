...
@JobEntry(
  id = "FTP_DELETE",
  i18nPackageName = "org.apache.hop.job.entries.ftpdelete",
  name = "JobEntryFTPDelete.Name",
  description = "JobEntryFTPDelete.Description",
  image = "FTPDelete.svg",
  categoryDescription = "i18n:org.apache.hop.job:JobCategory.Category.FileTransfer"
)

public class JobEntryFTPDelete extends JobEntryBase implements Cloneable, IJobEntry {
