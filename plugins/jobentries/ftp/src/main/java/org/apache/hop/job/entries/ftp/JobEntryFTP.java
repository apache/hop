...
@JobEntry(
  id = "FTP",
  i18nPackageName = "org.apache.hop.job.entries.ftp",
  name = "JobEntryFTP.Name",
  description = "JobEntryFTP.Description",
  image = "FTP.svg",
...
public class JobEntryFTP extends JobEntryBase implements Cloneable, IJobEntry {
  ...
  private void addFilenameToResultFilenames( Result result, Job parentJob, String filename ) throws HopException {
    if ( isaddresult ) {
