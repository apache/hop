...
public class JobEntryDeleteFileDialog extends JobEntryDialog implements IJobEntryDialog {
  ...
  public JobEntryDeleteFileDialog( Shell parent, IJobEntry jobEntryInt, JobMeta jobMeta ) {
