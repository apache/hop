...
@JobEntry(
  id = "DELETE_FILE",
  i18nPackageName = "org.apache.hop.job.entries.deletefile",
  name = "JobEntryDeleteFile.Name",
  description = "JobEntryDeleteFile.Description",
  image = "DeleteFile.svg",
  categoryDescription = "i18n:org.apache.hop.job:JobCategory.Category.FileManagement"
)
public class JobEntryDeleteFile extends JobEntryBase implements Cloneable, IJobEntry {
  private static Class<?> PKG = JobEntryDeleteFile.class; // for i18n purposes, needed by Translator!!
