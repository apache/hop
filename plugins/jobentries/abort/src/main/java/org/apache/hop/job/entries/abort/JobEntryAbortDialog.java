...
public class JobEntryAbortDialog extends JobEntryDialog implements IJobEntryDialog {
  private static final Class<?> PKG = JobEntryAbortDialog.class; // for i18n purposes, needed by Translator!!
  ...
  public JobEntryAbortDialog( Shell parent, IJobEntry jobEntryInt, JobMeta jobMeta ) {
