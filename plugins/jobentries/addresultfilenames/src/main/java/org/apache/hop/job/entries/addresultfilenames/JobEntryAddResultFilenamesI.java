...
@JobEntry(
  ...
  name = "JobEntryAddResultFilenames.Name",
  description = "JobEntryAddResultFilenames.Description",
  image="AddResultFileNames.svg",
  categoryDescription = "i18n:org.apache.hop.job:JobCategory.Category.FileManagement"
)
public class JobEntryAddResultFilenamesI extends JobEntryBase implements Cloneable, IJobEntry {
  private static Class<?> PKG = JobEntryAddResultFilenamesI.class; // for i18n purposes, needed by Translator!!
  ...
  public JobEntryAddResultFilenamesI( String n ) {
    super( n, "" );
  ...
  public JobEntryAddResultFilenamesI() {
    this( "" );
  }

  public Object clone() {
    JobEntryAddResultFilenamesI je = (JobEntryAddResultFilenamesI) super.clone();
    return je;
  }
