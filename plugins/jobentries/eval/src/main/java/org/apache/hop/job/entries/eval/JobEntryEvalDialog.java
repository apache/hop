...
public class JobEntryEvalDialog extends JobEntryDialog implements JobEntryDialogInterface {
  ...
  public JobEntryEvalDialog( Shell parent, JobEntryInterface jobEntryInt, JobMeta jobMeta ) {
    ...
    if ( this.jobEntry.getName() == null ) {
      this.jobEntry.setName( BaseMessages.getString( PKG, "JobEntryEval.Name.Default" ) );
    }
  }
  ...
  public JobEntryInterface open() {
    ...
    shell.setText( BaseMessages.getString( PKG, "JobEntryEval.Title" ) );
    ...
    wlName.setText( BaseMessages.getString( PKG, "JobEntryEval.Jobname.Label" ) );
    ...
    wlPosition.setText( BaseMessages.getString( PKG, "JobEntryEval.LineNr.Label", "0" ) );
    ...
    wlScript.setText( BaseMessages.getString( PKG, "JobEntryEval.Script.Label" ) );
    ...
    wScript.setText( BaseMessages.getString( PKG, "JobEntryEval.Script.Default" ) );
  ...
  public void setPosition() {
    ...
    wlPosition.setText( BaseMessages.getString( PKG, "JobEntryEval.Position.Label", "" + linenr, "" + colnr ) );
