...
@JobEntry(
  ...
  i18nPackageName = "org.apache.hop.job.entries.deleteresultfilenames",
  name = "JobEntryDeleteResultFilenames.Name",
  description = "JobEntryDeleteResultFilenames.Description",
  image = "DeleteResultFilenames.svg",
  categoryDescription = "i18n:org.apache.hop.job:JobCategory.Category.FileManagement"
)
public class JobEntryDeleteResultFilenamesI extends JobEntryBase implements Cloneable, IJobEntry {
  ...
  public JobEntryDeleteResultFilenamesI( String n ) {
    super( n, "" );
    foldername = null;
  ...
  public JobEntryDeleteResultFilenamesI() {
    this( "" );
  }

  public Object clone() {
    JobEntryDeleteResultFilenamesI je = (JobEntryDeleteResultFilenamesI) super.clone();
    return je;
  }
