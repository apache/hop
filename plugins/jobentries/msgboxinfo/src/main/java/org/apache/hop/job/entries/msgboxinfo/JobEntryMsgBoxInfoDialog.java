...
public class JobEntryMsgBoxInfoDialog extends JobEntryDialog implements IJobEntryDialog {
  private static Class<?> PKG = JobEntryMsgBoxInfo.class; // for i18n purposes, needed by Translator!!
  ...
  public JobEntryMsgBoxInfoDialog( Shell parent, IJobEntry jobEntryInt, JobMeta jobMeta ) {
