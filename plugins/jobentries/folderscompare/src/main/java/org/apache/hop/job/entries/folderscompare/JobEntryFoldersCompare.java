...
@JobEntry(
  id = "FOLDERS_COMPARE",
  i18nPackageName = "org.apache.hop.job.entries.folderscompare",
  name = "JobEntryFoldersCompare.Name",
  description = "JobEntryFoldersCompare.Description",
  image = "FoldersCompare.svg",
  categoryDescription = "i18n:org.apache.hop.job:JobCategory.Category.FileManagement"
)
public class JobEntryFoldersCompare extends JobEntryBase implements Cloneable, IJobEntry {
