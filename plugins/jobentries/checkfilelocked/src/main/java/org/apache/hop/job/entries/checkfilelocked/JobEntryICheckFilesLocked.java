...
public class JobEntryICheckFilesLocked extends JobEntryBase implements Cloneable, IJobEntry {
  ...
  public JobEntryICheckFilesLocked( String n ) {
    super( n, "" );
  ...
  public JobEntryICheckFilesLocked() {
    this( "" );
  }

  public Object clone() {
    JobEntryICheckFilesLocked je = (JobEntryICheckFilesLocked) super.clone();
    if ( arguments != null ) {
