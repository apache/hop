...
@JobEntry(
  id = "FILE_EXISTS",
  i18nPackageName = "org.apache.hop.job.entries.fileexists",
  name = "JobEntryFileExists.Name",
  description = "JobEntryFileExists.Description",
  image = "FileExists.svg",
  categoryDescription = "i18n:org.apache.hop.job:JobCategory.Category.Conditions"
)
public class JobEntryFileExists extends JobEntryBase implements Cloneable, IJobEntry {
