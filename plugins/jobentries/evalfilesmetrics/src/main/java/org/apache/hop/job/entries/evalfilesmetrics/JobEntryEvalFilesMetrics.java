...
@JobEntry(
  ...
  i18nPackageName = "org.apache.hop.job.entries.evalfilesmetrics",
  name = "JobEntryEvalFilesMetrics.Name",
  description = "JobEntryEvalFilesMetrics.Description",
  image = "EvalFilesMetrics.svg",
  categoryDescription = "i18n:org.apache.hop.job:JobCategory.Category.Conditions"
)
public class JobEntryEvalFilesMetrics extends JobEntryBase implements Cloneable, IJobEntry {
