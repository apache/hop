...
public class JobEntryTelnetDialog extends JobEntryDialog implements IJobEntryDialog {
  private static Class<?> PKG = JobEntryTelnet.class; // for i18n purposes, needed by Translator!!
  ...
  public JobEntryTelnetDialog( Shell parent, IJobEntry jobEntryInt, JobMeta jobMeta ) {
