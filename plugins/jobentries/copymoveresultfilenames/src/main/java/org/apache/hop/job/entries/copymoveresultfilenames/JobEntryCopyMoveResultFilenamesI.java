...
public class JobEntryCopyMoveResultFilenamesI extends JobEntryBase implements Cloneable, IJobEntry {
  ...
  public JobEntryCopyMoveResultFilenamesI( String n ) {
    super( n, "" );
  ...
  public JobEntryCopyMoveResultFilenamesI() {
    this( "" );
  }

  public Object clone() {
    JobEntryCopyMoveResultFilenamesI je = (JobEntryCopyMoveResultFilenamesI) super.clone();
    return je;
  }
