...
public class JobEntryCreateFolderDialog extends JobEntryDialog implements IJobEntryDialog {
  private static Class<?> PKG = JobEntryCreateFolder.class; // for i18n purposes, needed by Translator!!
  ...
  public JobEntryCreateFolderDialog( Shell parent, IJobEntry jobEntryInt, JobMeta jobMeta ) {
