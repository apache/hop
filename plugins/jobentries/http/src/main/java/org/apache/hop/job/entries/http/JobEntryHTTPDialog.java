...
public class JobEntryHTTPDialog extends JobEntryDialog implements IJobEntryDialog {
  ...
  public JobEntryHTTPDialog( Shell parent, IJobEntry jobEntryInt, JobMeta jobMeta ) {
