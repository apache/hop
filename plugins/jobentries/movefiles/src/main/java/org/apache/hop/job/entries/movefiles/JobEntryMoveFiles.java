...
@JobEntry(
  id = "MOVE_FILES",
  i18nPackageName = "org.apache.hop.job.entries.movefiles",
  name = "JobEntryMoveFiles.Name",
  description = "JobEntryMoveFiles.Description",
  image = "MoveFiles.svg",
  categoryDescription = "i18n:org.apache.hop.job:JobCategory.Category.FileManagement"
)
public class JobEntryMoveFiles extends JobEntryBase implements Cloneable, IJobEntry {
