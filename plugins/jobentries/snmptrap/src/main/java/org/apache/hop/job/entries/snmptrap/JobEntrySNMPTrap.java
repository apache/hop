...
@JobEntry(
  id = "SNMP_TRAP",
  i18nPackageName = "org.apache.hop.job.entries.snmptrap",
  name = "JobEntrySNMPTrap.Name",
  description = "JobEntrySNMPTrap.Description",
  image = "SNMP.svg",
...
public class JobEntrySNMPTrap extends JobEntryBase implements Cloneable, IJobEntry {
  ...
  public void loadXML( Node entrynode,
    ...
    try {
      ...
      throw new HopXMLException( "Unable to load job entry of type 'SNMPTrap' from XML node", xe );
    }
  }
