...
@JobEntry(
  ...
  i18nPackageName = "org.apache.hop.job.entries.webserviceavailable",
  name = "JobEntryWebServiceAvailable.Name",
  description = "JobEntryWebServiceAvailable.Description",
