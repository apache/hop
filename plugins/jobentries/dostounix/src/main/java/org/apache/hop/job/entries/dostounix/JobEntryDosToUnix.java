...
@JobEntry(
  ...
  i18nPackageName = "org.apache.hop.job.entries.dostounix",
  name = "JobEntryDosToUnix.Name",
  description = "JobEntryDosToUnix.Description",
  image = "DosToUnix.svg",
...
public class JobEntryDosToUnix extends JobEntryBase implements Cloneable, JobEntryInterface {
  ...
  private boolean convertOneFile( FileObject file, int convertion, Result result, Job parentJob ) throws HopException {
    boolean retval = false;
    try {
      // We deal with a file..
