...
public class JobEntrySendNagiosPassiveICheck extends JobEntryBase implements Cloneable, IJobEntry {
  ...
  public JobEntrySendNagiosPassiveICheck( String n ) {
    super( n, "" );
    port = "" + DEFAULT_PORT;
    serverName = null;
  ...
  public JobEntrySendNagiosPassiveICheck() {
    this( "" );
  }

  public Object clone() {
    JobEntrySendNagiosPassiveICheck je = (JobEntrySendNagiosPassiveICheck) super.clone();
    return je;
  }
