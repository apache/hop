...
class SparkLakeTableOutputMetaInjectionTest
    extends BaseMetadataInjectionTestJunit5<SparkLakeTableOutputMeta> {
  ...
  void test() throws Exception {
    ...
    check("SAVE_MODE", () -> meta.getSaveMode());
    check("PARTITION_BY", () -> meta.getPartitionByColumns());
    check("COALESCE", () -> meta.getCoalescePartitions());
