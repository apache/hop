...
class SparkLakeTableMaintenanceMetaInjectionTest
    extends BaseMetadataInjectionTestJunit5<SparkLakeTableMaintenanceMeta> {
  ...
  void test() throws Exception {
    ...
    check("RETENTION_HOURS", () -> meta.getRetentionHours());
    check("RETAIN_LAST", () -> meta.getRetainLast());
    check("WHERE_CLAUSE", () -> meta.getWhereClause());
    check("ZORDER_COLUMNS", () -> meta.getZOrderColumns());
    check("ACKNOWLEDGE_DESTRUCTIVE", () -> meta.isAcknowledgeDestructive());
  }
}
