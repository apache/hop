...
public class BeamBigQueryInputStepHandler extends BeamBaseStepHandler implements BeamStepHandler {
  ...
  public BeamBigQueryInputStepHandler( IBeamPipelineEngineRunConfiguration runConfiguration, IMetaStore metaStore, PipelineMeta pipelineMeta, List<String> stepPluginClasses, List<String> xpPluginClasses ) {
