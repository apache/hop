...
public class BeamInputStepHandler extends BeamBaseStepHandler implements BeamStepHandler {
  ...
  public BeamInputStepHandler( BeamJobConfig beamJobConfig, IMetaStore metaStore, PipelineMeta pipelineMeta, List<String> stepPluginClasses, List<String> xpPluginClasses ) {
