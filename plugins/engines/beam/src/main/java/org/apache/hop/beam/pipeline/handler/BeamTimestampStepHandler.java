...
public class BeamTimestampStepHandler extends BeamBaseStepHandler implements BeamStepHandler {
  ...
  public BeamTimestampStepHandler( BeamJobConfig beamJobConfig, IMetaStore metaStore, PipelineMeta pipelineMeta, List<String> stepPluginClasses, List<String> xpPluginClasses ) {
