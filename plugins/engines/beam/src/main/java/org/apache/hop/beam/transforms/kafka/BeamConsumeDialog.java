...
public class BeamConsumeDialog extends BaseTransformDialog implements ITransformDialog {
  ...
  public BeamConsumeDialog( Shell parent, Object in, PipelineMeta pipelineMeta, String sname ) {
  ...
  public String open() {
    ...
    wTopics = new TextVar( pipelineMeta, shell, SWT.SINGLE | SWT.LEFT | SWT.BORDER );
    ...
    wGroupId = new TextVar( pipelineMeta, shell, SWT.SINGLE | SWT.LEFT | SWT.BORDER );
    ...
    wConfigOptions = new TableView( pipelineMeta, shell, SWT.NONE, columns, input.getConfigOptions().size(), null, props );
