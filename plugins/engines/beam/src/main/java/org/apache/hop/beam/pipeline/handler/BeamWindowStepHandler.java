...
public class BeamWindowStepHandler extends BeamBaseStepHandler implements BeamStepHandler {
  ...
  public BeamWindowStepHandler( BeamJobConfig beamJobConfig, IMetaStore metaStore, PipelineMeta pipelineMeta, List<String> stepPluginClasses, List<String> xpPluginClasses ) {
