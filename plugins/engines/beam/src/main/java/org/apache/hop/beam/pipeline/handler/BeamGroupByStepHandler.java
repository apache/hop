...
public class BeamGroupByStepHandler extends BeamBaseStepHandler implements BeamStepHandler {
  ...
  public BeamGroupByStepHandler( BeamJobConfig beamJobConfig, IMetaStore metaStore, PipelineMeta pipelineMeta, List<String> stepPluginClasses, List<String> xpPluginClasses ) {
