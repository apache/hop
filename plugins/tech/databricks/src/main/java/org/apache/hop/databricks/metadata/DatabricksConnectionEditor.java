...
@GuiPlugin(description = "Editor for Databricks workspace connection metadata")
public class DatabricksConnectionEditor extends MetadataEditor<DatabricksConnection> {

  private static final Class<?> PKG = DatabricksConnection.class;

  public static final String GUI_WIDGETS_PARENT_ID = "DatabricksConnectionEditor-GuiWidgetsParent";

  private Text wName;
  private Composite wWidgetsComposite;
  private GuiCompositeWidgets guiCompositeWidgets;

  public DatabricksConnectionEditor(
      HopGui hopGui, MetadataManager<DatabricksConnection> manager, DatabricksConnection metadata) {
  ...
  public void createControl(Composite parent) {
    ...
    wlName.setText(BaseMessages.getString(PKG, "DatabricksConnection.Name.Label"));
    ...
    wTest.setText(BaseMessages.getString(PKG, "DatabricksConnection.Test.Label"));
  ...
  private void testConnection() {
    try {
      ...
      DatabricksConnection conn = getMetadata();
      try (DatabricksJobsClient client =
        ...
        box.setText(BaseMessages.getString(PKG, "DatabricksConnection.Test.Success.Title"));
        box.setMessage(
            BaseMessages.getString(PKG, "DatabricksConnection.Test.Success.Message", who));
        box.open();
      }
    } catch (Exception e) {
      new ErrorDialog(
          HopGui.getInstance().getShell(),
          BaseMessages.getString(PKG, "DatabricksConnection.Test.Error.Title"),
          BaseMessages.getString(PKG, "DatabricksConnection.Test.Error.Message"),
          e);
    }
  }
  ...
  public void setWidgetsContent() {
    DatabricksConnection meta = this.getMetadata();
  ...
  @Override
  public void getWidgetsContent(DatabricksConnection meta) {
