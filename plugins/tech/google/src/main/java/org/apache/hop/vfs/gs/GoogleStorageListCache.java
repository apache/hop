...
/**
 * Cache for GCS list results. When a directory is listed, we store the child keys and their
 * types/sizes so that later doAttach() calls for those children can be answered without extra API
 * calls.
 */
