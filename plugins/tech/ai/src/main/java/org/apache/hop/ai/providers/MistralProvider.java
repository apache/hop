...
public class MistralProvider extends BaseAiProvider {

  public MistralProvider() {
    setAuthKind(AiAuthKind.API_KEY);
    setHopModelType("MISTRAL");
    setRequiresApiKey(true);
    setDefaultBaseUrl("https://api.mistral.ai/v1");
    setDefaultModelName("mistral-small-latest");
  }
}
