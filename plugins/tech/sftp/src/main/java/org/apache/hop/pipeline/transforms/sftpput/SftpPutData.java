...
public class SftpPutData extends BaseTransformData implements ITransformData {
  ...
  public SftpConnection connection;

  public int indexOfSourceFileFieldName = -1;
  public int indexOfRemoteDirectory = -1;
  public int indexOfRemoteFilename = -1;
  public int indexOfMoveToFolderFieldName = -1;
