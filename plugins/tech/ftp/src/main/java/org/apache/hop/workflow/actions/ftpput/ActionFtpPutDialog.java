...
public class ActionFtpPutDialog extends ActionDialog {
  ...
  public IAction open() {
    ...
    wConnection =
        new MetaSelectionLine<>(
            ...
            wServerSettings,
            SWT.NONE,
            BaseMessages.getString(PKG, "ActionFtpPut.Connection.Label"),
            BaseMessages.getString(PKG, "ActionFtpPut.Connection.Tooltip"));
   ...
   */
  private IFtpConnection connectionSettings(ActionFtpPut onScreen) throws HopException {
      ...
      if (ftpclient == null || !ftpclient.isConnected()) {
        ...
        ftpclient =
            FtpClientFactory.connectAndLogin(
                LogChannel.UI, variables, connectionSettings(actionFtpPut));
  ...
  private void getInfo(ActionFtpPut actionFtpPut) {
    ...
    actionFtpPut.setConnection(wConnection.getText());
