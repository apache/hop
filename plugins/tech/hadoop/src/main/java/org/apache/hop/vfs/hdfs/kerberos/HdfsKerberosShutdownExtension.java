...
@ExtensionPoint(
    id = "HdfsKerberosShutdownExtension",
    extensionPointId = "HopServerShutdown",
    description = "Stop the HDFS Kerberos ticket renewer when Hop Server shuts down",
    classLoaderGroup = "vfs-hdfs")
public class HdfsKerberosShutdownExtension implements IExtensionPoint<Object> {
  @Override
