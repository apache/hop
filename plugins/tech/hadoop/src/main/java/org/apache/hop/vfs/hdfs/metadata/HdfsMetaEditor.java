...
public class HdfsMetaEditor extends MetadataEditor<HdfsMeta> {
  ...
  public static final String GUI_WIDGETS_PARENT_ID = "HdfsMetaEditor-GuiWidgetsParent";

  private TextVar wName;
  private Composite wWidgetsComposite;
  private GuiCompositeWidgets guiCompositeWidgets;

  public HdfsMetaEditor(HopGui hopGui, MetadataManager<HdfsMeta> manager, HdfsMeta metadata) {
  ...
  public void createControl(Composite parent) {
    ...
    wlName.setText(BaseMessages.getString(PKG, "HdfsMeta.Name.Label"));
  ...
  public void setWidgetsContent() {
    HdfsMeta meta = this.getMetadata();
  ...
  @Override
  public void getWidgetsContent(HdfsMeta meta) {
