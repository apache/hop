...
/** WebDAV over HTTPS with credentials from {@link WebDavConnection} metadata. */
public class HopWebDav4sConnectionFileProvider extends Webdav4sFileProvider {

  private final IVariables variables;
  private final WebDavConnection meta;

  public HopWebDav4sConnectionFileProvider(IVariables variables, WebDavConnection meta) {
