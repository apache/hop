...
public class SqsReaderDialog extends BaseTransformDialog implements ITransformDialog {
    ...
    public String open() {
        ...
        lblAWSCredChain.setText(BaseMessages.getString(PKG, "SQSReaderTransform.Settings.AWSCredChain.Label"));
        ...
        tAWSCredChain.setToolTipText(BaseMessages.getString(PKG, "SQSReaderTransform.Settings.AWSCredChain.Tooltip"));
        ...
        tAWSKey.setToolTipText(BaseMessages.getString(PKG, "SQSReaderTransform.Settings.AWSKey.Tooltip"));
        ...
        lblAWSKeySecret.setText(BaseMessages.getString(PKG, "SQSReaderTransform.Settings.AWSKeySecret.Label"));

        tAWSKeySecret = new PasswordTextVar(variables, settingsComp, SWT.SINGLE | SWT.LEFT | SWT.BORDER);
        ...
        tAWSKeySecret.setToolTipText(BaseMessages.getString(PKG, "SQSReaderTransform.Settings.AWSKeySecret.Tooltip"));
        ...
        lblAWSRegion.setText(BaseMessages.getString(PKG, "SQSReaderTransform.Settings.AWSRegion.Label"));
        ...
        tAWSRegion
                .setToolTipText(BaseMessages.getString(PKG, "SQSReaderTransform.Settings.AWSRegion.Tooltip"));
        ...
        tSQSQueue
                .setToolTipText(BaseMessages.getString(PKG, "SQSReaderTransform.Settings.SQSQueue.Tooltip"));
        ...
        grpOutputSettings.setText(BaseMessages.getString(PKG, "SQSReaderTransform.ReaderOutput.OutputSettings.GroupTitle"));
        ...
        lblMessageDelete.setText(BaseMessages.getString(PKG, "SQSReaderTransform.ReaderOutput.MessageDelete.Label"));
        ...
        tMessageDelete.setToolTipText(BaseMessages.getString(PKG, "SQSReaderTransform.ReaderOutput.MessageDelete.Tooltip"));
        ...
        lblMaxMessages.setText(BaseMessages.getString(PKG, "SQSReaderTransform.ReaderOutput.MaxMessages.Label"));
        ...
        tMaxMessages.setToolTipText(BaseMessages.getString(PKG, "SQSReaderTransform.ReaderOutput.MaxMessages.Tooltip"));
        ...
        grpOutputField.setText(BaseMessages.getString(PKG, "SQSReaderTransform.ReaderOutput.OutputFields.GroupTitle"));
        ...
        lblMessageID.setText(BaseMessages.getString(PKG, "SQSReaderTransform.ReaderOutput.MessageID.Label"));
        ...
        tMessageID
                .setToolTipText(BaseMessages.getString(PKG, "SQSReaderTransform.ReaderOutput.MessageID.Tooltip"));
        ...
        lblMessageBody.setText(BaseMessages.getString(PKG, "SQSReaderTransform.ReaderOutput.MessageBody.Label"));
        ...
        tMessageBody
                .setToolTipText(BaseMessages.getString(PKG, "SQSReaderTransform.ReaderOutput.MessageBody.Tooltip"));
        ...
        lblReceiptHandle.setText(BaseMessages.getString(PKG, "SQSReaderTransform.ReaderOutput.ReceiptHandle.Label"));
        ...
        tReceiptHandle
                .setToolTipText(BaseMessages.getString(PKG, "SQSReaderTransform.ReaderOutput.ReceiptHandle.Tooltip"));
        ...
        lblBodyMD5.setText(BaseMessages.getString(PKG, "SQSReaderTransform.ReaderOutput.BodyMD5.Label"));
        ...
        tBodyMD5
                .setToolTipText(BaseMessages.getString(PKG, "SQSReaderTransform.ReaderOutput.BodyMD5.Tooltip"));
        ...
        lblSNSMessage.setText(BaseMessages.getString(PKG, "SQSReaderTransform.ReaderOutput.SNSMessage.Label"));
        ...
        tSNSMessage
                .setToolTipText(BaseMessages.getString(PKG, "SQSReaderTransform.ReaderOutput.SNSMessage.Tooltip"));
