...
public class Add3 implements ICalculation {
  @Override
  ...
  public CalculationOutput calculate(CalculationInput in) throws HopValueException {
    Object value = ValueDataUtil.plus3(in.metaA, in.dataA, in.metaB, in.dataB, in.metaC, in.dataC);
    int resultType =
        (in.metaA.isString() || in.metaB.isString() || in.metaC.isString())
            ? IValueMeta.TYPE_STRING
            : ICalculation.getResultType(in.metaA);

    return new CalculationOutput(resultType, value);
  }
}
