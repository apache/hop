...
public class AddTimeToDate implements ICalculation {
  ...
  public CalculationOutput calculate(CalculationInput in) throws HopValueException {
    return new CalculationOutput(
        ...
        ValueDataUtil.addTimeToDate(in.metaA, in.dataA, in.metaB, in.dataB, in.metaC, in.dataC));
  }
}
