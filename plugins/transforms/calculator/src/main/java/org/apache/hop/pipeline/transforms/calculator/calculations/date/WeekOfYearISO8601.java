...
public class WeekOfYearISO8601 implements ICalculation {
  ...
  public CalculationOutput calculate(CalculationInput in) throws HopValueException {
    return new CalculationOutput(
        getDefaultResultType(), ValueDataUtil.weekOfYearISO8601(in.metaA, in.dataA));
  }
}
