...
public class RefinedSoundex implements ICalculation {
  ...
  public CalculationOutput calculate(CalculationInput in) {
    return new CalculationOutput(getDefaultResultType(), ValueDataUtil.getRefinedSoundEx(in.dataA));
  }
}
