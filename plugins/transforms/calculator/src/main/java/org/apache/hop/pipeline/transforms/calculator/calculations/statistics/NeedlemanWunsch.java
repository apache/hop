...
/**
 * The NeedlemanWunsch distance is a measure of the similarity between two strings. The distance is
 * the number of deletions, insertions, or substitutions required to transform a source string (s)
 * into a target string (t).
 */
public class NeedlemanWunsch implements ICalculation {
  private static final String description =
      BaseMessages.getString(PKG, "CalculatorMetaFunction.CalcFunctions.NeedlemanWunsch");

  @Override
  public String getCode() {
    // Name left unchanged for backward-compatibility
    return "NEEDLEMAN_WUNSH";
  }
  ...
  public CalculationOutput calculate(CalculationInput in) {
    ...
    if (in.dataA != null && in.dataB != null) {
      value =
          (long)
              new com.wcohen.ss.NeedlemanWunsch().score(in.dataA.toString(), in.dataB.toString());
    }
