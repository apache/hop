...
public class YearOfDateISO8601 implements ICalculation {
  ...
  public CalculationOutput calculate(CalculationInput in) throws HopValueException {
    return new CalculationOutput(
        getDefaultResultType(), ValueDataUtil.yearOfDateISO8601(in.metaA, in.dataA));
  }
}
