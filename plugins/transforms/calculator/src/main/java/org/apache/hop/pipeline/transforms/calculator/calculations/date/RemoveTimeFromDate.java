...
public class RemoveTimeFromDate implements ICalculation {
  ...
  public CalculationOutput calculate(CalculationInput in) throws HopValueException {
    return new CalculationOutput(
        ICalculation.getResultType(in.metaA), ValueDataUtil.removeTimeFromDate(in.metaA, in.dataA));
  }
}
