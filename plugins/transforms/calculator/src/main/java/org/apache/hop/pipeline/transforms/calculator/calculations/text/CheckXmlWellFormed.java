...
package org.apache.hop.pipeline.transforms.calculator.calculations.text;
...
public class CheckXmlWellFormed implements ICalculation {
  ...
  public CalculationOutput calculate(CalculationInput in) {
    return new CalculationOutput(
        getDefaultResultType(), ValueDataUtil.isXmlWellFormed(in.metaA, in.dataA));
  }
}
