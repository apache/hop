 ...
 * @since 24-05-2007
 */
public class GetFilesRowsCount extends BaseTransform implements TransformInterface {
  ...
  public GetFilesRowsCount( TransformMeta transformMeta, TransformDataInterface transformDataInterface, int copyNr,
