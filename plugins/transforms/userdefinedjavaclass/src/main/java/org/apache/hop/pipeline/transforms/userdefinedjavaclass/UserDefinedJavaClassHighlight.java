...
class UserDefinedJavaClassHighlight implements LineStyleListener {
  ...
  private static final String[] UDJC_FUNCTIONS = {
    "addResultFile", "addRowListener", "addTransformListener", "checkFeedback", "cleanup", "decrementLinesRead",
    ...
    "getRowFrom", "getRowListeners", "getRuntime", "getServerNr", "getStatus",
    "getStatusDescription", "getTransformDataInterface", "getTransformID", "getTransformListeners", "getTransformMeta",
    "getTransformname", "getPipeline", "getPipelineMeta", "getTypeId", "getUniqueTransformCountAcrossServers",
    "getUniqueTransformNrAcrossServers", "getVariable", "incrementLinesInput", "incrementLinesOutput",
    ...
    "openRemoteInputTransformSocketsOnce", "openRemoteOutputTransformSocketsOnce", "outputIsDone", "processRow",
    ...
    "setOutputDone", "setOutputRowSets", "setTransformListeners", "setVariable", "stopAll", "stopRunning",
    "toString", };
}
