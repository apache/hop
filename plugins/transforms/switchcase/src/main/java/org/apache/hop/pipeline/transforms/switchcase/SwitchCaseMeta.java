...
public class SwitchCaseMeta extends BaseTransformMeta implements ITransformMeta<SwitchCase, SwitchCaseData> {
  ...
  private static IStream newDefaultStream = new Stream( StreamType.TARGET, null, BaseMessages.getString(
    PKG, "SwitchCaseMeta.TargetStream.Default.Description" ), StreamIcon.TARGET, null );
  private static IStream newCaseTargetStream = new Stream( StreamType.TARGET, null, BaseMessages
  ...
  @Override
  public SwitchCase createTransform(TransformMeta transformMeta, SwitchCaseData data, int copyNr, PipelineMeta pipelineMeta, Pipeline pipeline) {
