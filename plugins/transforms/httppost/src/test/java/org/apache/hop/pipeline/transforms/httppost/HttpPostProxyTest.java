...
class HttpPostProxyTest {
  ...
  void proxyCredentialsAnswerTheProxyChallenge() throws Exception {
    ...
    Object[] result = post.callHttpPOST(new Object[0]);
  ...
  private HttpPost transform(String url, Consumer<HttpPostData> configure) {
    ...
    transformMeta.setName("HttpPostProxyTest");
    PipelineMeta pipelineMeta = new PipelineMeta();
    pipelineMeta.setName("HttpPostProxyTest");
