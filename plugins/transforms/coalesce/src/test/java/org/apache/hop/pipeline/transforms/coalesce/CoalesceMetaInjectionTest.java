...
public class CoalesceMetaInjectionTest extends BaseMetadataInjectionTest<CoalesceMeta> {	
	...
	public void test() throws Exception {
	    ...
	    check( "NAME", () -> meta.getCoalesces().get(0).getName() );
	    // check( "TYPE", () -> meta.getCoalesces().get(0).getType() );
	    skipPropertyTest( "TYPE");	    
	    check( "INPUT_FIELDS", () -> meta.getCoalesces().get(0).getInputField(0) );
	    check( "REMOVE_INPUT_FIELDS", () -> meta.getCoalesces().get(0).isRemoveFields() );
	}
}
