...
public class DimensionLookupMetaTest implements IInitializer<ITransformMeta> {
  ...
  public void setUpLoadSave() throws Exception {
    ...
    attrValidatorMap.put(
        "fieldUpdate",
        new FieldUpdateIntArrayLoadSaveValidator(
            new NonZeroIntLoadSaveValidator(DimensionLookupMeta.typeDesc.length), 5));
    attrValidatorMap.put("databaseMeta", new DatabaseMetaLoadSaveValidator());
    attrValidatorMap.put(
        "startDateAlternative",
        new IntLoadSaveValidator(DimensionLookupMeta.getStartDateAlternativeCodes().length));
  ...
  public void testGetFields() throws Exception {
    ...
    doReturn(extraFields)
        .when(meta)
        .getDatabaseTableFields((Database) anyObject(), anyString(), anyString());
  ...
  public void testProvidesModelerMeta() throws Exception {
    ...
    final DimensionLookupMeta dimensionLookupMeta =
        new DimensionLookupMeta() {
          @Override
  ...
  public class FieldUpdateIntArrayLoadSaveValidator extends PrimitiveIntArrayLoadSaveValidator {
    ...
    public FieldUpdateIntArrayLoadSaveValidator(
  ...
  public void testPDI16559() throws Exception {
    ...
    Assert.assertEquals(
        dimensionLookup.getKeyStream().length, dimensionLookup.getKeyLookup().length);
    Assert.assertEquals(
        dimensionLookup.getFieldStream().length, dimensionLookup.getFieldLookup().length);
    Assert.assertEquals(
        dimensionLookup.getFieldUpdate().length, dimensionLookup.getFieldUpdate().length);
  }
}
