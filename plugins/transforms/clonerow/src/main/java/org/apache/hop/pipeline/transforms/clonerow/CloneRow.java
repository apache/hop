 ...
 * @since 27-06-2008
 */
public class CloneRow extends BaseTransform implements TransformInterface {
  ...
  public CloneRow( TransformMeta transformMeta, TransformDataInterface transformDataInterface, int copyNr, PipelineMeta pipelineMeta,
                   Pipeline pipeline ) {
