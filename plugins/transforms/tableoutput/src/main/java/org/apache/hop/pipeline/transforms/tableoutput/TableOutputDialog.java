...
public class TableOutputDialog extends BaseTransformDialog implements ITransformDialog {
  ...
  public String open() {
    ...
    // Connection line
    DatabaseMeta dbm = pipelineMeta.findDatabase(variables.resolve(input.getConnection()));
  ...
  public void setFlags() {
    ...
    DatabaseMeta databaseMeta = pipelineMeta.findDatabase(variables.resolve(wConnection.getText()));
    if (databaseMeta != null) {
  ...
  public void getData() {
    ...
    if (input.getConnection() != null) {
      ...
      input.setDatabaseMeta(pipelineMeta.findDatabase(variables.resolve(input.getConnection())));
    }
  ...
  private void getInfo(TableOutputMeta info) {
    ...
    info.setDatabaseMeta(pipelineMeta.findDatabase(variables.resolve(wConnection.getText())));
