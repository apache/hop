...
public class ExecProcess extends BaseTransform implements TransformInterface {
  ...
  public ExecProcess( TransformMeta transformMeta, TransformDataInterface transformDataInterface, int copyNr, PipelineMeta pipelineMeta,
                      Pipeline pipeline ) {
