...
public class FormulaEditor extends Dialog implements KeyListener {
    ...
    private FormulaValidator evaluator;

    public FormulaEditor(Shell parent, int style, String formula, String[] inputFields ) throws Exception {
        super( parent, style );
        ...
        evaluator = new FormulaValidator( functions, inputFields );
