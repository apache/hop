  ...
  public boolean processRow() throws HopException {
    ...
    if ( Utils.isEmpty( meta.getUrl() ) ) {
      throw new HopTransformException( BaseMessages.getString(
        PKG, "WebServices.ERROR0014.urlNotSpecified", getTransformName() ) );
    }
    ...
    if ( ( vCurrentRow == null && ( nbRowProcess % meta.getCallTransform() != 0 ) )
      || ( vCurrentRow != null && ( ( nbRowProcess > 0 && nbRowProcess % meta.getCallTransform() == 0 ) ) )
      ...
      for ( WebServiceField curField : meta.getFieldsIn() ) {
        ...
        if ( index >= 0 ) {
          ...
          throw new HopException( "Required input field ["
            + curField.getName() + "] couldn't be found in the transform input" );
        }
      }
    }
  ...
  private synchronized void requestSOAP( Object[] rowData, IRowMeta rowMeta ) throws HopException {
    ...
    try {
      ...
      if ( responseCode == HttpStatus.SC_OK ) {
        ...
        throw new HopTransformException( BaseMessages.getString( PKG, "WebServices.ERROR0011.Authentication",
          cachedURLService ) );
      ...
      throw new HopTransformException( BaseMessages.getString( PKG, "WebServices.ERROR0002.InvalidURI",
        cachedURLService ), e );
    } finally {
                ...
                if ( processing ) {
                  ...
                  if ( meta.getFieldsOut().size() == 1 && field != null ) {
                    ...
                    try {
                      ...
                      throw new HopTransformException( "Unable to get value for field ["
                        + field.getName()
