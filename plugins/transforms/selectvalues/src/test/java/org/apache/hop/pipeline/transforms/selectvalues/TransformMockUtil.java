...
public class TransformMockUtil {
  ...
  public static <T extends TransformMetaInterface, V extends BaseTransform> TransformMockHelper<T, TransformDataInterface> getTransformMockHelper( Class<T> meta, String name ) {
    ...
    when( transformMockHelper.logChannelInterfaceFactory.create( ArgumentMatchers.any(), ArgumentMatchers.any( LoggingObjectInterface.class ) ) ).thenReturn( transformMockHelper.logChannelInterface );
    when( transformMockHelper.logChannelInterfaceFactory.create( ArgumentMatchers.any() ) ).thenReturn( transformMockHelper.logChannelInterface );
