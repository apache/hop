...
public class ConcatFields extends BaseTransform<ConcatFieldsMeta, ConcatFieldsData> implements ITransform<ConcatFieldsMeta, ConcatFieldsData> {
  ...
  public synchronized boolean processRow( ) throws HopException {
    ...
    if ( r != null && first ) {
      ...
      meta.getFieldsModifyInput( data.inputRowMetaModified, getTransformName(), null, null, this, metadataProvider );
  ...
  Object[] putRowFastDataDump( Object[] r ) throws HopTransformException {
