...
public class GoogleSheetsPluginOutput
    extends BaseTransform<GoogleSheetsPluginOutputMeta, GoogleSheetsPluginOutputData>
    implements ITransform<GoogleSheetsPluginOutputMeta, GoogleSheetsPluginOutputData> {

  private static Class<?> PKG =
      GoogleSheetsPluginOutput.class; // for i18n purposes, needed by Translator2!!

  public GoogleSheetsPluginOutput(
      TransformMeta transformMeta,
      GoogleSheetsPluginOutputMeta meta,
      GoogleSheetsPluginOutputData data,
      int copyNr,
