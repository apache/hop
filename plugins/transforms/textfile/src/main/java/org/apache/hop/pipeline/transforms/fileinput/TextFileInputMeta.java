...
implements IInputFileMeta {
  ...
  public Object clone() {
    ...
    retval.allocate(nrFiles, nrfilters);
    ...
    for (TextFileInputField field : inputFields) {
      retval.inputFields.add((TextFileInputField) field.clone());
    }
  ...
  public void allocate(int nrfiles, int nrfilters) {
