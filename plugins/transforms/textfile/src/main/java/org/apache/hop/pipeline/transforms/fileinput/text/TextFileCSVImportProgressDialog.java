      ...
      Object[] r =
          TextFileInputUtils.convertLineToRow(
              ...
              FileInputList.createFilePathList(
                  variables,
                  meta.inputFiles.fileName.toArray(new String[0]),
                  meta.inputFiles.fileMask.toArray(new String[0]),
                  meta.inputFiles.excludeFileMask.toArray(new String[0]),
                  meta.inputFiles.fileRequired.toArray(new String[0]),
