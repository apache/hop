...
public class ExcelInputContentParsingTest extends BaseExcelParsingTest {
  ...
  protected void test_PDI_17765_SingleSheet(
    ...
    assertEquals(
        "Wrong last result", lastResult, rows.get(PDI_17765_ROW_LIMIT_SINGLE_SHEET - 1)[0]);
  }
  ...
  public void test_PDI_17765_SingleSheet_NoHeader_StartRow12() throws Exception {
    ...
    test_PDI_17765_SingleSheet(
        PDI_17765_ROW_LIMIT_SINGLE_SHEET, false, 12, firstResult, lastResult);
  }
  ...
  public void test_PDI_17765_MultipleSheets_Header_StartRow0() throws Exception {
    ...
    test_PDI_17765(
        PDI_17765_ROW_LIMIT_MULTIPLE_SHEET,
        true,
    ...
    assertEquals("Wrong first result", firstResult, rows.get(0)[0]);
    assertEquals(
        "Wrong last result", lastResult, rows.get(PDI_17765_ROW_LIMIT_MULTIPLE_SHEET - 1)[0]);
  }
