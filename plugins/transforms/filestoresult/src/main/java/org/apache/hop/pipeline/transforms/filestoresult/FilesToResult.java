 ...
 * @since 26-may-2006
 */
public class FilesToResult extends BaseTransform implements TransformInterface {
  ...
  public FilesToResult( TransformMeta transformMeta, TransformDataInterface transformDataInterface, int copyNr, PipelineMeta pipelineMeta,
                        Pipeline pipeline ) {
