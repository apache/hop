...
public class SplunkInputMeta extends BaseTransformMeta implements ITransformMeta<SplunkInput, SplunkInputData> {
  ...
  @Override public ITransform createTransform( TransformMeta transformMeta, SplunkInputData data, int copyNr, PipelineMeta pipelineMeta, Pipeline pipeline ) {
    return new SplunkInput( transformMeta, this, data, copyNr, pipelineMeta, pipeline );
  }

  @Override public SplunkInputData getTransformData() {
  ...
  @Override public void loadXml( Node stepnode, IHopMetadataProvider provider ) throws HopXmlException {
