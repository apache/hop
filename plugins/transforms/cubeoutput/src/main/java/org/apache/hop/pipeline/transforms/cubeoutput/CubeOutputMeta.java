...
public class CubeOutputMeta extends BaseTransformMeta implements TransformMetaInterface<CubeOutput, CubeOutputData> {
  ...
  public CubeOutput createTransform( TransformMeta transformMeta, CubeOutputData transformDataInterface, int cnr,
