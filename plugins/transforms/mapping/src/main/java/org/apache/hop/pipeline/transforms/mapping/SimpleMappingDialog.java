...
public class SimpleMappingDialog extends BaseTransformDialog implements ITransformDialog {
  ...
  protected Image getImage() {
    return SwtSvgImageUtil
      .getImage( shell.getDisplay(), getClass().getClassLoader(), "MAP.svg", ConstUi.ICON_SIZE, ConstUi.ICON_SIZE );
  }
  ...
  private void selectFilePipeline() {
    ...
    try {
      ...
      new ErrorDialog( shell,
        ...
        BaseMessages.getString( PKG, "SimpleMappingDialog.ErrorLoadingPipeline.DialogMessage" ), ex );
    }
  }

  private void loadPipelineFile( String fname ) throws HopException {
    mappingPipelineMeta = new PipelineMeta( pipelineMeta.environmentSubstitute( fname ), metadataProvider, true, pipelineMeta );
