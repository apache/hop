...
@Transform(
    ...
    image = "redshift.svg",
    name = "i18n::RedshiftBulkLoader.Name",
    description = "i18n::RedshiftBulkLoader.Description",
    categoryDescription = "i18n:org.apache.hop.pipeline.transform:BaseTransform.Category.Bulk",
    documentationUrl = "/pipeline/transforms/redshiftbulkloader.html",
    keywords = "i18n::RedshiftBulkLoader.Keyword",
...
public class RedshiftBulkLoaderMeta
  ...
  protected static final String DEBUG_MODE_VAR = "${REDSHIFT_DEBUG_MODE}";
  ...
  private List<RedshiftLoaderField> redshiftBulkLoaderFields;

  /** Default initializer */
  public RedshiftBulkLoaderMeta() {
    super();
    redshiftBulkLoaderFields = new ArrayList<>();
  }
   ...
   *
   * @return The name of the Redshift stage
   */
  @SuppressWarnings("unused")
  ...
  /**
   * Ignored unless the location_type is internal_stage, sets the name of the Redshift stage
   *
   * @param stageName The name of the Redshift stage
   */
  @SuppressWarnings("unused")
  ...
  /**
   * Ignored if onError is not skip_file or skip_file_percent, the limit at which Redshift should
   * skip loading the file
   *
   * @param errorLimit The limit at which Redshift should skip loading the file. 0 = no limit
   */
  ...
  /**
   * @return Should the files be removed from the Redshift internal storage after they are loaded
   */
  ...
  /**
   * Set if the files should be removed from the Redshift internal storage after they are loaded
   *
   ...
   */
  public List<RedshiftLoaderField> getRedshiftBulkLoaderFields() {
    return redshiftBulkLoaderFields;
  }

  /**
   * CSV: Set the array containing the Stream to Table field mapping
   *
   * @param redshiftBulkLoaderFields The array containing the stream to table field mapping
   */
  @SuppressWarnings("unused")
  public void setRedshiftBulkLoaderFields(
      List<RedshiftLoaderField> redshiftBulkLoaderFields) {
    this.redshiftBulkLoaderFields = redshiftBulkLoaderFields;
  }
  ...
  public void check(
    ...
    if (prev != null && prev.size() > 0) {
      cr =
          new CheckResult(
              ...
              BaseMessages.getString(
                  PKG, "RedshiftBulkLoadMeta.CheckResult.FieldsReceived", "" + prev.size()),
              transformMeta);
      remarks.add(cr);
      ...
      for (RedshiftLoaderField redshiftBulkLoaderField : redshiftBulkLoaderFields) {
        int idx = prev.indexOfValue(redshiftBulkLoaderField.getStreamField());
        if (idx < 0) {
          errorMessage += "\t\t" + redshiftBulkLoaderField.getStreamField() + Const.CR;
          errorFound = true;
        }
      }
      if (errorFound) {
        errorMessage =
            BaseMessages.getString(
                PKG, "RedshiftBulkLoadMeta.CheckResult.FieldsNotFound", errorMessage);
        ...
        cr =
            new CheckResult(
                ICheckResult.TYPE_RESULT_OK,
                BaseMessages.getString(PKG, "RedshiftBulkLoadMeta.CheckResult.AllFieldsFound"),
                transformMeta);
        remarks.add(cr);
      }
    }
    ...
    if (input.length > 0) {
      cr =
          new CheckResult(
              ICheckResult.TYPE_RESULT_OK,
              BaseMessages.getString(PKG, "RedshiftBulkLoadMeta.CheckResult.ExpectedInputOk"),
              transformMeta);
      remarks.add(cr);
    } else {
      cr =
          new CheckResult(
              ...
              BaseMessages.getString(PKG, "RedshiftBulkLoadMeta.CheckResult.ExpectedInputError"),
              transformMeta);
      remarks.add(cr);
    }
    ...
    for (RedshiftLoaderField redshiftBulkLoaderField : redshiftBulkLoaderFields) {
      try {
        redshiftBulkLoaderField.validate();
        cr =
            new CheckResult(
                ICheckResult.TYPE_RESULT_OK,
                BaseMessages.getString(
                    PKG,
                    "RedshiftBulkLoadMeta.CheckResult.MappingValid",
                    redshiftBulkLoaderField.getStreamField()),
                transformMeta);
        remarks.add(cr);
        ...
        cr =
            new CheckResult(
                ...
                BaseMessages.getString(
                    PKG,
                    "RedshiftBulkLoadMeta.CheckResult.MappingNotValid",
                    redshiftBulkLoaderField.getStreamField()),
                transformMeta);
        remarks.add(cr);
      }
  ...
  public ITransformData getTransformData() {
    return new RedshiftBulkLoaderData();
  }

  /**
   * Gets the Redshift stage name based on the configured metadata
   *
   * @param variables The variable space
   * @return The Redshift stage name to use
   */
  ...
  /**
   * Creates the copy statement used to load data into Redshift
   *
   * @param variables The variable space
   * @param filenames A list of filenames to load
   * @return The copy statement to load data into Redshift
  ...
  public SqlStatement getSqlStatements(
    ...
    if (databaseMeta != null) {
      if (prev != null && prev.size() > 0) {
        ...
        retval.setError(
            BaseMessages.getString(PKG, "RedshiftBulkLoaderMeta.GetSQL.NotReceivingAnyFields"));
      }
    } else {
      retval.setError(
          BaseMessages.getString(PKG, "RedshiftBulkLoaderMeta.GetSQL.NoConnectionDefined"));
    }
