...
class UserDefinedJavaClassMetaInjectionTest
  ...
  void test() throws Exception {
    ...
    injector.setProperty(meta, "FIELD_LENGTH", setValue(new ValueMetaInteger("4"), 4L), "4");
    ...
    injector.setProperty(meta, "FIELD_PRECISION", setValue(new ValueMetaInteger("4"), 4L), "4");
