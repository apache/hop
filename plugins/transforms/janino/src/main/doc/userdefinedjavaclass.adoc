...
:language: en_US
:page-alternativeEditUrl: https://github.com/apache/incubator-hop/edit/master/pipeline/transforms/userdefinedjavaclass/src/main/doc/userdefinedjavaclass.adoc
