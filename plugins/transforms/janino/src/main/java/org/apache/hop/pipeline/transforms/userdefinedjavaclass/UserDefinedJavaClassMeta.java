...
@Transform(
        ...
        documentationUrl = "https://hop.apache.org/manual/latest/plugins/transforms/userdefinedjavaclass.html"
)
    ...
    try {
      ...
      for ( int i = 0; i < nrDefinitions; i++ ) {
        ...
        definitions.add( new UserDefinedJavaClassDef(
          UserDefinedJavaClassDef.ClassType.valueOf( XmlHandler.getTagValue( fnode, ElementNames.classType.name() ) ),
