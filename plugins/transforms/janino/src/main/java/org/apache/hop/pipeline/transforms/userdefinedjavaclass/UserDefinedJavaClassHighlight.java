...
class UserDefinedJavaClassHighlight implements LineStyleListener {
  ...
  private static final String[] UDJC_FUNCTIONS = {
    ...
    "getRowFrom", "getRowListeners", "getStatus",
    "getStatusDescription", "getTransformId", "getTransformMeta",
    "getTransformName", "getPipeline", "getPipelineMeta", "getTypeId",
    "getVariable", "incrementLinesInput", "incrementLinesOutput",
    ...
    "isSafeModeEnabled", "isStopped", "logBasic", "logDebug", "logDetailed",
    "logError", "logError", "logMinimal", "logRowlevel", "logSummary", "markStart", "markStop",
    "outputIsDone", "processRow",
    ...
    "setOutputDone", "setOutputRowSets", "setVariable", "stopAll", "stopRunning",
    "toString", "getParent", "getMeta", "getData" };
}
