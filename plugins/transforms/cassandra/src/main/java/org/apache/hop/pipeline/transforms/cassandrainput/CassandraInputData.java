...
/**
 * Data class for the CassandraInput transform. Contains some utility methods for obtaining a connection
 * to cassandra, translating a row from cassandra to Hop and for compressing a query.
 */
