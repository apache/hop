...
public class LdapOutputMeta extends BaseTransformMeta
    ...
    static final String[] derefAliasesTypeDesc = {
        ...
        BaseMessages.getString(
                classFromResourcesPackage, "LdapOutputMeta.derefAliasesType.Searching"),
    ...
    public String getXml() {
        ...
        retval.append("    ")
                .append(
                        XmlHandler.addTagValue(
                                "operationType", getOperationTypeCode(operationType)));
        retval.append("    ")
        ...
        retval.append("    ")
                .append(
                        XmlHandler.addTagValue(
                                "derefAliasesType", getDerefAliasesCode(derefAliasesType)));
        ...
        try {
            ...
            derefAliasesType =
                    getDerefAliasesTypeByCode(
                            Const.NVL(
                                    XmlHandler.getTagValue(transformNode, "derefAliasesType"), ""));
            ...
            throw new HopXmlException(
                    BaseMessages.getString(
                            classFromResourcesPackage, "LdapOutputMeta.UnableToLoadFromXML"),
                    e);
        }
    }
            ...
            cr =
                    new CheckResult(
                            ...
                            BaseMessages.getString(
                                    ...
                                    "LdapOutputMeta.CheckResult.NoInputExpected"),
                            transformMeta);
        } else {
            cr =
                    new CheckResult(
                            ...
                            BaseMessages.getString(
                                    classFromResourcesPackage,
                                    "LdapOutputMeta.CheckResult.NoInput"),
                            transformMeta);
        }
        remarks.add(cr);
        ...
        if (Utils.isEmpty(host)) {
            cr =
                    new CheckResult(
                            ...
                            BaseMessages.getString(
                                    classFromResourcesPackage,
                                    "LdapOutputMeta.CheckResult.HostnameMissing"),
                            transformMeta);
        } else {
            cr =
                    new CheckResult(
                            ...
                            BaseMessages.getString(
                                    classFromResourcesPackage,
                                    "LdapOutputMeta.CheckResult.HostnameOk"),
                            transformMeta);
        }
        remarks.add(cr);
