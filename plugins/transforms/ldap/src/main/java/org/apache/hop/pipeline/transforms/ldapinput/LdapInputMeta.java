...
public class LdapInputMeta extends BaseTransformMeta
    ...
    public String getXml() {
        ...
        retval.append("    ")
                .append(XmlHandler.addTagValue("useauthentication", useAuthentication));
        ...
        for (int i = 0; i < inputFields.length; i++) {
            ...
            retval.append("        ")
                    .append(XmlHandler.addTagValue("name", inputFields[i].getName()));
            retval.append("        ")
            ...
            retval.append("        ")
                    .append(
                            XmlHandler.addTagValue(
                                    "attribute_fetch_as",
                                    inputFields[i].getFetchAttributeAsCode()));
            retval.append("        ")
    ...
    private void readData(Node transformNode) throws HopXmlException {
        try {
            ...
            useAuthentication =
                    "Y"
                            .equalsIgnoreCase(
                                    XmlHandler.getTagValue(transformNode, "useauthentication"));
            includeRowNumber =
                    "Y".equalsIgnoreCase(XmlHandler.getTagValue(transformNode, "rownum"));
            ...
            for (int i = 0; i < nrFields; i++) {
                ...
                inputFields[i].setTrimType(
                        ValueMetaBase.getTrimTypeByCode(
                                XmlHandler.getTagValue(fnode, "trim_type")));
            ...
            dynamicSearch =
                    "Y".equalsIgnoreCase(XmlHandler.getTagValue(transformNode, "dynamicsearch"));
            dynamicSeachFieldName = XmlHandler.getTagValue(transformNode, "dynamicseachfieldname");
            dynamicFilter =
                    "Y".equalsIgnoreCase(XmlHandler.getTagValue(transformNode, "dynamicfilter"));
            dynamicFilterFieldName =
                    XmlHandler.getTagValue(transformNode, "dynamicfilterfieldname");
            searchScope =
            ...
            trustAllCertificates =
                    "Y"
                            .equalsIgnoreCase(
                                    XmlHandler.getTagValue(transformNode, "trustAllCertificates"));
            useCertificate =
            ...
            cr =
                    new CheckResult(
                            ...
                            BaseMessages.getString(
                                    PKG, "LdapInputMeta.CheckResult.NoInputExpected"),
                            transformMeta);
        } else {
            cr =
                    new CheckResult(
        ...
        if (Utils.isEmpty(Host)) {
            cr =
                    new CheckResult(
                            TYPE_RESULT_ERROR,
                            BaseMessages.getString(
                                    PKG, "LdapInputMeta.CheckResult.HostnameMissing"),
                            transformMeta);
        } else {
            cr =
                    new CheckResult(
            ...
            if (Utils.isEmpty(dynamicSeachFieldName)) {
                cr =
                        new CheckResult(
                                ...
                                BaseMessages.getString(
                                        PKG,
                                        "LdapInputMeta.CheckResult.DynamicSearchBaseFieldNameMissing"),
                                transformMeta);
            } else {
                cr =
                        new CheckResult(
                                ...
                                BaseMessages.getString(
                                        PKG,
                                        "LdapInputMeta.CheckResult.DynamicSearchBaseFieldNameOk"),
                                transformMeta);
            }
            remarks.add(cr);
        } else {
            ...
            if (Utils.isEmpty(searchBase)) {
                cr =
                        new CheckResult(
                                TYPE_RESULT_WARNING,
                                BaseMessages.getString(
                                        PKG, "LdapInputMeta.CheckResult.SearchBaseMissing"),
                                transformMeta);
            } else {
                cr =
                        new CheckResult(
                                TYPE_RESULT_OK,
                                BaseMessages.getString(
                                        PKG, "LdapInputMeta.CheckResult.SearchBaseOk"),
                                transformMeta);
            }
            remarks.add(cr);
        }
            ...
            if (Utils.isEmpty(dynamicFilterFieldName)) {
                cr =
                        new CheckResult(
                                ...
                                BaseMessages.getString(
                                        PKG,
                                        "LdapInputMeta.CheckResult.DynamicFilterFieldNameMissing"),
                                transformMeta);
            } else {
                cr =
                        new CheckResult(
                                TYPE_RESULT_OK,
                                BaseMessages.getString(
                                        PKG, "LdapInputMeta.CheckResult.DynamicFilterFieldNameOk"),
                                transformMeta);
            }
            remarks.add(cr);
        } else {
            ...
            if (Utils.isEmpty(filterString)) {
                cr =
                        new CheckResult(
                                TYPE_RESULT_WARNING,
                                BaseMessages.getString(
                                        PKG, "LdapInputMeta.CheckResult.FilterStringMissing"),
                                transformMeta);
            } else {
                cr =
                        new CheckResult(
                                TYPE_RESULT_OK,
                                BaseMessages.getString(
                                        PKG, "LdapInputMeta.CheckResult.FilterStringOk"),
                                transformMeta);
            }
            remarks.add(cr);
        }
