...
import org.apache.hop.core.annotations.RepositoryPlugin;
...
public class RepositoryPluginType extends BasePluginType implements PluginTypeInterface {
  ...
  protected String getXmlPluginFile() {
    return Const.XML_FILE_HOP_REPOSITORIES;
  }
        ...
        for ( FileObject file : pluginXmlFiles ) {
          ...
          try {
            ...
            registerPluginFromXmlResource(
              pluginNode, HopVFS.getFilename( file.getParent() ), this.getClass(), false, file
                .getParent().getURL() );
          } catch ( Exception e ) {
