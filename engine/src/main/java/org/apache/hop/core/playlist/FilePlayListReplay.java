...
public class FilePlayListReplay implements FilePlayList {
  ...
  private void initializeCurrentIfNeeded( FileObject file, String filePart ) throws HopException {
    if ( !( file.equals( getCurrentProcessingFile() ) && filePart.equals( getCurrentProcessingFilePart() ) ) ) {
      initializeCurrent( file, filePart );
    }
  }

  private void initializeCurrent( FileObject file, String filePart ) throws HopException {
    try {
      FileObject lineFile =
