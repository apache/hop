...
public class GetTransStatusServlet extends BaseHttpServlet implements HopServerPluginInterface {
  ...
  public void doGet( HttpServletRequest request, HttpServletResponse response ) throws ServletException,
    ...
    if ( trans != null ) {
      if ( useXML ) {
        ...
        out.println( "<HEAD>" );
        out.println( "<TITLE>"
          + BaseMessages.getString( PKG, "TransStatusServlet.HopTransStatus" ) + "</TITLE>" );
  ...
  private String getLogText( Trans trans, int startLineNr, int lastLineNr ) throws HopException {
    try {
