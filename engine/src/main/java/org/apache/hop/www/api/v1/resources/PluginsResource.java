...
/** Exposes the plugin registry. */
@Path("/plugins")
public class PluginsResource extends BaseApiResource {
   ...
   *
   * @param typeClassName the class name of the plugin type
  ...
  public Response listPlugins(@PathParam("typeClassName") String typeClassName)
      throws HopException, ClassNotFoundException {
    PluginRegistry registry = PluginRegistry.getInstance();
    ...
    registry.getPluginTypes().forEach(c -> typeClassesSet.add(c.getName()));
