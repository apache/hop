...
public class SlaveServerWorkflowStatus {
  ...
  public SlaveServerWorkflowStatus() {
  }
   ...
   */
  public SlaveServerWorkflowStatus( String pipelineName, String id, String statusDescription ) {
    this();
