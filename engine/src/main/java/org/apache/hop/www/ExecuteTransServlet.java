...
public class ExecuteTransServlet extends BaseHttpServlet implements HopServerPluginInterface {
 ...
 <div id="mindtouch">
  ...
  <webresult>
    ...
    &#x3a;&#x2f;home&#x2f;admin&#xd;&#xa;&#xd;&#xa; at
    org.apache.hop.www.ExecuteTransServlet.loadTransformation&#x28;ExecuteTransServlet.java&#x3a;214&#x29;&#xd;&#xa;
    at org.apache.hop.www.ExecuteTransServlet.doGet&#x28;ExecuteTransServlet.java&#x3a;104&#x29;&#xd;&#xa;
  ...
  */
  public void doGet( HttpServletRequest request, HttpServletResponse response ) throws ServletException,
    ...
    try {
      ...
      try {
        ...
        String logging = HopLogStore.getAppender().getBuffer( trans.getLogChannelId(), false ).toString();
        throw new HopException( "Error executing transformation: " + logging, executionException );
      }
    } catch ( Exception ex ) {
  ...
  private TransMeta loadTransformation( Repository repository, String trans ) throws HopException {
    ...
    if ( repository == null ) {
      ...
      if ( transformationID == null ) {
        throw new HopException( "Unable to find transformation '" + name + "' in directory :" + directory );
      }
