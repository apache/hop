 ...
 * <p>
 * The problem is: during Workbook writing to stream, Apache POI closes output stream itself. After that, ExcelWrite
 * closes this stream also because it was open in the ExcelWriter. But Java 8 contains bug
