...
package org.apache.hop.datafactory;
...
public interface DynamicDatasource {
  ...
  /**
   * Return the name of the Hop transformation template that holds the uninitialized input step. The template should
  ...
  /**
   * The name of the step that represents the datasource, as it appears in the Hop transformation template.
   *
