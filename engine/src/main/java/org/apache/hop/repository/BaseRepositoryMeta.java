...
public class BaseRepositoryMeta {
   ...
   * the org.apache.hop.ui tree and has a class name that is the name of the job entry with 'Dialog' added to the end.
   *
   * e.g. if the repository meta class is org.apache.hop.repository.kdr.HopDatabaseRepositoryMeta the dialog would be
   * org.apache.hop.ui.repository.kdr.HopDatabaseRepositoryDialog
   *
   ...
   * the org.apache.hop.ui tree and has a class name that is the name of the job entry with 'Dialog' added to the end.
   *
   * e.g. if the repository meta class is org.apache.hop.pur.PurRepositoryMeta the dialog would be
   * org.apache.hop.ui.repository.pur.PurRepositoryRevisionBrowserDialog
   *
   * If the dialog class does not match this pattern, the RepositoryMeta class should override this method and return
   * the appropriate class name
   *
   ...
   * (non-Javadoc)
   *
   * @see org.apache.hop.repository.RepositoryMeta#loadXML(org.w3c.dom.Node, java.util.List)
   */
  public void loadXML( Node repnode, List<DatabaseMeta> databases ) throws HopException {
    try {
      ...
      throw new HopException( "Unable to load repository meta object", e );
    }
  }
   ...
   * (non-Javadoc)
   *
   * @see org.apache.hop.repository.RepositoryMeta#getXML()
   */
   ...
   * (non-Javadoc)
   *
   * @see org.apache.hop.repository.RepositoryMeta#getId()
   */
  public String getId() {
    return id;
  }
   ...
   * (non-Javadoc)
   *
   * @see org.apache.hop.repository.RepositoryMeta#setId(java.lang.String)
   */
   ...
   * (non-Javadoc)
   *
   * @see org.apache.hop.repository.RepositoryMeta#getName()
   */
   ...
   * (non-Javadoc)
   *
   * @see org.apache.hop.repository.RepositoryMeta#setName(java.lang.String)
   */
   ...
   * (non-Javadoc)
   *
   * @see org.apache.hop.repository.RepositoryMeta#getDescription()
   */
   ...
   * (non-Javadoc)
   *
   * @see org.apache.hop.repository.RepositoryMeta#setDescription(java.lang.String)
   */
   ...
   * (non-Javadoc)
   *
   * @see org.apache.hop.repository.RepositoryMeta#isDefault()
   */
   ...
   * (non-Javadoc)
   *
   * @see org.apache.hop.repository.RepositoryMeta#setDefault(java.lang.Boolean)
   */
