...
public abstract class HopDatabaseRepositoryBase extends AbstractRepository {
  ...
  /** The maximum length of a text field in a Hop repository : 2.000.000 is enough for everyone ;-) */
  ...
  protected HopDatabaseRepositoryMeta repositoryMeta;
  ...
  protected HopDatabaseRepositoryCreationHelper creationHelper;

  public HopDatabaseRepositoryBase() {
  }

  public HopDatabaseRepositoryMeta getRepositoryMeta() {
    return repositoryMeta;
  }

  public void setRepositoryMeta( HopDatabaseRepositoryMeta repositoryMeta ) {
