...
package org.apache.hop.repository.kdr.delegates.metastore;
...
public class HopDatabaseRepositoryMetaStore extends MemoryMetaStore implements IMetaStore {

  protected HopDatabaseRepository repository;
  private HopDatabaseRepositoryMetaStoreDelegate delegate;

  public HopDatabaseRepositoryMetaStore( HopDatabaseRepository repository ) {
  ...
  public List<String> getNamespaces() throws MetaStoreException {
    ...
    try {
      ...
      for ( RowMetaAndData namespaceRow : namespaceRows ) {
        String namespace = namespaceRow.getString( HopDatabaseRepository.FIELD_NAMESPACE_NAME, null );
  ...
  public void deleteElementType( String namespace, IMetaStoreElementType elementType ) throws MetaStoreException,
    ...
    try {
      ...
      if ( !elementTypeRows.isEmpty() ) {
        ...
        for ( RowMetaAndData elementTypeRow : elementTypeRows ) {
          Long elementTypeId =
            elementTypeRow.getInteger( HopDatabaseRepository.FIELD_ELEMENT_TYPE_ID_ELEMENT_TYPE );
