...
import org.apache.hop.repository.RepositoryExporter;
import org.apache.hop.repository.RepositoryImporter;
...
import org.apache.hop.repository.kdr.delegates.HopDatabaseRepositoryClusterSchemaDelegate;
import org.apache.hop.repository.kdr.delegates.HopDatabaseRepositoryConditionDelegate;
...
import org.apache.hop.repository.kdr.delegates.HopDatabaseRepositoryDirectoryDelegate;
import org.apache.hop.repository.kdr.delegates.HopDatabaseRepositoryJobDelegate;
import org.apache.hop.repository.kdr.delegates.HopDatabaseRepositoryJobEntryDelegate;
import org.apache.hop.repository.kdr.delegates.HopDatabaseRepositoryMetaStoreDelegate;
import org.apache.hop.repository.kdr.delegates.HopDatabaseRepositoryNotePadDelegate;
import org.apache.hop.repository.kdr.delegates.HopDatabaseRepositoryPartitionSchemaDelegate;
import org.apache.hop.repository.kdr.delegates.HopDatabaseRepositorySlaveServerDelegate;
import org.apache.hop.repository.kdr.delegates.HopDatabaseRepositoryStepDelegate;
...
import org.apache.hop.repository.kdr.delegates.HopDatabaseRepositoryValueDelegate;
...
/**
 *
 * This class handles interactions with a Hop repository.
 *
 * @author Matt Created on 31-mrt-2004
 *
 */
public class HopDatabaseRepository extends HopDatabaseRepositoryBase {
  // private static Class<?> PKG = Repository.class; // for i18n purposes, needed by Translator2!!

  public HopDatabaseRepositoryTransDelegate transDelegate;
  public HopDatabaseRepositoryJobDelegate jobDelegate;
  public HopDatabaseRepositoryDatabaseDelegate databaseDelegate;
  public HopDatabaseRepositorySlaveServerDelegate slaveServerDelegate;
  public HopDatabaseRepositoryClusterSchemaDelegate clusterSchemaDelegate;
  public HopDatabaseRepositoryPartitionSchemaDelegate partitionSchemaDelegate;
  public HopDatabaseRepositoryDirectoryDelegate directoryDelegate;
  public HopDatabaseRepositoryConnectionDelegate connectionDelegate;
  public HopDatabaseRepositoryUserDelegate userDelegate;
  public HopDatabaseRepositoryConditionDelegate conditionDelegate;
  public HopDatabaseRepositoryValueDelegate valueDelegate;
  public HopDatabaseRepositoryNotePadDelegate notePadDelegate;
  public HopDatabaseRepositoryStepDelegate stepDelegate;
  public HopDatabaseRepositoryJobEntryDelegate jobEntryDelegate;
  public HopDatabaseRepositoryMetaStoreDelegate metaStoreDelegate;

  private HopDatabaseRepositorySecurityProvider securityProvider;
  ...
  public HopDatabaseRepositoryMetaStore metaStore;

  public HopDatabaseRepository() {
    super();
    metaStore = null;
  }
  ...
  public void init( RepositoryMeta repositoryMeta ) {
    this.repositoryMeta = (HopDatabaseRepositoryMeta) repositoryMeta;
  ...
  private void init() {
    ...
    //
    this.transDelegate = new HopDatabaseRepositoryTransDelegate( this );
    this.jobDelegate = new HopDatabaseRepositoryJobDelegate( this );
    this.databaseDelegate = new HopDatabaseRepositoryDatabaseDelegate( this );
    this.slaveServerDelegate = new HopDatabaseRepositorySlaveServerDelegate( this );
    this.clusterSchemaDelegate = new HopDatabaseRepositoryClusterSchemaDelegate( this );
    this.partitionSchemaDelegate = new HopDatabaseRepositoryPartitionSchemaDelegate( this );
    this.directoryDelegate = new HopDatabaseRepositoryDirectoryDelegate( this );
    this.connectionDelegate =
      new HopDatabaseRepositoryConnectionDelegate( this, repositoryMeta.getConnection() );
    this.userDelegate = new HopDatabaseRepositoryUserDelegate( this );
    this.conditionDelegate = new HopDatabaseRepositoryConditionDelegate( this );
    this.valueDelegate = new HopDatabaseRepositoryValueDelegate( this );
    this.notePadDelegate = new HopDatabaseRepositoryNotePadDelegate( this );
    this.stepDelegate = new HopDatabaseRepositoryStepDelegate( this );
    this.jobEntryDelegate = new HopDatabaseRepositoryJobEntryDelegate( this );
    this.metaStoreDelegate = new HopDatabaseRepositoryMetaStoreDelegate( this );
    this.creationHelper = new HopDatabaseRepositoryCreationHelper( this );
  }
  ...
  public RepositoryMeta createRepositoryMeta() {
    return new HopDatabaseRepositoryMeta();
  }
   ...
   *           in case there is a general unexpected error or if we're already connected
   */
  public void connect( String username, String password, boolean upgrade ) throws HopException {
    // first disconnect if already connected
    connectionDelegate.connect( upgrade, upgrade );
    try {
      IUser userinfo = userDelegate.loadUserInfo( new UserInfo(), username, password );
      securityProvider = new HopDatabaseRepositorySecurityProvider( this, repositoryMeta, userinfo );
      ...
      //
      metaStore = new HopDatabaseRepositoryMetaStore( this );
  ...
  @Override public void create() {
    if ( repositoryMeta.getConnection() != null ) {
      ...
      try {
        ...
        try {
          String userTableName = getDatabaseMeta().quoteField( HopDatabaseRepository.TABLE_R_USER );
  ...
  void reconnectAsAdminForUpgrade() {
    try {
      ...
      log.logError( BaseMessages.getString( HopDatabaseRepository.class,
          "HopDatabaseRepository.ERROR_CONNECT_TO_REPOSITORY" ), e );
    }
  }
  ...
  public synchronized void commit() throws HopException {
  ...
  public TransMeta loadTransformation( String transname, RepositoryDirectoryInterface repdir,
    ProgressMonitorListener monitor, boolean setInternalVariables, String versionName ) throws HopException {
    try {
      ...
      ExtensionPointHandler.callExtensionPoint( log, HopExtensionPoint.TransformationMetaLoaded.id, transMeta );
      return transMeta;
    } finally {
      connectionDelegate.closeReadTransaction();
    }
  ...
  public synchronized ObjectId renameTransformation( ObjectId id_transformation, String versionComment,
      RepositoryDirectoryInterface newDir, String newName ) throws HopException {
  ...
  public JobMeta loadJob( String jobname, RepositoryDirectoryInterface repdir, ProgressMonitorListener monitor,
    String versionName ) throws HopException {
    try {
      ...
      ExtensionPointHandler.callExtensionPoint( log, HopExtensionPoint.JobMetaLoaded.id, jobMeta );
      return jobMeta;
    } finally {
      connectionDelegate.closeReadTransaction();
    }
  ...
  public boolean exists( String name, RepositoryDirectoryInterface repositoryDirectory,
    ...
    try {
      switch ( objectType ) {
        ...
        default:
          throw new HopException( "We can't verify the existance of repository element type ["
            + objectType + "]" );
      }
    } finally {
      connectionDelegate.closeReadTransaction();
  ...
  public void save( RepositoryElementInterface repositoryElement, String versionComment ) throws HopException {
  ...
  public void save( RepositoryElementInterface repositoryElement, String versionComment,
    ProgressMonitorListener monitor, ObjectId parentId, boolean used, boolean overwrite ) throws HopException {
    ...
    try {
      ...
      switch ( repositoryElement.getRepositoryElementType() ) {
        ...
        case PARTITION_SCHEMA:
          ...
          break;
        default:
          throw new HopException( "We can't save the element with type ["
   ...
   */
  public DatabaseMeta loadDatabaseMeta( ObjectId id_database, String versionName ) throws HopException {
  ...
  public SlaveServer loadSlaveServer( ObjectId id_slave_server, String versionName ) throws HopException {
    return slaveServerDelegate.loadSlaveServer( id_slave_server );
  }

  // PartitionSchema

  public PartitionSchema loadPartitionSchema( ObjectId id_partition_schema, String versionName ) throws HopException {
  ...
  public synchronized ObjectId getRootDirectoryID() throws HopException {
    RowMetaAndData result =
      connectionDelegate.getOneRow( "SELECT "
        ...
        + quote( HopDatabaseRepository.FIELD_DIRECTORY_ID_DIRECTORY_PARENT ) + " = 0" );
  ...
  public synchronized ObjectId insertLogEntry( String description ) throws HopException {
    ObjectId id = connectionDelegate.getNextLogID();

    RowMetaAndData table = new RowMetaAndData();
    table.addValue( new ValueMetaInteger(
      HopDatabaseRepository.FIELD_REPOSITORY_LOG_ID_REPOSITORY_LOG ), id );
    table.addValue( new ValueMetaString(
      HopDatabaseRepository.FIELD_REPOSITORY_LOG_REP_VERSION ), getVersion() );
    table.addValue( new ValueMetaDate(
      HopDatabaseRepository.FIELD_REPOSITORY_LOG_LOG_DATE ), new Date() );
    table.addValue(
      new ValueMetaString( HopDatabaseRepository.FIELD_REPOSITORY_LOG_LOG_USER ),
      getUserInfo() != null ? getUserInfo().getLogin() : "admin" );
    table.addValue(
      new ValueMetaString(
        HopDatabaseRepository.FIELD_REPOSITORY_LOG_OPERATION_DESC ),
      description );

    connectionDelegate.insertTableRow( HopDatabaseRepository.TABLE_R_REPOSITORY_LOG, table );

    return id;
  }

  public synchronized void insertTransNote( ObjectId id_transformation, ObjectId id_note ) throws HopException {
    RowMetaAndData table = new RowMetaAndData();

    table.addValue(
      new ValueMetaInteger(
        HopDatabaseRepository.FIELD_TRANS_NOTE_ID_TRANSFORMATION ),
      id_transformation );
    table.addValue( new ValueMetaInteger(
      HopDatabaseRepository.FIELD_TRANS_NOTE_ID_NOTE ), id_note );

    connectionDelegate.insertTableRow( HopDatabaseRepository.TABLE_R_TRANS_NOTE, table );
  }

  public synchronized void insertJobNote( ObjectId id_job, ObjectId id_note ) throws HopException {
    RowMetaAndData table = new RowMetaAndData();

    table.addValue(
      new ValueMetaInteger( HopDatabaseRepository.FIELD_JOB_NOTE_ID_JOB ), id_job );
    table.addValue( new ValueMetaInteger(
      HopDatabaseRepository.FIELD_JOB_NOTE_ID_NOTE ), id_note );

    connectionDelegate.insertTableRow( HopDatabaseRepository.TABLE_R_JOB_NOTE, table );
  }

  public synchronized void insertStepDatabase( ObjectId id_transformation, ObjectId id_step, ObjectId id_database ) throws HopException {
    ...
    if ( check.getInteger( 0 ) == null ) {
      ...
      table.addValue(
        new ValueMetaInteger(
          HopDatabaseRepository.FIELD_STEP_DATABASE_ID_TRANSFORMATION ),
        id_transformation );
      table.addValue( new ValueMetaInteger(
        HopDatabaseRepository.FIELD_STEP_DATABASE_ID_STEP ), id_step );
      table
        .addValue(
          new ValueMetaInteger(
            HopDatabaseRepository.FIELD_STEP_DATABASE_ID_DATABASE ),
          id_database );

      connectionDelegate.insertTableRow( HopDatabaseRepository.TABLE_R_STEP_DATABASE, table );
    }
  }

  public synchronized void insertJobEntryDatabase( ObjectId id_job, ObjectId id_jobentry, ObjectId id_database ) throws HopException {
    // First check if the relationship is already there.
    // There is no need to store it twice!
    ...
    if ( check.getInteger( 0 ) == null ) {
      ...
      table.addValue( new ValueMetaInteger(
        HopDatabaseRepository.FIELD_JOBENTRY_DATABASE_ID_JOB ), id_job );
      table.addValue(
        new ValueMetaInteger(
          HopDatabaseRepository.FIELD_JOBENTRY_DATABASE_ID_JOBENTRY ),
        id_jobentry );
      table.addValue(
        new ValueMetaInteger(
          HopDatabaseRepository.FIELD_JOBENTRY_DATABASE_ID_DATABASE ),
        id_database );

      connectionDelegate.insertTableRow( HopDatabaseRepository.TABLE_R_JOBENTRY_DATABASE, table );
    }
  }

  public synchronized ObjectId insertTransformationPartitionSchema( ObjectId id_transformation,
    ObjectId id_partition_schema ) throws HopException {
    ObjectId id = connectionDelegate.getNextTransformationPartitionSchemaID();

    RowMetaAndData table = new RowMetaAndData();

    table.addValue( new ValueMetaInteger(
      HopDatabaseRepository.FIELD_TRANS_PARTITION_SCHEMA_ID_TRANS_PARTITION_SCHEMA ), id );
    table.addValue(
      new ValueMetaInteger(
        HopDatabaseRepository.FIELD_TRANS_PARTITION_SCHEMA_ID_TRANSFORMATION ), id_transformation );
    table.addValue(
      new ValueMetaInteger(
        HopDatabaseRepository.FIELD_TRANS_PARTITION_SCHEMA_ID_PARTITION_SCHEMA ), id_partition_schema );

    connectionDelegate.insertTableRow( HopDatabaseRepository.TABLE_R_TRANS_PARTITION_SCHEMA, table );

    return id;
  }

  public synchronized ObjectId insertClusterSlave( ClusterSchema clusterSchema, SlaveServer slaveServer ) throws HopException {
    ObjectId id = connectionDelegate.getNextClusterSlaveID();

    RowMetaAndData table = new RowMetaAndData();

    table.addValue( new ValueMetaInteger(
      HopDatabaseRepository.FIELD_CLUSTER_SLAVE_ID_CLUSTER_SLAVE ), id );
    table.addValue( new ValueMetaInteger(
      HopDatabaseRepository.FIELD_CLUSTER_SLAVE_ID_CLUSTER ), clusterSchema
      .getObjectId() );
    table.addValue( new ValueMetaInteger(
      HopDatabaseRepository.FIELD_CLUSTER_SLAVE_ID_SLAVE ), slaveServer
      .getObjectId() );

    connectionDelegate.insertTableRow( HopDatabaseRepository.TABLE_R_CLUSTER_SLAVE, table );

    return id;
  }

  public synchronized ObjectId insertTransformationCluster( ObjectId id_transformation, ObjectId id_cluster ) throws HopException {
    ObjectId id = connectionDelegate.getNextTransformationClusterID();

    RowMetaAndData table = new RowMetaAndData();

    table.addValue( new ValueMetaInteger(
      HopDatabaseRepository.FIELD_TRANS_CLUSTER_ID_TRANS_CLUSTER ), id );
    table.addValue(
      new ValueMetaInteger(
        HopDatabaseRepository.FIELD_TRANS_CLUSTER_ID_TRANSFORMATION ),
      id_transformation );
    table.addValue( new ValueMetaInteger(
      HopDatabaseRepository.FIELD_TRANS_CLUSTER_ID_CLUSTER ), id_cluster );

    connectionDelegate.insertTableRow( HopDatabaseRepository.TABLE_R_TRANS_CLUSTER, table );

    return id;
  }

  public synchronized ObjectId insertTransformationSlave( ObjectId id_transformation, ObjectId id_slave ) throws HopException {
    ObjectId id = connectionDelegate.getNextTransformationSlaveID();

    RowMetaAndData table = new RowMetaAndData();

    table.addValue( new ValueMetaInteger(
      HopDatabaseRepository.FIELD_TRANS_SLAVE_ID_TRANS_SLAVE ), id );
    table.addValue(
      new ValueMetaInteger(
        HopDatabaseRepository.FIELD_TRANS_SLAVE_ID_TRANSFORMATION ),
      id_transformation );
    table.addValue( new ValueMetaInteger(
      HopDatabaseRepository.FIELD_TRANS_SLAVE_ID_SLAVE ), id_slave );

    connectionDelegate.insertTableRow( HopDatabaseRepository.TABLE_R_TRANS_SLAVE, table );

    return id;
  }

  public synchronized void insertTransStepCondition( ObjectId id_transformation, ObjectId id_step,
    ObjectId id_condition ) throws HopException {
    String tablename = HopDatabaseRepository.TABLE_R_TRANS_STEP_CONDITION;
    RowMetaAndData table = new RowMetaAndData();
    table
      .addValue(
        new ValueMetaInteger(
          HopDatabaseRepository.FIELD_TRANS_STEP_CONDITION_ID_TRANSFORMATION ), id_transformation );
    table.addValue( new ValueMetaInteger(
      HopDatabaseRepository.FIELD_TRANS_STEP_CONDITION_ID_STEP ), id_step );
    table.addValue(
      new ValueMetaInteger(
  ...
  public synchronized String[] getTransformationNames( ObjectId id_directory, boolean includeDeleted ) throws HopException {
    return connectionDelegate.getStrings( "SELECT "
      + quote( HopDatabaseRepository.FIELD_TRANSFORMATION_NAME ) + " FROM "
      + quoteTable( HopDatabaseRepository.TABLE_R_TRANSFORMATION ) + " WHERE "
      + quote( HopDatabaseRepository.FIELD_TRANSFORMATION_ID_DIRECTORY ) + " = ? ORDER BY "
      + quote( HopDatabaseRepository.FIELD_TRANSFORMATION_NAME ), id_directory );
  }
  ...
  public List<RepositoryElementMetaInterface> getJobObjects( ObjectId id_directory, boolean includeDeleted ) throws HopException {
    return getRepositoryObjects(
      quoteTable( HopDatabaseRepository.TABLE_R_JOB ), RepositoryObjectType.JOB, id_directory );
  }
  ...
  public List<RepositoryElementMetaInterface> getTransformationObjects( ObjectId id_directory,
    ...
    List<RepositoryElementMetaInterface> objects =
      getRepositoryObjects(
        quoteTable( HopDatabaseRepository.TABLE_R_TRANSFORMATION ), RepositoryObjectType.TRANSFORMATION,
        id_directory );
  ...
  private synchronized List<RepositoryElementMetaInterface> getRepositoryObjects( String tableName,
    RepositoryObjectType objectType, ObjectId id_directory ) throws HopException {
    return connectionDelegate.getRepositoryObjects( tableName, objectType, id_directory );
  }

  public synchronized String[] getJobNames( ObjectId id_directory, boolean includeDeleted ) throws HopException {
    return connectionDelegate.getStrings( "SELECT "
      + quote( HopDatabaseRepository.FIELD_JOB_NAME ) + " FROM "
      + quoteTable( HopDatabaseRepository.TABLE_R_JOB ) + " WHERE "
      + quote( HopDatabaseRepository.FIELD_JOB_ID_DIRECTORY ) + " = ? ORDER BY "
      + quote( HopDatabaseRepository.FIELD_JOB_NAME ), id_directory );
  }

  public synchronized String[] getDirectoryNames( ObjectId id_directory ) throws HopException {
    return connectionDelegate.getStrings( "SELECT "
      + quote( HopDatabaseRepository.FIELD_DIRECTORY_DIRECTORY_NAME ) + " FROM "
      + quoteTable( HopDatabaseRepository.TABLE_R_DIRECTORY ) + " WHERE "
  ...
  public synchronized String[] getJobNames() throws HopException {
    return connectionDelegate.getStrings( "SELECT "
      + quote( HopDatabaseRepository.FIELD_JOB_NAME ) + " FROM "
      + quoteTable( HopDatabaseRepository.TABLE_R_JOB ) + " ORDER BY "
      + quote( HopDatabaseRepository.FIELD_JOB_NAME ) );
  }

  public ObjectId[] getSubConditionIDs( ObjectId id_condition ) throws HopException {
    return connectionDelegate.getIDs( "SELECT "
      + quote( HopDatabaseRepository.FIELD_CONDITION_ID_CONDITION ) + " FROM "
      + quoteTable( HopDatabaseRepository.TABLE_R_CONDITION ) + " WHERE "
      + quote( HopDatabaseRepository.FIELD_CONDITION_ID_CONDITION_PARENT ) + " = ? ORDER BY "
      + quote( HopDatabaseRepository.FIELD_CONDITION_ID_CONDITION ), id_condition );
  }

  public ObjectId[] getTransNoteIDs( ObjectId id_transformation ) throws HopException {
    return connectionDelegate.getIDs( "SELECT "
      + quote( HopDatabaseRepository.FIELD_TRANS_NOTE_ID_NOTE ) + " FROM "
      + quoteTable( HopDatabaseRepository.TABLE_R_TRANS_NOTE ) + " WHERE "
      + quote( HopDatabaseRepository.FIELD_TRANS_NOTE_ID_TRANSFORMATION ) + " = ?", id_transformation );
  }

  public ObjectId[] getTransformationConditionIDs( ObjectId id_transformation ) throws HopException {
    return connectionDelegate.getIDs(
      "SELECT "
        + quote( HopDatabaseRepository.FIELD_TRANS_STEP_CONDITION_ID_CONDITION ) + " FROM "
        + quoteTable( HopDatabaseRepository.TABLE_R_TRANS_STEP_CONDITION ) + " WHERE "
        + quote( HopDatabaseRepository.FIELD_TRANS_STEP_CONDITION_ID_TRANSFORMATION ) + " = ? ",
      id_transformation );
  }

  public ObjectId[] getTransformationDatabaseIDs( ObjectId id_transformation ) throws HopException {
    return connectionDelegate.getIDs( "SELECT "
      + quote( HopDatabaseRepository.FIELD_STEP_DATABASE_ID_DATABASE ) + " FROM "
      + quoteTable( HopDatabaseRepository.TABLE_R_STEP_DATABASE ) + " WHERE "
      + quote( HopDatabaseRepository.FIELD_STEP_DATABASE_ID_TRANSFORMATION ) + " = ?", id_transformation );
  }

  public ObjectId[] getJobNoteIDs( ObjectId id_job ) throws HopException {
    return connectionDelegate.getIDs( "SELECT "
      + quote( HopDatabaseRepository.FIELD_JOB_NOTE_ID_NOTE ) + " FROM "
      + quoteTable( HopDatabaseRepository.TABLE_R_JOB_NOTE ) + " WHERE "
      + quote( HopDatabaseRepository.FIELD_JOB_NOTE_ID_JOB ) + " = ?", id_job );
  }

  public ObjectId[] getDatabaseIDs( boolean includeDeleted ) throws HopException {
    return connectionDelegate.getIDs( "SELECT "
      + quote( HopDatabaseRepository.FIELD_DATABASE_ID_DATABASE ) + " FROM "
      + quoteTable( HopDatabaseRepository.TABLE_R_DATABASE ) + " ORDER BY "
      + quote( HopDatabaseRepository.FIELD_DATABASE_ID_DATABASE ) );
  }

  public ObjectId[] getDatabaseAttributeIDs( ObjectId id_database ) throws HopException {
    return connectionDelegate.getIDs( "SELECT "
      + quote( HopDatabaseRepository.FIELD_DATABASE_ATTRIBUTE_ID_DATABASE_ATTRIBUTE ) + " FROM "
  ...
  public ObjectId[] getPartitionSchemaIDs( boolean includeDeleted ) throws HopException {
    return connectionDelegate.getIDs( "SELECT "
      + quote( HopDatabaseRepository.FIELD_PARTITION_SCHEMA_ID_PARTITION_SCHEMA ) + " FROM "
      + quoteTable( HopDatabaseRepository.TABLE_R_PARTITION_SCHEMA ) + " ORDER BY "
      + quote( HopDatabaseRepository.FIELD_PARTITION_SCHEMA_NAME ) );
  }

  public ObjectId[] getPartitionIDs( ObjectId id_partition_schema ) throws HopException {
    return connectionDelegate.getIDs( "SELECT "
      + quote( HopDatabaseRepository.FIELD_PARTITION_ID_PARTITION ) + " FROM "
  ...
  public ObjectId[] getTransformationPartitionSchemaIDs( ObjectId id_transformation ) throws HopException {
    return connectionDelegate.getIDs(
      "SELECT "
        + quote( HopDatabaseRepository.FIELD_TRANS_PARTITION_SCHEMA_ID_TRANS_PARTITION_SCHEMA ) + " FROM "
        + quoteTable( HopDatabaseRepository.TABLE_R_TRANS_PARTITION_SCHEMA ) + " WHERE "
        + quote( HopDatabaseRepository.FIELD_TRANS_PARTITION_SCHEMA_ID_TRANSFORMATION ) + " = ? ",
      id_transformation );
  }

  public ObjectId[] getTransformationClusterSchemaIDs( ObjectId id_transformation ) throws HopException {
    return connectionDelegate.getIDs(
      "SELECT ID_TRANS_CLUSTER FROM "
        + quoteTable( HopDatabaseRepository.TABLE_R_TRANS_CLUSTER ) + " WHERE ID_TRANSFORMATION = ? ",
      id_transformation );
  }

  public ObjectId[] getClusterIDs( boolean includeDeleted ) throws HopException {
    return connectionDelegate.getIDs( "SELECT "
      + quote( HopDatabaseRepository.FIELD_CLUSTER_ID_CLUSTER ) + " FROM "
      + quoteTable( HopDatabaseRepository.TABLE_R_CLUSTER ) + " ORDER BY "
      + quote( HopDatabaseRepository.FIELD_CLUSTER_NAME ) );
  }

  public ObjectId[] getSlaveIDs( boolean includeDeleted ) throws HopException {
    return connectionDelegate.getIDs( "SELECT "
      + quote( HopDatabaseRepository.FIELD_SLAVE_ID_SLAVE ) + " FROM "
      + quoteTable( HopDatabaseRepository.TABLE_R_SLAVE ) );
  }

  public ObjectId[] getClusterSlaveIDs( ObjectId id_cluster_schema ) throws HopException {
    return connectionDelegate.getIDs( "SELECT "
      + quote( HopDatabaseRepository.FIELD_CLUSTER_SLAVE_ID_SLAVE ) + " FROM "
      + quoteTable( HopDatabaseRepository.TABLE_R_CLUSTER_SLAVE ) + " WHERE "
      + quote( HopDatabaseRepository.FIELD_CLUSTER_SLAVE_ID_CLUSTER ) + " = ? ", id_cluster_schema );
  }

  public synchronized String[] getDatabaseNames( boolean includeDeleted ) throws HopException {
    String nameField = quote( HopDatabaseRepository.FIELD_DATABASE_NAME );
    return connectionDelegate.getStrings( "SELECT "
      + nameField + " FROM " + quoteTable( HopDatabaseRepository.TABLE_R_DATABASE ) + " ORDER BY "
      + nameField );
  }

  public synchronized String[] getPartitionSchemaNames( boolean includeDeleted ) throws HopException {
    String nameField = quote( HopDatabaseRepository.FIELD_PARTITION_SCHEMA_NAME );
    return connectionDelegate.getStrings( "SELECT "
      + nameField + " FROM " + quoteTable( HopDatabaseRepository.TABLE_R_PARTITION_SCHEMA ) + " ORDER BY "
      + nameField );
  }

  public synchronized String[] getSlaveNames( boolean includeDeleted ) throws HopException {
    String nameField = quote( HopDatabaseRepository.FIELD_SLAVE_NAME );
    return connectionDelegate.getStrings( "SELECT "
      + nameField + " FROM " + quoteTable( HopDatabaseRepository.TABLE_R_SLAVE ) + " ORDER BY " + nameField );
  }

  public synchronized String[] getClusterNames( boolean includeDeleted ) throws HopException {
    String nameField = quote( HopDatabaseRepository.FIELD_CLUSTER_NAME );
    return connectionDelegate
      .getStrings( "SELECT "
        + nameField + " FROM " + quoteTable( HopDatabaseRepository.TABLE_R_CLUSTER ) + " ORDER BY "
        + nameField );
  }

  public ObjectId[] getStepIDs( ObjectId id_transformation ) throws HopException {
    return connectionDelegate.getIDs( "SELECT "
      + quote( HopDatabaseRepository.FIELD_STEP_ID_STEP ) + " FROM "
      + quoteTable( HopDatabaseRepository.TABLE_R_STEP ) + " WHERE "
      + quote( HopDatabaseRepository.FIELD_STEP_ID_TRANSFORMATION ) + " = ?", id_transformation );
  }

  public synchronized String[] getTransformationsUsingDatabase( ObjectId id_database ) throws HopException {
    ObjectId[] transIds =
  ...
  public synchronized String[] getJobsUsingDatabase( ObjectId id_database ) throws HopException {
    ObjectId[] jobIds =
      connectionDelegate.getIDs( "SELECT DISTINCT "
        + quote( HopDatabaseRepository.FIELD_JOBENTRY_DATABASE_ID_JOB ) + " FROM "
        + quoteTable( HopDatabaseRepository.TABLE_R_JOBENTRY_DATABASE ) + " WHERE "
        + quote( HopDatabaseRepository.FIELD_JOBENTRY_DATABASE_ID_DATABASE ) + " = ? ", id_database );

    return jobDelegate.getJobsWithIDList( jobIds );
  }

  public synchronized String[] getClustersUsingSlave( ObjectId id_slave ) throws HopException {
  ...
  public synchronized String[] getTransformationsUsingSlave( ObjectId id_slave ) throws HopException {
    ObjectId[] transIds =
      connectionDelegate.getIDs( "SELECT DISTINCT "
  ...
  public synchronized String[] getTransformationsUsingPartitionSchema( ObjectId id_partition_schema ) throws HopException {
    ObjectId[] transIds =
      connectionDelegate.getIDs( "SELECT DISTINCT "
  ...
  public synchronized String[] getTransformationsUsingCluster( ObjectId id_cluster ) throws HopException {
    ObjectId[] transIds =
      connectionDelegate.getIDs( "SELECT DISTINCT "
  ...
  public ObjectId[] getJobHopIDs( ObjectId id_job ) throws HopException {
    return connectionDelegate.getIDs( "SELECT "
      + quote( HopDatabaseRepository.FIELD_JOB_HOP_ID_JOB_HOP ) + " FROM "
      + quoteTable( HopDatabaseRepository.TABLE_R_JOB_HOP ) + " WHERE "
      + quote( HopDatabaseRepository.FIELD_JOB_HOP_ID_JOB ) + " = ?", id_job );
  }

  public ObjectId[] getTransDependencyIDs( ObjectId id_transformation ) throws HopException {
    return connectionDelegate.getIDs( "SELECT "
      + quote( HopDatabaseRepository.FIELD_DEPENDENCY_ID_DEPENDENCY ) + " FROM "
      + quoteTable( HopDatabaseRepository.TABLE_R_DEPENDENCY ) + " WHERE "
      + quote( HopDatabaseRepository.FIELD_DEPENDENCY_ID_TRANSFORMATION ) + " = ?", id_transformation );
  }

  public ObjectId[] getJobEntryIDs( ObjectId id_job ) throws HopException {
    return connectionDelegate.getIDs( "SELECT "
      + quote( HopDatabaseRepository.FIELD_JOBENTRY_ID_JOBENTRY ) + " FROM "
      + quoteTable( HopDatabaseRepository.TABLE_R_JOBENTRY ) + " WHERE "
      + quote( HopDatabaseRepository.FIELD_JOBENTRY_ID_JOB ) + " = ?", id_job );
  }

  public ObjectId[] getJobEntryCopyIDs( ObjectId id_job ) throws HopException {
    return connectionDelegate.getIDs( "SELECT "
      + quote( HopDatabaseRepository.FIELD_JOBENTRY_COPY_ID_JOBENTRY_COPY ) + " FROM "
      + quoteTable( HopDatabaseRepository.TABLE_R_JOBENTRY_COPY ) + " WHERE "
      + quote( HopDatabaseRepository.FIELD_JOBENTRY_COPY_ID_JOB ) + " = ?", id_job );
  }

  public ObjectId[] getJobEntryCopyIDs( ObjectId id_job, ObjectId id_jobentry ) throws HopException {
    return connectionDelegate.getIDs( "SELECT "
      + quote( HopDatabaseRepository.FIELD_JOBENTRY_COPY_ID_JOBENTRY_COPY ) + " FROM "
      + quoteTable( HopDatabaseRepository.TABLE_R_JOBENTRY_COPY ) + " WHERE "
      + quote( HopDatabaseRepository.FIELD_JOBENTRY_COPY_ID_JOB ) + " = ? AND "
      + quote( HopDatabaseRepository.FIELD_JOBENTRY_COPY_ID_JOBENTRY ) + " = ? ", id_job, id_jobentry );
  }

  private RowMetaAndData getStepDatabase( ObjectId id_step ) throws HopException {
    return connectionDelegate.getOneRow(
      quoteTable( HopDatabaseRepository.TABLE_R_STEP_DATABASE ),
      quote( HopDatabaseRepository.FIELD_STEP_DATABASE_ID_STEP ), id_step );
  }

  private RowMetaAndData getJobEntryDatabase( ObjectId id_jobentry ) throws HopException {
    return connectionDelegate.getOneRow(
      quoteTable( HopDatabaseRepository.TABLE_R_JOBENTRY_DATABASE ),
      quote( HopDatabaseRepository.FIELD_JOBENTRY_DATABASE_ID_JOBENTRY ), id_jobentry );
  }
  ...
  public synchronized void delSteps( ObjectId id_transformation ) throws HopException {
    connectionDelegate.performDelete( "DELETE FROM "
      + quoteTable( HopDatabaseRepository.TABLE_R_STEP ) + " WHERE "
      + quote( HopDatabaseRepository.FIELD_STEP_ID_TRANSFORMATION ) + " = ? ", id_transformation );
  }

  public synchronized void deleteCondition( ObjectId id_condition ) throws HopException {
    boolean ok = true;
  ...
  public synchronized void delStepConditions( ObjectId id_transformation ) throws HopException {
   ...
   */
  public synchronized void delStepDatabases( ObjectId id_transformation ) throws HopException {
    connectionDelegate.performDelete( "DELETE FROM "
      + quoteTable( HopDatabaseRepository.TABLE_R_STEP_DATABASE ) + " WHERE "
      + quote( HopDatabaseRepository.FIELD_STEP_DATABASE_ID_TRANSFORMATION ) + " = ? ", id_transformation );
  }
   ...
   *           in case something unexpected happens.
   */
  public synchronized void delJobEntryDatabases( ObjectId id_job ) throws HopException {
    connectionDelegate.performDelete( "DELETE FROM "
      + quoteTable( HopDatabaseRepository.TABLE_R_JOBENTRY_DATABASE ) + " WHERE "
      + quote( HopDatabaseRepository.FIELD_JOBENTRY_DATABASE_ID_JOB ) + " = ? ", id_job );
  }

  public synchronized void delJobEntries( ObjectId id_job ) throws HopException {
    connectionDelegate.performDelete( "DELETE FROM "
      + quoteTable( HopDatabaseRepository.TABLE_R_JOBENTRY ) + " WHERE "
      + quote( HopDatabaseRepository.FIELD_JOBENTRY_ID_JOB ) + " = ? ", id_job );
  }

  public synchronized void delJobEntryCopies( ObjectId id_job ) throws HopException {
    connectionDelegate.performDelete( "DELETE FROM "
      + quoteTable( HopDatabaseRepository.TABLE_R_JOBENTRY_COPY ) + " WHERE "
      + quote( HopDatabaseRepository.FIELD_JOBENTRY_COPY_ID_JOB ) + " = ? ", id_job );
  }

  public synchronized void delDependencies( ObjectId id_transformation ) throws HopException {
    connectionDelegate.performDelete( "DELETE FROM "
      + quoteTable( HopDatabaseRepository.TABLE_R_DEPENDENCY ) + " WHERE "
      + quote( HopDatabaseRepository.FIELD_DEPENDENCY_ID_TRANSFORMATION ) + " = ? ", id_transformation );
  }

  public synchronized void delStepAttributes( ObjectId id_transformation ) throws HopException {
    connectionDelegate.performDelete( "DELETE FROM "
      + quoteTable( HopDatabaseRepository.TABLE_R_STEP_ATTRIBUTE ) + " WHERE "
      + quote( HopDatabaseRepository.FIELD_STEP_ATTRIBUTE_ID_TRANSFORMATION ) + " = ? ", id_transformation );
  }

  public synchronized void delTransAttributes( ObjectId id_transformation ) throws HopException {
    connectionDelegate.performDelete( "DELETE FROM "
      + quoteTable( HopDatabaseRepository.TABLE_R_TRANS_ATTRIBUTE ) + " WHERE "
      + quote( HopDatabaseRepository.FIELD_TRANS_ATTRIBUTE_ID_TRANSFORMATION ) + " = ? ", id_transformation );
  }

  public synchronized void delJobAttributes( ObjectId id_job ) throws HopException {
    connectionDelegate.performDelete( "DELETE FROM "
      + quoteTable( HopDatabaseRepository.TABLE_R_JOB_ATTRIBUTE ) + " WHERE "
      + quote( HopDatabaseRepository.FIELD_JOB_ATTRIBUTE_ID_JOB ) + " = ? ", id_job );
  }

  public synchronized void delPartitionSchemas( ObjectId id_transformation ) throws HopException {
    connectionDelegate.performDelete(
      "DELETE FROM "
        + quoteTable( HopDatabaseRepository.TABLE_R_TRANS_PARTITION_SCHEMA ) + " WHERE "
        + quote( HopDatabaseRepository.FIELD_TRANS_PARTITION_SCHEMA_ID_TRANSFORMATION ) + " = ? ",
  ...
  public synchronized void delPartitions( ObjectId id_partition_schema ) throws HopException {
    connectionDelegate.performDelete( "DELETE FROM "
      + quoteTable( HopDatabaseRepository.TABLE_R_PARTITION ) + " WHERE "
      + quote( HopDatabaseRepository.FIELD_PARTITION_ID_PARTITION_SCHEMA ) + " = ? ", id_partition_schema );
  }

  public synchronized void delClusterSlaves( ObjectId id_cluster ) throws HopException {
    connectionDelegate.performDelete( "DELETE FROM "
      + quoteTable( HopDatabaseRepository.TABLE_R_CLUSTER_SLAVE ) + " WHERE "
      + quote( HopDatabaseRepository.FIELD_CLUSTER_SLAVE_ID_CLUSTER ) + " =  ? ", id_cluster );
  }

  public synchronized void delTransformationClusters( ObjectId id_transformation ) throws HopException {
    connectionDelegate.performDelete( "DELETE FROM "
      + quoteTable( HopDatabaseRepository.TABLE_R_TRANS_CLUSTER ) + " WHERE "
      + quote( HopDatabaseRepository.FIELD_TRANS_CLUSTER_ID_TRANSFORMATION ) + " = ? ", id_transformation );
  }

  public synchronized void delTransformationSlaves( ObjectId id_transformation ) throws HopException {
    connectionDelegate.performDelete( "DELETE FROM "
      + quoteTable( HopDatabaseRepository.TABLE_R_TRANS_SLAVE ) + " WHERE "
      + quote( HopDatabaseRepository.FIELD_TRANS_SLAVE_ID_TRANSFORMATION ) + " = ? ", id_transformation );
  }

  public synchronized void delJobEntryAttributes( ObjectId id_job ) throws HopException {
    connectionDelegate.performDelete( "DELETE FROM "
      + quoteTable( HopDatabaseRepository.TABLE_R_JOBENTRY_ATTRIBUTE ) + " WHERE "
      + quote( HopDatabaseRepository.FIELD_JOBENTRY_ATTRIBUTE_ID_JOB ) + " = ? ", id_job );
  }

  public synchronized void delTransHops( ObjectId id_transformation ) throws HopException {
    connectionDelegate.performDelete( "DELETE FROM "
  ...
  public synchronized void delJobHops( ObjectId id_job ) throws HopException {
    connectionDelegate.performDelete( "DELETE FROM "
      + quoteTable( HopDatabaseRepository.TABLE_R_JOB_HOP ) + " WHERE "
      + quote( HopDatabaseRepository.FIELD_JOB_HOP_ID_JOB ) + " = ? ", id_job );
  }

  public synchronized void delTransNotes( ObjectId id_transformation ) throws HopException {
    ObjectId[] ids = getTransNoteIDs( id_transformation );

    for ( int i = 0; i < ids.length; i++ ) {
      connectionDelegate.performDelete( "DELETE FROM "
        + quoteTable( HopDatabaseRepository.TABLE_R_NOTE ) + " WHERE "
        + quote( HopDatabaseRepository.FIELD_NOTE_ID_NOTE ) + " = ? ", ids[i] );
    }
  ...
  public synchronized void delJobNotes( ObjectId id_job ) throws HopException {
  ...
  public synchronized void delTrans( ObjectId id_transformation ) throws HopException {
  ...
  public synchronized void delJob( ObjectId id_job ) throws HopException {
    securityProvider.validateAction( RepositoryOperation.DELETE_TRANSFORMATION );

    connectionDelegate.performDelete( "DELETE FROM "
      + quoteTable( HopDatabaseRepository.TABLE_R_JOB ) + " WHERE "
      + quote( HopDatabaseRepository.FIELD_JOB_ID_JOB ) + " = ? ", id_job );
  }

  public synchronized void delTransStepCondition( ObjectId id_transformation ) throws HopException {
    connectionDelegate.performDelete(
      "DELETE FROM "
        + quoteTable( HopDatabaseRepository.TABLE_R_TRANS_STEP_CONDITION ) + " WHERE "
        + quote( HopDatabaseRepository.FIELD_TRANS_STEP_CONDITION_ID_TRANSFORMATION ) + " = ? ",
  ...
  public synchronized void delValue( ObjectId id_value ) throws HopException {
    connectionDelegate.performDelete( "DELETE FROM "
      + quoteTable( HopDatabaseRepository.TABLE_R_VALUE ) + " WHERE "
      + quote( HopDatabaseRepository.FIELD_VALUE_ID_VALUE ) + " = ? ", id_value );
  }

  public synchronized void deleteSlave( ObjectId id_slave ) throws HopException {
    ...
    if ( transList.length == 0 && clustList.length == 0 ) {
      connectionDelegate.performDelete( "DELETE FROM "
        + quoteTable( HopDatabaseRepository.TABLE_R_SLAVE ) + " WHERE "
        + quote( HopDatabaseRepository.FIELD_SLAVE_ID_SLAVE ) + " = ? ", id_slave );
      connectionDelegate.performDelete( "DELETE FROM "
        + quoteTable( HopDatabaseRepository.TABLE_R_TRANS_SLAVE ) + " WHERE "
        + quote( HopDatabaseRepository.FIELD_TRANS_SLAVE_ID_SLAVE ) + " = ? ", id_slave );
      commit();
    } else {
      ...
      throw new HopDependencyException( "This slave server is still in use by one or more transformations ("
        + transList.length + ") or cluster schemas (" + clustList.length + ") :", e );
    }
  }

  public synchronized void deletePartitionSchema( ObjectId id_partition_schema ) throws HopException {
    partitionSchemaDelegate.delPartitionSchema( id_partition_schema );
    commit();
  }

  public synchronized void deleteClusterSchema( ObjectId id_cluster ) throws HopException {
    clusterSchemaDelegate.delClusterSchema( id_cluster );
    commit();
  }

  public synchronized void deleteTransformation( ObjectId id_transformation ) throws HopException {
  ...
  public synchronized void deleteJob( ObjectId id_job ) throws HopException {
  ...
  public boolean dropRepositorySchema() throws HopException {
   ...
   */
  public void updateStepTypes() throws HopException {
   ...
   *           if the update didn't go as planned.
   */
  public void updateDatabaseTypes() throws HopException {
   ...
   */
  public void updateJobEntryTypes() throws HopException {
  ...
  public synchronized void lockRepository() throws HopException {
    connectionDelegate.lockRepository();
  }

  public synchronized void unlockRepository() throws HopException {
   ...
   * @throws HopException
   */
  public List<DatabaseMeta> getDatabases() throws HopException {
  ...
  public void createRepositorySchema( ProgressMonitorListener monitor, boolean upgrade, List<String> statements,
    boolean dryRun ) throws HopException {
    creationHelper.createRepositorySchema( monitor, upgrade, statements, dryRun );
  }

  // REQUIRED INTERFACE METHODS...
  //
  public synchronized int countNrStepAttributes( ObjectId id_step, String code ) throws HopException {
    return connectionDelegate.countNrStepAttributes( id_step, code );
  }

  public synchronized int countNrJobEntryAttributes( ObjectId id_jobentry, String code ) throws HopException {
  ...
  @Override
  public boolean getJobEntryAttributeBoolean( ObjectId id_jobentry, int nr, String code, boolean def ) throws HopException {
   ...
   * @throws HopException
   */
  public ObjectId findStepAttributeID( ObjectId id_step, int nr, String code ) throws HopException {
    return connectionDelegate.findStepAttributeID( id_step, nr, code );
  }

  public void execStatement( String sql ) throws HopException {
  ...
  public ObjectId insertJobEntry( ObjectId id_job, JobEntryBase jobEntryBase ) throws HopException {
    return jobEntryDelegate.insertJobEntry( id_job, jobEntryBase );
  }

  public DatabaseMeta loadDatabaseMetaFromStepAttribute( ObjectId idStep, String code, List<DatabaseMeta> databases ) throws HopException {
   ...
   */
  public HopDatabaseRepositorySecurityProvider getSecurityProvider() {
    return securityProvider;
  }

  public HopDatabaseRepositorySecurityProvider getSecurityManager() {
    return securityProvider;
  }

  public void undeleteObject( RepositoryElementMetaInterface element ) throws HopException {
  ...
  public RepositoryDirectory getDefaultSaveDirectory( RepositoryElementInterface repositoryElement ) throws HopException {
    return getUserHomeDirectory();
  }

  public RepositoryDirectory getUserHomeDirectory() throws HopException {
    RepositoryDirectory root = new RepositoryDirectory();
    root.setObjectId( new LongObjectId( 0L ) );
    ...
    try {
      ...
      switch ( objectType ) {
        case TRANSFORMATION: {
          ...
          name = row.getString( HopDatabaseRepository.FIELD_TRANSFORMATION_NAME, null );
          description = row.getString( HopDatabaseRepository.FIELD_TRANSFORMATION_DESCRIPTION, null );
          modifiedUser = row.getString( HopDatabaseRepository.FIELD_TRANSFORMATION_MODIFIED_USER, "-" );
          modifiedDate = row.getDate( HopDatabaseRepository.FIELD_TRANSFORMATION_MODIFIED_DATE, null );
          dirId = row.getInteger( HopDatabaseRepository.FIELD_TRANSFORMATION_ID_DIRECTORY, 0 );
          break;
        }

        case JOB: {
          RowMetaAndData row = jobDelegate.getJob( objectId );
          name = row.getString( HopDatabaseRepository.FIELD_JOB_NAME, null );
          description = row.getString( HopDatabaseRepository.FIELD_JOB_DESCRIPTION, null );
          modifiedUser = row.getString( HopDatabaseRepository.FIELD_JOB_MODIFIED_USER, "-" );
          modifiedDate = row.getDate( HopDatabaseRepository.FIELD_JOB_MODIFIED_DATE, null );
          dirId = row.getInteger( HopDatabaseRepository.FIELD_JOB_ID_DIRECTORY, 0 );
          break;
        }
        //PDI-15871 Return available information for DATABASE
        case DATABASE: {
          RowMetaAndData row = databaseDelegate.getDatabase( objectId );
          name = row.getString( HopDatabaseRepository.FIELD_DATABASE_NAME, null );
          return new RepositoryObject(
              objectId, name, null, null, null, objectType, null, false );
        }
        default:
          throw new HopException( "Object type "
      ...
      throw new HopException( "Unable to get object information for object with id=" + objectId, e );
    }
  }

  public JobMeta loadJob( ObjectId idJob, String versionLabel ) throws HopException {
  ...
  public TransMeta loadTransformation( ObjectId idTransformation, String versionLabel ) throws HopException {
  ...
  public HopDatabaseRepositoryMetaStore getMetaStore() {
    return metaStore;
  }
}
