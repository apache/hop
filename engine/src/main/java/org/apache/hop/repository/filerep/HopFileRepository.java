...
public class HopFileRepository extends AbstractRepository {
  ...
  private HopFileRepositoryMeta repositoryMeta;
  private HopFileRepositorySecurityProvider securityProvider;
  ...
  public void init( RepositoryMeta repositoryMeta ) {
    ...
    this.repositoryMeta = (HopFileRepositoryMeta) repositoryMeta;
    this.securityProvider = new HopFileRepositorySecurityProvider( repositoryMeta );
  ...
  FileObject getFileObject( RepositoryElementInterface element ) throws HopFileException {
    return HopVFS.getFileObject( calcFilename( element.getRepositoryDirectory(), element.getName(), element
      .getRepositoryElementType().getExtension() ) );
  }

  @Override
  public boolean exists( final String name, final RepositoryDirectoryInterface repositoryDirectory,
    final RepositoryObjectType objectType ) throws HopException {
    try {
      FileObject fileObject =
        HopVFS.getFileObject( calcFilename( repositoryDirectory, name, objectType.getExtension() ) );
  ...
  public void save( RepositoryElementInterface repositoryElement, String versionComment,
    ProgressMonitorListener monitor, ObjectId parentId, boolean used ) throws HopException {
    try {
      if ( !( repositoryElement instanceof XMLInterface )
        && !( repositoryElement instanceof SharedObjectInterface ) ) {
        throw new HopException( "Class ["
      ...
      OutputStream os = HopVFS.getOutputStream( fileObject, false );
      ...
      throw new HopException( "Unable to save repository element ["
  ...
  public RepositoryDirectoryInterface createRepositoryDirectory( RepositoryDirectoryInterface parentDirectory,
    ...
    FileObject parent = HopVFS.getFileObject( newFolder );
    try {
      parent.createFolder();
    } catch ( FileSystemException e ) {
      throw new HopException( "Unable to create folder " + newFolder, e );
    }
  ...
  private void delObject( ObjectId id ) throws HopException {
  ...
  public void deleteCondition( ObjectId id_condition ) throws HopException {
  ...
  public void deleteRootObject( String name, String extension ) throws HopException {
    try {
      String filename = calcDirectoryName( null ) + name + extension;
      FileObject fileObject = HopVFS.getFileObject( filename );
      fileObject.delete();
    } catch ( Exception e ) {
      throw new HopException( "Unable to delete database with name ["
  ...
  public void deleteFile( String filename ) throws HopException {
    try {
      ...
      throw new HopException( "Unable to delete file with name [" + filename + "]", e );
    }
  }
  ...
  public String[] getClustersUsingSlave( ObjectId id_slave ) throws HopException {
    return new String[] {};
  }
  ...
  private ObjectId getObjectId( RepositoryDirectoryInterface repositoryDirectory, String name, String extension ) throws HopException {
    try {
      ...
      throw new HopException( "Error finding ID for directory ["
  ...
  private String[] getDatabaseNames( ObjectId[] databaseIds ) throws HopException {
  ...
  public ObjectId getRootDirectoryID() throws HopException {
  ...
  private ObjectId[] getRootObjectIDs( String extension ) throws HopException {
    try {
      ...
      throw new HopException( "Unable to get root object ids for extension [" + extension + "]", e );
    }
  }
  ...
  public ObjectId[] getSubDirectoryIDs( ObjectId id_directory ) throws HopException {
    RepositoryDirectoryInterface tree = loadRepositoryDirectoryTree();
    RepositoryDirectoryInterface directory = tree.findDirectory( id_directory );
  ...
  public String[] getTransformationsUsingCluster( ObjectId id_cluster ) throws HopException {
    return new String[] {};
  }
  ...
  public String[] getTransformationsUsingPartitionSchema( ObjectId id_partition_schema ) throws HopException {
    return new String[] {};
  }

  public String[] getTransformationsUsingSlave( ObjectId id_slave ) throws HopException {
    return new String[] {};
  }
  ...
  public ObjectId insertClusterSlave( ClusterSchema clusterSchema, SlaveServer slaveServer ) throws HopException {
    return null;
  }
  ...
  public void insertJobNote( ObjectId id_job, ObjectId id_note ) throws HopException {
  }
  ...
  public ObjectId insertLogEntry( String description ) throws HopException {
    ...
    try {
      OutputStream outputStream = HopVFS.getOutputStream( logfile, true );
      ...
      throw new HopException( "Unable to write log entry to file [" + logfile + "]" );
    }
  }
  ...
  public void insertTransNote( ObjectId id_transformation, ObjectId id_note ) throws HopException {

  }

  public void insertTransStepCondition( ObjectId id_transformation, ObjectId id_step, ObjectId id_condition ) throws HopException {

  }

  public ObjectId insertTransformationCluster( ObjectId id_transformation, ObjectId id_cluster ) throws HopException {

    return null;
  }

  public ObjectId insertTransformationPartitionSchema( ObjectId id_transformation, ObjectId id_partition_schema ) throws HopException {

    return null;
  }

  public ObjectId insertTransformationSlave( ObjectId id_transformation, ObjectId id_slave ) throws HopException {
  ...
  public ClusterSchema loadClusterSchema( ObjectId id_cluster_schema, List<SlaveServer> slaveServers,
    ...
    try {
      ...
      throw new HopException( "Unable to load cluster schema from the file repository", e );
    }
  }
  ...
  public Node loadNodeFromXML( ObjectId id, String tag ) throws HopException {
    try {
      ...
      throw new HopException( "Unable to load XML object from object with ID ["
        + id + "] and tag [" + tag + "]", e );
    }
  }
  ...
  public DatabaseMeta loadDatabaseMeta( ObjectId id_database, String versionName ) throws HopException {
    try {
      ...
      throw new HopException( "Unable to load database connection from the file repository", e );
    }
  }
  ...
  public PartitionSchema loadPartitionSchema( ObjectId id_partition_schema, String versionName ) throws HopException {
    try {
      ...
      throw new HopException( "Unable to load partition schema from the file repository", e );
    }
  }
  ...
  public RepositoryDirectoryInterface loadRepositoryDirectoryTree( RepositoryDirectoryInterface dir ) throws HopException {
    try {
      ...
      throw new HopException( "Unable to load the directory tree from this file repository", e );
    }
  }
  ...
  public List<RepositoryElementMetaInterface> getTransformationObjects( ObjectId idDirectory,
    ...
    try {
      ...
      throw new HopException( "Unable to get list of transformations in folder with id : " + idDirectory, e );
    }
  }
  ...
  public List<RepositoryElementMetaInterface> getJobObjects( ObjectId id_directory, boolean includeDeleted ) throws HopException {
    ...
    try {
      ...
      throw new HopException( "Unable to get list of jobs in folder with id : " + id_directory, e );
    }
  }

  public int getNrSubDirectories( ObjectId id_directory ) throws HopException {
  ...
  public SlaveServer loadSlaveServer( ObjectId id_slave_server, String versionName ) throws HopException {
    try {
      ...
      throw new HopException( "Unable to load slave server from the file repository", e );
    }
  }
   ...
   * @throws HopException
   */
  public void readDatabases( HasDatabasesInterface transMeta, boolean overWriteShared ) throws HopException {
    try {
  ...
  public void moveJob( String jobname, ObjectId id_directory_from, ObjectId id_directory_to ) throws HopException {

  }

  public void moveTransformation( String transname, ObjectId id_directory_from, ObjectId id_directory_to ) throws HopException {
  ...
  private ObjectId renameObject( ObjectId id, RepositoryDirectoryInterface newDirectory, String newName,
    String extension ) throws HopException {
    try {
      // In case of a root object, the ID is the same as the relative filename...
      //
      FileObject fileObject = HopVFS.getFileObject( calcDirectoryName( null ) + id.getId() );
      ...
      FileObject newObject = HopVFS.getFileObject( newFilename );
      fileObject.moveTo( newObject );

      return new StringObjectId( calcObjectId( newDirectory, newName, extension ) );
    } catch ( Exception e ) {
      throw new HopException( "Unable to rename object with ID [" + id + "] to [" + newName + "]", e );
    }
  ...
  public ObjectId renameRepositoryDirectory( ObjectId id, RepositoryDirectoryInterface newParentDir, String newName ) throws HopException {
    if ( newParentDir != null || newName != null ) {
      try {
        ...
        if ( dir == null ) {
          throw new HopException( "Could not find folder [" + id + "]" );
        }

        // If newName is null, keep the current name
        newName = ( newName != null ) ? newName : dir.getName();

        FileObject folder = HopVFS.getFileObject( dir.getPath() );

        String newFolderName = null;

        if ( newParentDir != null ) {
          FileObject newParentFolder = HopVFS.getFileObject( newParentDir.getPath() );
        ...
        FileObject newFolder = HopVFS.getFileObject( newFolderName );
        folder.moveTo( newFolder );

        return new StringObjectId( dir.getObjectId() );
      } catch ( Exception e ) {
        throw new HopException( "Unable to rename directory folder to [" + id + "]" );
      }
    }
    return ( id );
  }
  ...
  public UserInfo loadUserInfo( String login ) throws HopException {
    return null;
  }

  public UserInfo loadUserInfo( String login, String password ) throws HopException {
    return null;
  }
  ...
  public void saveUserInfo( UserInfo userInfo ) throws HopException {
  }
   ...
   */
  @Override
  public HopFileRepositoryMeta getRepositoryMeta() {
   ...
   */
  public void setRepositoryMeta( HopFileRepositoryMeta repositoryMeta ) {
  ...
  public RepositoryObject getObjectInformation( ObjectId objectId, RepositoryObjectType objectType ) throws HopException {
    try {
      ...
      final FileObject baseDirObject = HopVFS.getFileObject( repositoryMeta.getBaseDirectory() );
