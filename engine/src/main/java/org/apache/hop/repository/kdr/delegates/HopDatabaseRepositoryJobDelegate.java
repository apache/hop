...
public class HopDatabaseRepositoryJobDelegate extends HopDatabaseRepositoryBaseDelegate {
  ...
  public HopDatabaseRepositoryJobDelegate( HopDatabaseRepository repository ) {
    super( repository );
  }

  public RowMetaAndData getJob( ObjectId id_job ) throws HopException {
  ...
  public RowMetaAndData getJobHop( ObjectId id_job_hop ) throws HopException {
    return repository.connectionDelegate.getOneRow(
      quoteTable( HopDatabaseRepository.TABLE_R_JOB_HOP ),
      quote( HopDatabaseRepository.FIELD_JOB_HOP_ID_JOB_HOP ), id_job_hop );
  }

  public synchronized ObjectId getJobHopID( ObjectId id_job, ObjectId id_jobentry_copy_from,
    ObjectId id_jobentry_copy_to ) throws HopException {
    String[] lookupkey =
      new String[] {
        quote( HopDatabaseRepository.FIELD_JOB_HOP_ID_JOB ),
        quote( HopDatabaseRepository.FIELD_JOB_HOP_ID_JOBENTRY_COPY_FROM ),
        quote( HopDatabaseRepository.FIELD_JOB_HOP_ID_JOBENTRY_COPY_TO ), };
    ...
    return repository.connectionDelegate.getIDWithValue(
      quoteTable( HopDatabaseRepository.TABLE_R_JOB_HOP ),
      quote( HopDatabaseRepository.FIELD_JOB_HOP_ID_JOB_HOP ), lookupkey, key );
  }
   ...
   */
  public void saveJob( JobMeta jobMeta, String versionComment, ProgressMonitorListener monitor, boolean overwrite ) throws HopException {
    try {
   ...
   *           Upon any error.
   */
  private void saveJobParameters( JobMeta jobMeta ) throws HopException {
  ...
  public boolean existsJobMeta( String name, RepositoryDirectoryInterface repositoryDirectory,
    ...
    try {
      ...
      throw new HopException( "Unable to verify if the job with name ["
   ...
   * @throws HopException
   */
  public JobMeta loadJobMeta( String jobname, RepositoryDirectoryInterface repdir ) throws HopException {
   ...
   * @throws HopException
   */
  public JobMeta loadJobMeta( String jobname, RepositoryDirectoryInterface repdir, ProgressMonitorListener monitor ) throws HopException {
    ...
    synchronized ( repository ) {
      try {
        ...
        if ( jobMeta.getObjectId() != null ) {
          ...
          jobMeta.setName( jobRow.getString( HopDatabaseRepository.FIELD_JOB_NAME, null ) );
          jobMeta.setDescription( jobRow.getString( HopDatabaseRepository.FIELD_JOB_DESCRIPTION, null ) );
          jobMeta.setExtendedDescription( jobRow.getString(
            HopDatabaseRepository.FIELD_JOB_EXTENDED_DESCRIPTION, null ) );
          jobMeta.setJobversion( jobRow.getString( HopDatabaseRepository.FIELD_JOB_JOB_VERSION, null ) );
          jobMeta.setJobstatus( Const.toInt( jobRow
            .getString( HopDatabaseRepository.FIELD_JOB_JOB_STATUS, null ), -1 ) );

          jobMeta.setCreatedUser( jobRow.getString( HopDatabaseRepository.FIELD_JOB_CREATED_USER, null ) );
          jobMeta.setCreatedDate( jobRow.getDate( HopDatabaseRepository.FIELD_JOB_CREATED_DATE, new Date() ) );

          jobMeta.setModifiedUser( jobRow.getString( HopDatabaseRepository.FIELD_JOB_MODIFIED_USER, null ) );
          jobMeta.setModifiedDate( jobRow.getDate( HopDatabaseRepository.FIELD_JOB_MODIFIED_DATE, new Date() ) );

          long id_logdb = jobRow.getInteger( HopDatabaseRepository.FIELD_JOB_ID_DATABASE_LOG, 0 );
          if ( id_logdb > 0 ) {
          ...
          jobMeta.getJobLogTable().setTableName(
            jobRow.getString( HopDatabaseRepository.FIELD_JOB_TABLE_NAME_LOG, null ) );
          jobMeta.getJobLogTable().setBatchIdUsed(
            jobRow.getBoolean( HopDatabaseRepository.FIELD_JOB_USE_BATCH_ID, false ) );
          jobMeta.getJobLogTable().setLogFieldUsed(
            jobRow.getBoolean( HopDatabaseRepository.FIELD_JOB_USE_LOGFIELD, false ) );
          jobMeta.getJobLogTable().setLogSizeLimit(
            getJobAttributeString(
              jobMeta.getObjectId(), 0, HopDatabaseRepository.JOB_ATTRIBUTE_LOG_SIZE_LIMIT ) );

          jobMeta.setBatchIdPassed( jobRow.getBoolean( HopDatabaseRepository.FIELD_JOB_PASS_BATCH_ID, false ) );

          // Load all the log tables for the job...
          //
          RepositoryAttributeInterface attributeInterface =
            new HopDatabaseRepositoryJobAttribute( repository.connectionDelegate, jobMeta.getObjectId() );
          ...
          try {
            jobMeta
              .setSharedObjectsFile( jobRow.getString( HopDatabaseRepository.FIELD_JOB_SHARED_FILE, null ) );
          ...
          throw new HopException( BaseMessages.getString( PKG, "JobMeta.Exception.CanNotFindJob" ) + jobname );
        }
   ...
   *
   */
  private void loadRepParameters( JobMeta jobMeta ) throws HopException {
   ...
   *           Upon any error.
   */
  public String getJobParameterKey( ObjectId id_job, int nr ) throws HopException {
    return repository.connectionDelegate.getJobAttributeString(
      id_job, nr, HopDatabaseRepository.JOB_ATTRIBUTE_PARAM_KEY );
  }
   ...
   *           Upon any error.
   */
  public String getJobParameterDefault( ObjectId id_job, int nr ) throws HopException {
    return repository.connectionDelegate.getJobAttributeString(
      id_job, nr, HopDatabaseRepository.JOB_ATTRIBUTE_PARAM_DEFAULT );
  }
   ...
   *           Upon any error.
   */
  public String getJobParameterDescription( ObjectId id_job, int nr ) throws HopException {
    return repository.connectionDelegate.getJobAttributeString(
      id_job, nr, HopDatabaseRepository.JOB_ATTRIBUTE_PARAM_DESCRIPTION );
  }
   ...
   *           Upon any error.
   */
  public void insertJobParameter( ObjectId id_job, long nr, String key, String defValue, String description ) throws HopException {
    repository.connectionDelegate.insertJobAttribute(
      id_job, nr, HopDatabaseRepository.JOB_ATTRIBUTE_PARAM_KEY, 0, key != null ? key : "" );
    repository.connectionDelegate.insertJobAttribute(
      id_job, nr, HopDatabaseRepository.JOB_ATTRIBUTE_PARAM_DEFAULT, 0, defValue != null ? defValue : "" );
    repository.connectionDelegate.insertJobAttribute(
      id_job, nr, HopDatabaseRepository.JOB_ATTRIBUTE_PARAM_DESCRIPTION, 0, description != null
        ? description : "" );
  }
   ...
   *           Upon any error.
   */
  public int countJobParameter( ObjectId id_job ) throws HopException {
    return repository.connectionDelegate.countNrJobAttributes(
      id_job, HopDatabaseRepository.JOB_ATTRIBUTE_PARAM_KEY );
  }

  public JobHopMeta loadJobHopMeta( ObjectId id_job_hop, List<JobEntryCopy> jobcopies ) throws HopException {
    ...
    try {
      ...
      if ( r != null ) {
        ...
        throw new HopException( "Unable to find job hop with ID : " + id_job_hop );
      }
    } catch ( HopDatabaseException dbe ) {
      throw new HopException( BaseMessages.getString( PKG, "JobHopMeta.Exception.UnableToLoadHopInfoRep", ""
        + id_job_hop ), dbe );

    }
  }

  public void saveJobHopMeta( JobHopMeta hop, ObjectId id_job ) throws HopException {
    try {
      ...
      throw new HopException( BaseMessages.getString( PKG, "JobHopMeta.Exception.UnableToSaveHopInfoRep", ""
        + id_job ), dbe );
   ...
   * @throws HopException
   */
  public void readDatabases( JobMeta jobMeta ) throws HopException {
   ...
   * @throws HopException
   */
  public void readDatabases( JobMeta jobMeta, boolean overWriteShared ) throws HopException {
    try {
   ...
   * @throws HopException
   */
  public void readSlaves( JobMeta jobMeta, boolean overWriteShared ) throws HopException {
    try {
  ...
  public SharedObjects readSharedObjects( JobMeta jobMeta ) throws HopException {
  ...
  public synchronized ObjectId getJobID( String name, ObjectId id_directory ) throws HopException {
    return repository.connectionDelegate.getIDWithValue(
      quoteTable( HopDatabaseRepository.TABLE_R_JOB ), quote( HopDatabaseRepository.FIELD_JOB_ID_JOB ),
      quote( HopDatabaseRepository.FIELD_JOB_NAME ), name,
      quote( HopDatabaseRepository.FIELD_JOB_ID_DIRECTORY ), id_directory );
  }

  public synchronized int getNrJobs() throws HopException {
    int retval = 0;

    String sql = "SELECT COUNT(*) FROM " + quoteTable( HopDatabaseRepository.TABLE_R_JOB );
  ...
  public synchronized int getNrJobs( ObjectId id_directory ) throws HopException {
    int retval = 0;
    ...
    String sql =
      "SELECT COUNT(*) FROM "
        ...
        + quote( HopDatabaseRepository.FIELD_JOB_ID_DIRECTORY ) + " = ? ";
  ...
  public synchronized int getNrJobHops( ObjectId id_job ) throws HopException {
    int retval = 0;
  ...
  public String[] getJobsWithIDList( List<Object[]> list, RowMetaInterface rowMeta ) throws HopException {
    String[] jobList = new String[list.size()];
    for ( int i = 0; i < list.size(); i++ ) {
      long id_job = rowMeta.getInteger( list.get( i ), quote( HopDatabaseRepository.FIELD_JOB_ID_JOB ), -1L );
      if ( id_job > 0 ) {
        RowMetaAndData jobRow = getJob( new LongObjectId( id_job ) );
        if ( jobRow != null ) {
          String jobName = jobRow.getString( HopDatabaseRepository.FIELD_JOB_NAME, "<name not found>" );
          long id_directory = jobRow.getInteger( HopDatabaseRepository.FIELD_JOB_ID_DIRECTORY, -1L );
  ...
  public String[] getJobsWithIDList( ObjectId[] ids ) throws HopException {
    ...
    for ( int i = 0; i < ids.length; i++ ) {
      ...
      if ( id_job != null ) {
        ...
        if ( transRow != null ) {
          String jobName = transRow.getString( HopDatabaseRepository.FIELD_JOB_NAME, "<name not found>" );
          long id_directory = transRow.getInteger( HopDatabaseRepository.FIELD_JOB_ID_DIRECTORY, -1L );
          RepositoryDirectoryInterface dir =
  ...
  private synchronized void insertJob( JobMeta jobMeta ) throws HopException {
    RowMetaAndData table = new RowMetaAndData();

    table.addValue(
      new ValueMetaInteger( HopDatabaseRepository.FIELD_JOB_ID_JOB ), jobMeta
        .getObjectId() );
    table.addValue( new ValueMetaInteger(
      HopDatabaseRepository.FIELD_JOB_ID_DIRECTORY ), jobMeta
      .getRepositoryDirectory().getObjectId() );
    table.addValue(
      new ValueMetaString( HopDatabaseRepository.FIELD_JOB_NAME ), jobMeta
        .getName() );
    table.addValue(
      new ValueMetaString( HopDatabaseRepository.FIELD_JOB_DESCRIPTION ), jobMeta
        .getDescription() );
    table.addValue( new ValueMetaString(
      HopDatabaseRepository.FIELD_JOB_EXTENDED_DESCRIPTION ), jobMeta
      .getExtendedDescription() );
    table.addValue(
      new ValueMetaString( HopDatabaseRepository.FIELD_JOB_JOB_VERSION ), jobMeta
        .getJobversion() );
    table.addValue(
      new ValueMetaInteger( HopDatabaseRepository.FIELD_JOB_JOB_STATUS ), new Long(
        jobMeta.getJobstatus() < 0 ? -1L : jobMeta.getJobstatus() ) );

    table.addValue( new ValueMetaInteger(
      HopDatabaseRepository.FIELD_JOB_ID_DATABASE_LOG ), jobMeta
      .getJobLogTable().getDatabaseMeta() != null
      ? jobMeta.getJobLogTable().getDatabaseMeta().getObjectId() : -1L );
    table.addValue( new ValueMetaString(
      HopDatabaseRepository.FIELD_JOB_TABLE_NAME_LOG ), jobMeta
      .getJobLogTable().getTableName() );
    table.addValue( new ValueMetaBoolean(
      HopDatabaseRepository.FIELD_JOB_USE_BATCH_ID ), jobMeta
      .getJobLogTable().isBatchIdUsed() );
    table.addValue( new ValueMetaBoolean(
      HopDatabaseRepository.FIELD_JOB_USE_LOGFIELD ), jobMeta
      .getJobLogTable().isLogFieldUsed() );
    repository.connectionDelegate.insertJobAttribute(
      jobMeta.getObjectId(), 0, HopDatabaseRepository.JOB_ATTRIBUTE_LOG_SIZE_LIMIT, 0, jobMeta
        .getJobLogTable().getLogSizeLimit() );

    table.addValue(
      new ValueMetaString( HopDatabaseRepository.FIELD_JOB_CREATED_USER ), jobMeta
        .getCreatedUser() );
    table.addValue(
      new ValueMetaDate( HopDatabaseRepository.FIELD_JOB_CREATED_DATE ), jobMeta
        .getCreatedDate() );
    table.addValue( new ValueMetaString(
      HopDatabaseRepository.FIELD_JOB_MODIFIED_USER ), jobMeta
      .getModifiedUser() );
    table.addValue(
      new ValueMetaDate( HopDatabaseRepository.FIELD_JOB_MODIFIED_DATE ), jobMeta
        .getModifiedDate() );
    table.addValue( new ValueMetaBoolean(
      HopDatabaseRepository.FIELD_JOB_PASS_BATCH_ID ), jobMeta
      .isBatchIdPassed() );
    table.addValue(
      new ValueMetaString( HopDatabaseRepository.FIELD_JOB_SHARED_FILE ), jobMeta
        .getSharedObjectsFile() );

    repository.connectionDelegate.getDatabase().prepareInsert(
      table.getRowMeta(), HopDatabaseRepository.TABLE_R_JOB );
    repository.connectionDelegate.getDatabase().setValuesInsert( table );
    repository.connectionDelegate.getDatabase().insertRow();
    if ( log.isDebug() ) {
      log.logDebug( "Inserted new record into table "
        + quoteTable( HopDatabaseRepository.TABLE_R_JOB ) + " with data : " + table );
    }
  ...
  public synchronized ObjectId insertJobHop( ObjectId id_job, ObjectId id_jobentry_copy_from,
    ObjectId id_jobentry_copy_to, boolean enabled, boolean evaluation, boolean unconditional ) throws HopException {
    ObjectId id = repository.connectionDelegate.getNextJobHopID();

    RowMetaAndData table = new RowMetaAndData();

    table.addValue( new ValueMetaInteger(
      HopDatabaseRepository.FIELD_JOB_HOP_ID_JOB_HOP ), id );
    table.addValue(
      new ValueMetaInteger( HopDatabaseRepository.FIELD_JOB_HOP_ID_JOB ), id_job );
    table.addValue(
      new ValueMetaInteger(
        HopDatabaseRepository.FIELD_JOB_HOP_ID_JOBENTRY_COPY_FROM ),
      id_jobentry_copy_from );
    table
      .addValue(
        new ValueMetaInteger(
          HopDatabaseRepository.FIELD_JOB_HOP_ID_JOBENTRY_COPY_TO ),
        id_jobentry_copy_to );
    table.addValue(
      new ValueMetaBoolean( HopDatabaseRepository.FIELD_JOB_HOP_ENABLED ), Boolean
        .valueOf( enabled ) );
    table.addValue( new ValueMetaBoolean(
      HopDatabaseRepository.FIELD_JOB_HOP_EVALUATION ), Boolean
      .valueOf( evaluation ) );
    table.addValue( new ValueMetaBoolean(
      HopDatabaseRepository.FIELD_JOB_HOP_UNCONDITIONAL ), Boolean
      .valueOf( unconditional ) );

    repository.connectionDelegate.getDatabase().prepareInsert(
      table.getRowMeta(), HopDatabaseRepository.TABLE_R_JOB_HOP );
    repository.connectionDelegate.getDatabase().setValuesInsert( table );
    repository.connectionDelegate.getDatabase().insertRow();
    repository.connectionDelegate.getDatabase().closeInsert();
  ...
  public String getJobAttributeString( ObjectId id_job, int nr, String code ) throws HopException {
    return repository.connectionDelegate.getJobAttributeString( id_job, nr, code );
  }

  public long getJobAttributeInteger( ObjectId id_job, int nr, String code ) throws HopException {
    return repository.connectionDelegate.getJobAttributeInteger( id_job, nr, code );
  }

  public boolean getJobAttributeBoolean( ObjectId id_job, int nr, String code ) throws HopException {
    return repository.connectionDelegate.getJobAttributeBoolean( id_job, nr, code );
  }

  public synchronized void moveJob( String jobname, ObjectId id_directory_from, ObjectId id_directory_to ) throws HopException {
    String sql =
      "UPDATE "
        + quoteTable( HopDatabaseRepository.TABLE_R_JOB ) + " SET "
        + quote( HopDatabaseRepository.FIELD_JOB_ID_DIRECTORY ) + " = ? WHERE "
        + quote( HopDatabaseRepository.FIELD_JOB_NAME ) + " = ? AND "
        + quote( HopDatabaseRepository.FIELD_JOB_ID_DIRECTORY ) + " = ?";

    RowMetaAndData par = new RowMetaAndData();
    par.addValue(
      new ValueMetaInteger( HopDatabaseRepository.FIELD_JOB_ID_DIRECTORY ),
      id_directory_to );
    par.addValue(
      new ValueMetaString( HopDatabaseRepository.FIELD_JOB_NAME ), jobname );
    par.addValue(
      new ValueMetaInteger( HopDatabaseRepository.FIELD_JOB_ID_DIRECTORY ),
      id_directory_from );
  ...
  public synchronized void renameJob( ObjectId id_job, RepositoryDirectoryInterface newParentDir, String newname ) throws HopException {
    if ( newParentDir != null || newname != null ) {
      RowMetaAndData table = new RowMetaAndData();

      String sql = "UPDATE " + quoteTable( HopDatabaseRepository.TABLE_R_JOB ) + " SET ";

      boolean additionalParameter = false;

      if ( newname != null ) {
        additionalParameter = true;
        sql += quote( HopDatabaseRepository.FIELD_JOB_NAME ) + " = ? ";
        table.addValue(
          new ValueMetaString( HopDatabaseRepository.FIELD_JOB_NAME ), newname );
      }
      if ( newParentDir != null ) {
        if ( additionalParameter ) {
          sql += ", ";
        }
        sql += quote( HopDatabaseRepository.FIELD_JOB_ID_DIRECTORY ) + " = ? ";
        table.addValue( new ValueMetaInteger(
          HopDatabaseRepository.FIELD_JOB_ID_DIRECTORY ), newParentDir
          .getObjectId() );
      }

      sql += "WHERE " + quote( HopDatabaseRepository.FIELD_JOB_ID_JOB ) + " = ?";
      table.addValue(
        new ValueMetaInteger( HopDatabaseRepository.FIELD_JOB_ID_JOB ), id_job );
  ...
  private void saveJobAttributesMap( ObjectId jobId, Map<String, Map<String, String>> attributesMap ) throws HopException {
  ...
  private Map<String, Map<String, String>> loadJobAttributesMap( ObjectId jobId ) throws HopException {
    ...
    for ( Object[] attributeRow : attributeRows ) {
      String code = rowMeta.getString( attributeRow, HopDatabaseRepository.FIELD_JOB_ATTRIBUTE_CODE, null );
      String value =
        rowMeta.getString( attributeRow, HopDatabaseRepository.FIELD_JOB_ATTRIBUTE_VALUE_STR, null );
