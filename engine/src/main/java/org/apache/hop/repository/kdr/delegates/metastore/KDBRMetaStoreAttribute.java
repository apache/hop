...
public class KDBRMetaStoreAttribute implements IMetaStoreAttribute {
  ...
  protected HopDatabaseRepositoryMetaStoreDelegate delegate;
  ...
  public KDBRMetaStoreAttribute( HopDatabaseRepositoryMetaStoreDelegate delegate ) {
    this.children = new ArrayList<IMetaStoreAttribute>();
    this.delegate = delegate;
  }

  public KDBRMetaStoreAttribute( HopDatabaseRepositoryMetaStoreDelegate delegate, String id, Object value ) {
    this( delegate );
    this.id = id;
    this.value = value;
  }
  ...
  public HopDatabaseRepositoryMetaStoreDelegate getDelegate() {
    return delegate;
  }

  public void setDelegate( HopDatabaseRepositoryMetaStoreDelegate delegate ) {
    this.delegate = delegate;
  }
