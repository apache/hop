...
public class RepositoryImporter implements IRepositoryImporter, CanLimitDirs {
  ...
  public synchronized void importAll( RepositoryImportFeedbackInterface feedback, String fileDirectory,
    ...
    String importPathCompatibility =
        System.getProperty( Const.HOP_COMPATIBILITY_IMPORT_PATH_ADDITION_ON_VARIABLES, "N" );
      ...
      for ( RepositoryObject repoObject : referencingObjects ) {
        switch ( repoObject.getObjectType() ) {
          ...
          case JOB:
            ...
            break;
          default:
            throw new HopException( BaseMessages.getString( PKG, "RepositoryImporter.ErrorDetectFileType" ) );
        }
      }
   ...
   * @throws HopException
   */
  protected void loadSharedObjects() throws HopException {
   ...
   * @throws HopException
   */
  public static void validateImportedElement( ImportRules importRules, Object subject ) throws HopException {
  ...
  /**
   * Adapted from HopDatabaseRepositoryDatabaseDelegate.saveDatabaseMeta
   */
  ...
  protected void saveTransMeta( TransMeta transMeta ) throws HopException {
  ...
  protected void saveJobMeta( JobMeta jobMeta ) throws HopException {
    // Keep info on who & when this transformation was created...
  ...
  protected boolean importJob( Node jobnode, RepositoryImportFeedbackInterface feedback ) throws HopException {
  ...
  private RepositoryDirectoryInterface getTargetDirectory( String directoryPath, String dirOverride,
      RepositoryImportFeedbackInterface feedback ) throws HopException {
  ...
  private RepositoryDirectoryInterface getRepositoryRoot() throws HopException {
    if ( root == null ) {
  ...
  private void saveJobToRepo( JobMeta jobMeta, RepositoryImportFeedbackInterface feedback ) throws HopException {
    try {
