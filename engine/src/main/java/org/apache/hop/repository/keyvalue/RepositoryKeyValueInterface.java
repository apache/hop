...
package org.apache.hop.repository.keyvalue;
...
public interface RepositoryKeyValueInterface {
   ...
   */
  public void putValue( String namespace, String key, String value ) throws HopException;
   ...
   *           in case there is an unexpected repository error
   */
  public void removeValue( String namespace, String key ) throws HopException;
   ...
   *           in case there is an unexpected repository error
   */
  public String getValue( String namespace, String key, String revision ) throws HopException;
   ...
   *           in case there is an unexpected repository error
   */
  public List<String> listNamespaces() throws HopException;
   ...
   *           in case there is an unexpected repository error
   */
  public List<String> listKeys( String namespace ) throws HopException;
   ...
   *           in case there is an unexpected repository error
   */
  public List<RepositoryValueInterface> listValues( String namespace ) throws HopException;
}
