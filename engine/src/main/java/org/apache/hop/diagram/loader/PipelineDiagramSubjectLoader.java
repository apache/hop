...
/** Loads a {@link PipelineMeta} domain subject from a .hpl pipeline file. */
public class PipelineDiagramSubjectLoader implements IDiagramSubjectLoader {

  @Override
  public boolean supportsFile(String filename) {
    return filename != null && filename.toLowerCase().endsWith(".hpl");
  }
  ...
  public Object loadSubject(
    ...
    return new PipelineMeta(filename, metadataProvider, variables);
  }
}
