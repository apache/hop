...
public class JobExecutionConfiguration implements ExecutionConfiguration {
  ...
  public JobExecutionConfiguration( Node trecNode ) throws HopException {
    this();
  ...
  public Repository connectRepository( String repositoryName, String username, String password ) throws HopException {
