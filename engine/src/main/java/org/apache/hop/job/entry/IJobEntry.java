...
/**
 * IJobEntry is the main Java interface that a plugin implements. The responsibilities of the implementing class
 * are listed below:
 * <p>
 * <ul>
 ...
 * and setters. The dialog class implementing IJobEntryDialog is using the getters and setters to copy the user
 ...
 * getDialogClassName() must return the name of the class implementing the IJobEntryDialog.</li></br>
 ...
 * The class implementing IJobEntry executes the actual job entry task by implementing the following method:
 * <br/>
 * <br/>
...
public interface IJobEntry {
   ...
   */
  void check( List<ICheckResult> remarks, JobMeta jobMeta, IVariables variables, IMetaStore metaStore );
   ...
   * JobMeta
   *
   * @param jobMeta the JobMeta to which this IJobEntry belongs
   */
  ...
  default JobMeta getParentJobMeta() {
    throw new UnsupportedOperationException( "Attemped access of getJobMet not supported by IJobEntry implementation" );
  }
