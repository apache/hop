...
/**
 * This interface allows custom transforms to talk to Hop. The TransformMetaInterface is the main Java interface that a plugin
 ...
 * private fields with corresponding getters and setters. The dialog class implementing TransformDialogInterface is using the
 ...
 * The TransformMetaInterface plugin class is the main class tying in with the rest of PDI architecture. It is responsible
 * for supplying instances of the other plugin classes implementing TransformDialogInterface, TransformInterface and
 * TransformDataInterface. The following methods cover these responsibilities. Each of the method&#8217;s implementation is
 ...
 * <p>
 * public TransformDialogInterface getDialog(...)<br/>
 * public TransformInterface getTransform(...)<br/>
 * public TransformDataInterface getTransformData()<br/>
 * <p>
 * Each of the above methods returns a new instance of the plugin class implementing TransformDialogInterface, TransformInterface
 * and TransformDataInterface.</li>
 * <li>
 ...
 * org.apache.hop.core.row.RowMetaInterface[], org.apache.hop.pipeline.transform.TransformMeta,
...
public interface TransformMetaInterface<Main extends TransformInterface, Data extends TransformDataInterface> {
  /**
   * Set default values
   */
  void setDefault();
   ...
   */
  void getFields( RowMetaInterface inputRowMeta, String name, RowMetaInterface[] info, TransformMeta nextTransform,
   ...
   * @param metaStore the MetaStore to use to load additional external data or metadata impacting the output fields
   */
  void check( List<CheckResultInterface> remarks, PipelineMeta pipelineMeta, TransformMeta transformMeta,
   ...
   */
  TransformInterface createTransform( TransformMeta transformMeta, Data transformDataInterface, int copyNr,
   ...
   *
   * @return The appropriate TransformDataInterface class.
   */
  ...
  void analyseImpact( List<DatabaseImpact> impact, PipelineMeta pipelineMeta, TransformMeta transformMeta,
                      RowMetaInterface prev, String[] input, String[] output, RowMetaInterface info, IMetaStore metaStore ) throws HopTransformException;
   ...
   * SQLStatement
   */
  SQLStatement getSQLStatements( PipelineMeta pipelineMeta, TransformMeta transformMeta, RowMetaInterface prev,
   ...
   */
  TransformIOMetaInterface getTransformIOMeta();
