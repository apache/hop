...
package org.apache.hop.pipeline.steps.file;
...
import org.apache.hop.pipeline.step.errorhandling.CompositeFileErrorHandler;
import org.apache.hop.pipeline.step.errorhandling.FileErrorHandler;
import org.apache.hop.pipeline.step.errorhandling.FileErrorHandlerContentLineNumber;
import org.apache.hop.pipeline.step.errorhandling.FileErrorHandlerMissingFiles;
...
public abstract class BaseFileInputStep<M extends BaseFileInputMeta<?, ?, ?>, D extends BaseFileInputStepData> extends
  ...
  private static Class<?> PKG = BaseFileInputStep.class; // for i18n purposes, needed by Translator!!
  ...
  public BaseFileInputStep( StepMeta stepMeta, StepDataInterface stepDataInterface, int copyNr, PipelineMeta pipelineMeta,
                            Pipeline pipeline ) {
   ...
   */
  private RowMetaInterface[] filesFromPreviousStep() throws HopException {
    RowMetaInterface[] infoStep = null;
