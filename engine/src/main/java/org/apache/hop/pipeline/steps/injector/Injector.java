...
package org.apache.hop.pipeline.steps.injector;
...
/**
 * Executor class to allow a java program to inject rows of data into a pipeline. This step can be used as a
...
public class Injector extends BaseStep implements StepInterface {
  ...
  public Injector( StepMeta stepMeta, StepDataInterface stepDataInterface, int copyNr, PipelineMeta pipelineMeta,
                   Pipeline pipeline ) {
