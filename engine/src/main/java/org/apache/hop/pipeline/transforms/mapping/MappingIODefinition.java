...
public class MappingIODefinition implements Cloneable {
  ...
  /**
   * @param inputTransformName  the name of the transform to "connect" to. If no name is given, detect the source transform automatically: use all
   *                       input transforms for this mapping transform.
   * @param outputTransformName the name of the transform in the mapping to accept the data from the input transform. If no name is given, detect
  ...
  /**
   * @param inputTransform the input transform to set
   */
