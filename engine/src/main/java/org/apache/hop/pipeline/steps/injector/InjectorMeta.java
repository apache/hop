...
/**
 * Metadata class to allow a java program to inject rows of data into a pipeline. This step can be used as a
...
public class InjectorMeta extends BaseStepMeta implements StepMetaInterface {
  ...
  public StepInterface getStep( StepMeta stepMeta, StepDataInterface stepDataInterface, int cnr,
    ...
    return new Injector( stepMeta, stepDataInterface, cnr, pipelineMeta, pipeline );
  }
