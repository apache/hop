...
public class BaseStepMeta implements Cloneable, StepAttributesInterface {
  public static final LoggingObjectInterface loggingObject = new SimpleLoggingObject(
    "Step metadata", LoggingObjectType.STEP_META, null );
  ...
  public Object clone() {
    try {
      ...
      // PDI-15799: Makes a copy of the StepMeta. This copy can be used within the same Pipeline.
      ...
      try {
        if ( ioMetaVar != null ) {
          StepIOMetaInterface stepIOMeta =
            new StepIOMeta( ioMetaVar.isInputAcceptor(), ioMetaVar.isOutputProducer(), ioMetaVar.isInputOptional(), ioMetaVar.isSortedDataRequired(), ioMetaVar.isInputDynamic(),
   ...
   * (non-Javadoc)
   *
   * @see org.apache.hop.pipeline.step.StepAttributesInterface#findParent(java.util.List, java.lang.String)
   */
  @Override
   ...
   * (non-Javadoc)
   *
   * @see org.apache.hop.pipeline.step.StepAttributesInterface#findAttribute(java.lang.String)
   */
  @Override
   ...
   * (non-Javadoc)
   *
   * @see org.apache.hop.pipeline.step.StepAttributesInterface#getXmlCode(java.lang.String)
   */
  @Override
   ...
   * (non-Javadoc)
   *
   * @see org.apache.hop.pipeline.step.StepAttributesInterface#getDescription(java.lang.String)
   */
  @Override
   ...
   * (non-Javadoc)
   *
   * @see org.apache.hop.pipeline.step.StepAttributesInterface#getTooltip(java.lang.String)
   */
  @Override
  ...
  /**
   * @return The supported pipeline types that this step supports.
   */
