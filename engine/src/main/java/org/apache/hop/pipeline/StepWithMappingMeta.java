...
/**
 * This class is supposed to use in steps where the mapping to sub pipelines takes place
 *
...
public abstract class StepWithMappingMeta extends BaseSerializingMeta implements StepMetaInterface {
  ...
  public static PipelineMeta loadMappingMeta( StepWithMappingMeta mappingMeta, IMetaStore metaStore, VariableSpace space ) throws HopException {
  ...
  public static synchronized PipelineMeta loadMappingMeta( StepWithMappingMeta executorMeta,
    ...
    try {
      ...
      throw new HopException( BaseMessages.getString( PKG, "StepWithMappingMeta.Exception.UnableToLoadPipeline" ), e );
    }
  ...
  public String exportResources( VariableSpace space, Map<String, ResourceDefinition> definitions,
    ...
    try {
      ...
      throw new HopException( BaseMessages.getString( PKG, "StepWithMappingMeta.Exception.UnableToLoadPipeline", fileName ) );
    }
  }
