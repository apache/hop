...
package org.apache.hop.pipeline.steps.socketreader;
...
public class SocketReader extends BaseStep implements StepInterface {
  private static Class<?> PKG = SocketReaderMeta.class; // for i18n purposes, needed by Translator!!
  ...
  public SocketReader( StepMeta stepMeta, StepDataInterface stepDataInterface, int copyNr, PipelineMeta pipelineMeta,
                       Pipeline pipeline ) {
      ...
      if ( first ) {
        ...
        while ( !connected
          ...
          try {
            ...
            lastException =
              new HopException( "Unable to open socket to server "
