...
public class WorkflowExecutorMeta extends BaseTransformMeta implements ITransformMeta<WorkflowExecutor, WorkflowExecutorData> {
  ...
  /**
   * Optional name of a field to group rows together that are sent together to the workflow
  ...
  /**
   * The optional name of the output field that will contain the execution time of the workflow in (Integer in ms)
   */
  ...
  /**
   * The optional name of the output field that will contain the log text of the workflow execution (String)
   */
  private String executionLogTextField;

  /**
   * The optional name of the output field that will contain the log channel ID of the workflow execution (String)
   */
  ...
  @Override
  public ITransform createTransform( TransformMeta transformMeta, WorkflowExecutorData data, int cnr, PipelineMeta tr,
                                     Pipeline pipeline ) {
