...
public class StepStatus {
  ...
  public String getXML() throws HopException {
    try {
      ...
      throw new HopException( "Unable to serialize step '" + stepname + "' status data to XML", e );
    }
  }

  public StepStatus( Node node ) throws HopException {
  ...
  public StepStatus fromXML( String xml ) throws HopException {
