...
import org.apache.hop.pipeline.steps.pipelineexecutor.PipelineExecutor;
...
public class JobExecutor extends BaseStep implements StepInterface {
  ...
  public JobExecutor( StepMeta stepMeta, StepDataInterface stepDataInterface, int copyNr, PipelineMeta pipelineMeta,
                      Pipeline pipeline ) {
  ...
  private void executeJob() throws HopException {
    ...
    //
    getPipeline().getActiveSubjobs().put( getStepname(), data.executorJob );
