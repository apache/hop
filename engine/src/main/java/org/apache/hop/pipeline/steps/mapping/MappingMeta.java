...
public class MappingMeta extends StepWithMappingMeta implements StepMetaInterface,
  ...
  public void loadXML( Node stepnode, IMetaStore metaStore ) throws HopXMLException {
    try {
      ...
      throw new HopXMLException( BaseMessages.getString(
        PKG, "MappingMeta.Exception.ErrorLoadingPipelineStepFromXML" ), e );
    }
  }
  ...
  public void getFields( RowMetaInterface row, String origin, RowMetaInterface[] info, StepMeta nextStep,
    ...
    /*
     * Before we ask the mapping outputs anything, we should teach the mapping input steps in the sub-pipeline
    ...
    for ( MappingIODefinition definition : inputMappings ) {
      ...
      //
      StepMeta mappingInputStep = mappingPipelineMeta.findMappingInputStep( definition.getOutputStepname() );
    ...
    StepMeta mappingOutputStep =
      mappingPipelineMeta.findMappingOutputStep( mappingOutputDefinition.getInputStepname() );
  ...
  public StepInterface getStep( StepMeta stepMeta, StepDataInterface stepDataInterface, int cnr, PipelineMeta tr,
                                Pipeline pipeline ) {
    return new Mapping( stepMeta, stepDataInterface, cnr, tr, pipeline );
  }
