...
public interface TransformIOMetaInterface {
  ...
  StreamInterface findTargetStream( TransformMeta targetTransform );

  StreamInterface findInfoStream( TransformMeta infoTransform );
}
