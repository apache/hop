...
public interface RowDistributionInterface {
   ...
   * @param transformInterface The transform to distribute the rows in
   * @throws HopTransformException
   */
  public void distributeRow( RowMetaInterface rowMeta, Object[] row, TransformInterface transformInterface ) throws HopTransformException;
