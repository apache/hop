 ...
 * restart them later on without loosing track of the situation. Typically the TransformDataInterface implementing class will
 * contain result sets, temporary data, caching indexes, etc.
 *
 * @author Matt
 * @since 20-jan-2005
 */
public interface TransformDataInterface {
