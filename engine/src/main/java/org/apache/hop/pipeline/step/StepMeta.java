...
public class StepMeta implements
  ...
  private static Class<?> PKG = StepMeta.class; // for i18n purposes, needed by Translator!!
  ...
  public StepMeta( Node stepnode, IMetaStore metaStore ) throws HopXMLException,
    ...
    try {
      ...
      if ( sp == null ) {
        setStepMetaInterface( new Missing( name, stepid ) );
      } else {
  ...
  public void check( List<CheckResultInterface> remarks, PipelineMeta pipelineMeta, RowMetaInterface prev, String[] input,
    ...
    stepMetaInterface.check( remarks, pipelineMeta, this, prev, input, output, info, space, metaStore );
  }
  ...
  public List<ResourceReference> getResourceDependencies( PipelineMeta pipelineMeta ) {
    return stepMetaInterface.getResourceDependencies( pipelineMeta, this );
  }
  ...
  public boolean isMissing() {
    return this.stepMetaInterface instanceof Missing;
  }
