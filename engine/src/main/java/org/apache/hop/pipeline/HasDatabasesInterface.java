...
public interface HasDatabasesInterface {
  ...
  /**
   * Add a database connection to the pipeline.
   *
  ...
  /**
   * Add a database connection to the pipeline if that connection didn't exists yet. Otherwise, replace the
  ...
  /**
   * Add a database connection to the pipeline on a certain location.
   *
  ...
  /**
   * Removes a database from the pipeline on a certain location.
   *
  ...
  /**
   * Count the nr of databases in the pipeline.
   *
