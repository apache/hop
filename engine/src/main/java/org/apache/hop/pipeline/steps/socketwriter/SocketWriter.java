...
package org.apache.hop.pipeline.steps.socketwriter;
...
public class SocketWriter extends BaseStep implements StepInterface {
  ...
  public SocketWriter( StepMeta stepMeta, StepDataInterface stepDataInterface, int copyNr, PipelineMeta pipelineMeta,
                       Pipeline pipeline ) {
  ...
  public boolean init( StepMetaInterface smi, StepDataInterface sdi ) {
    ...
    if ( super.init( smi, sdi ) ) {
      try {
        ...
        data.serverSocket =
          getPipeline().getSocketRepository().openServerSocket(
            data.serverSocketPort, getPipelineMeta().getName() + " - " + this.toString() );
  ...
  public void dispose( StepMetaInterface smi, StepDataInterface sdi ) {
    ...
    try {
      getPipeline().getSocketRepository().releaseSocket( data.serverSocketPort );
