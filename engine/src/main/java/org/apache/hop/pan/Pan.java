...
import org.apache.hop.kitchen.Kitchen;
...
public class Pan {
  ...
  public static void main( String[] a ) throws Exception {
    HopClientEnvironment.getInstance().setClient( HopClientEnvironment.ClientType.PAN );
    HopEnvironment.init();
    ...
    String kettleRepname = Const.getEnvironmentVariable( Const.HOP_REPOSITORY, null );
    String kettleUsername = Const.getEnvironmentVariable( Const.HOP_USER, null );
    String kettlePassword = Const.getEnvironmentVariable(  Const.HOP_PASSWORD, null );
