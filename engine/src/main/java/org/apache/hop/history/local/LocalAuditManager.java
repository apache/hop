...
public class LocalAuditManager implements IAuditManager {
  ...
  @Override public void storeList( String group, String type, AuditList auditList ) throws HopException {
  ...
  @Override public void storeState( String group, String type, AuditState auditState ) throws HopException {
    if ( StringUtils.isEmpty( group ) ) {
  ...
  @Override public AuditState retrieveState( String group, String type, String name ) throws HopException {
    if ( StringUtils.isEmpty( group ) ) {
