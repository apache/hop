...
public class GetRepositoryNames extends BaseStep implements StepInterface {
  ...
  private List<RepositoryElementMetaInterface> getRepositoryObjects() throws HopException {
    ...
    try {
      ...
      throw new HopException( "Unable to get the list of repository objects from the repository", e );
    }
  }
  ...
  private List<RepositoryElementMetaInterface> getRepositoryObjects( RepositoryDirectoryInterface directory,
      String nameMask, String excludeNameMask ) throws HopException {
    List<RepositoryElementMetaInterface> list = new ArrayList<RepositoryElementMetaInterface>();
