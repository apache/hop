...
public class TransMeta extends AbstractMeta
  ...
  public TransMeta( String fname, IMetaStore metaStore, Repository rep, boolean setInternalVariables,
    ...
    Document doc = null;
    try {
      final FileObject transFile = HopVFS.getFileObject( fname, parentVariableSpace );
      if ( !transFile.exists() ) {
        throw new HopXMLException( BaseMessages.getString( PKG, "TransMeta.Exception.InvalidXMLPath", fname ) );
      }
  ...
  public void loadXML( Node transnode, String fname, IMetaStore metaStore, Repository rep, boolean setInternalVariables,
    ...
    try {
      ...
      try {
        ...
        ExtensionPointHandler.callExtensionPoint( log, HopExtensionPoint.TransformationMetaLoaded.id, this );
      }
    } catch ( Exception e ) {
