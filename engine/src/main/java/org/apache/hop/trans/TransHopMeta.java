...
public class TransHopMeta extends BaseHopMeta<StepMeta> implements Comparable<TransHopMeta> {
  ...
  public TransHopMeta( Node hopnode, List<StepMeta> steps ) throws HopXMLException {
    try {
      ...
      throw new HopXMLException( BaseMessages.getString( PKG, "TransHopMeta.Exception.UnableToLoadHopInfo" ), e );
    }
  }
