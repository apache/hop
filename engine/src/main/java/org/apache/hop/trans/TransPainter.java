...
public class TransPainter extends BasePainter<TransHopMeta, StepMeta> {
  ...
  private void drawTrans( Point thumb ) {
    ...
    try {
      ExtensionPointHandler.callExtensionPoint( LogChannel.GENERAL, HopExtensionPoint.TransPainterStart.id, this );
    ...
    try {
      ExtensionPointHandler.callExtensionPoint( LogChannel.GENERAL, HopExtensionPoint.TransPainterEnd.id, this );
    } catch ( HopException e ) {
  ...
  protected void drawArrow( EImage arrow, int x1, int y1, int x2, int y2, double theta, int size, double factor,
    ...
    try {
      ExtensionPointHandler.callExtensionPoint(
        LogChannel.GENERAL, HopExtensionPoint.TransPainterArrow.id, extension );
    } catch ( Exception e ) {
