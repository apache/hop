...
public abstract class BasePartitioner implements Partitioner {
   ...
   * (non-Javadoc)
   *
   * @see org.apache.hop.trans.Partitioner#setMeta(org.apache.hop.trans.step.StepPartitioningMeta)
   */
   ...
   * (non-Javadoc)
   *
   * @see org.apache.hop.trans.Partitioner#getInstance()
   */
   ...
   * (non-Javadoc)
   *
   * @see org.apache.hop.trans.Partitioner#getDescription()
   */
   ...
   * (non-Javadoc)
   *
   * @see org.apache.hop.trans.Partitioner#setDescription(java.lang.String)
   */
   ...
   * (non-Javadoc)
   *
   * @see org.apache.hop.trans.Partitioner#getId()
   */
  public String getId() {
    return id;
  }
   ...
   * (non-Javadoc)
   *
   * @see org.apache.hop.trans.Partitioner#setId(java.lang.String)
   */
