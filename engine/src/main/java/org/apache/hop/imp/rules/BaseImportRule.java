...
public abstract class BaseImportRule implements ImportRuleInterface {
   ...
   *
   * The expected name is in the org.apache.hop.ui tree and has a class name that is the name of the job entry with
   * 'Composite' added to the end.
   *
   * e.g. if the import rule class name is: "org.apache.hop.imp.rules.DatabaseConfigurationImportRule" the composite
   * then the composite class name would be: "org.apache.hop.ui.imp.rules.DatabaseConfigurationImportRuleComposite"
   *
