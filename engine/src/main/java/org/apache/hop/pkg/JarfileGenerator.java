...
public class JarfileGenerator {
  ...
  public static final void generateJarFile( TransMeta transMeta ) {
    ...
    HopDependencies deps = new HopDependencies( transMeta );
    ...
    try {
      ...
      strManifest += "Created-By: Hop version " + BuildVersion.getInstance().getVersion() + Const.CR;
