...
@ExtensionPoint(
    id = "LineageHubWorkflowActionBeforeXp",
    extensionPointId = "WorkflowBeforeActionExecution",
    description = "Emits lineage RUN_LIFECYCLE STARTED before a workflow action runs")
public class LineageHubWorkflowActionBeforeXp
  ...
  public void callExtensionPoint(
      ...
      throws HopException {
    LineageRunLifecycleEmitter.emitWorkflowAction(extension, RunLifecyclePhase.STARTED, null);
  }
}
