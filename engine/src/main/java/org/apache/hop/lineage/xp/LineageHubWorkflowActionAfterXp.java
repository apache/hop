...
@ExtensionPoint(
    id = "LineageHubWorkflowActionAfterXp",
    extensionPointId = "WorkflowAfterActionExecution",
    description = "Emits lineage RUN_LIFECYCLE FINISHED or FAILED after a workflow action runs")
public class LineageHubWorkflowActionAfterXp
  ...
  public void callExtensionPoint(
    ...
    RunLifecyclePhase phase =
        LineageRunLifecycleEmitter.workflowActionFailed(extension)
            ? RunLifecyclePhase.FAILED
            : RunLifecyclePhase.FINISHED;
    LineageRunLifecycleEmitter.emitWorkflowAction(extension, phase, null);
  }
}
