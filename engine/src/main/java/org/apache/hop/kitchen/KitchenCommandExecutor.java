...
public class KitchenCommandExecutor extends AbstractBaseCommandExecutor {
  ...
  Future<HopException> kettleInit;
  ...
  public KitchenCommandExecutor( Class<?> pkgClazz, LogChannelInterface log, Future<HopException> kettleInit ) {
    setPkgClazz( pkgClazz );
    setLog( log );
    setHopInit( kettleInit );
  }
  ...
  public int printVersion() {
    printVersion( "Kitchen.Log.HopVersion" );
    return CommandExecutorCodes.Kitchen.HOP_VERSION_PRINT.getCode();
  }
  ...
  protected void printRepositoryStoredJobs( Repository repository, RepositoryDirectoryInterface directory ) throws HopException {
  ...
  public Future<HopException> getHopInit() {
    return kettleInit;
  }

  public void setHopInit( Future<HopException> kettleInit ) {
