 ...
 */
public class HopFileRepositoryMetaTest {
  ...
  public static final String JSON_OUTPUT = "{\"isDefault\":true,\"displayName\":\"Name\",\"showHiddenFolders\":true,"
    + "\"description\":\"Description\",\"location\":\"\\/this\\/is\\/the\\/path\",\"id\":\"HopFileRepository\","
    + "\"doNotModify\":true}";

  private RepositoriesMeta repositoriesMeta = mock( RepositoriesMeta.class );

  HopFileRepositoryMeta kettleFileRepositoryMeta;

  @Before
  public void setup() {
    kettleFileRepositoryMeta = new HopFileRepositoryMeta();
  }
