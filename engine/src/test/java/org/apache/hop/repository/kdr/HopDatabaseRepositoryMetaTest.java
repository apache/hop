...
public class HopDatabaseRepositoryMetaTest {

  public static final String JSON_OUTPUT =
    "{\"isDefault\":true,\"displayName\":\"Name\",\"description\":\"Description\","
      + "\"databaseConnection\":\"Database Connection\",\"id\":\"HopDatabaseRepository\"}";
  ...
  HopDatabaseRepositoryMeta kettleDatabaseRepositoryMeta;

  @Before
  public void setup() {
    kettleDatabaseRepositoryMeta = new HopDatabaseRepositoryMeta();
  }
