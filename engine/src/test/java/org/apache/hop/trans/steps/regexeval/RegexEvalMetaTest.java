...
public class RegexEvalMetaTest implements InitializerInterface<StepMetaInterface> {
  ...
  @Test
  public void testGetFieldsReplacesResultFieldIfItExists() throws HopStepException {
  ...
  @Test
  public void testGetFieldsAddsResultFieldIfDoesntExist() throws HopStepException {
    RegexEvalMeta regexEvalMeta = new RegexEvalMeta();
    String name = "TEST_NAME";
    String resultField = "result";
    regexEvalMeta.setResultFieldName( resultField );
  ...
  @Test
  public void testGetFieldsReplacesFieldIfItExists() throws HopStepException {
    RegexEvalMeta regexEvalMeta = new RegexEvalMeta();
    String name = "TEST_NAME";
  ...
  @Test
  public void testGetFieldsAddsFieldIfDoesntExist() throws HopStepException {
    RegexEvalMeta regexEvalMeta = new RegexEvalMeta();
    String name = "TEST_NAME";
    regexEvalMeta.allocate( 1 );
    String fieldName = "fieldname";
