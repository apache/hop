...
public class TransMetaTest {
  ...
  public void testGetPrevInfoFields() throws HopStepException {
    ...
    final String UDJC_METHOD =
      "public boolean processRow( StepMetaInterface smi, StepDataInterface sdi ) throws HopException { return "
        + "false; }";
  ...
  public void testTransWithOneStepIsConsideredUsed() throws Exception {
    ...
    transMeta.checkSteps( remarks, false, monitor, new Variables(), metaStore );
