...
public class SlaveServerWorkflowStatusLoadSaveTester extends LoadSaveBase<SlaveServerWorkflowStatus> {

  public SlaveServerWorkflowStatusLoadSaveTester( Class<SlaveServerWorkflowStatus> clazz, List<String> commonAttributes ) {
  ...
  protected void testXmlRoundTrip() throws HopException {
    SlaveServerWorkflowStatus metaToSave = createMeta();
