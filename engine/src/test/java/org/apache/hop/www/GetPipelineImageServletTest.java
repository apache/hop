...
class GetPipelineImageServletTest {
  ...
  void doGetReturnsEarlyWhenContextPathDoesNotMatchInJettyMode()
    ...
    GetPipelineImageServlet servlet = new GetPipelineImageServlet();
  ...
  void doGetReturnsNoContentWhenGraphicsDisabled() throws IOException, ServletException {
    ...
    HttpServletRequest request = mock(HttpServletRequest.class);
    when(request.getContextPath()).thenReturn(GetPipelineImageServlet.CONTEXT_PATH);
    HttpServletResponse response = mock(HttpServletResponse.class);
