...
public class StopPipelineServletTest {
  private PipelineMap mockPipelineMap;

  private StopPipelineServlet stopPipelineServlet;

  @Before
  public void setup() {
    mockPipelineMap = mock( PipelineMap.class );
    stopPipelineServlet = new StopPipelineServlet( mockPipelineMap );
  }

  @Test
  @PrepareForTest( { Encode.class } )
  public void testStopPipelineServletEscapesHtmlWhenPipelineNotFound() throws ServletException, IOException {
    ...
    when( mockHttpServletRequest.getContextPath() ).thenReturn( StopPipelineServlet.CONTEXT_PATH );
    when( mockHttpServletRequest.getParameter( anyString() ) ).thenReturn( ServletTestUtils.BAD_STRING_TO_TEST );
    when( mockHttpServletResponse.getWriter() ).thenReturn( printWriter );

    stopPipelineServlet.doGet( mockHttpServletRequest, mockHttpServletResponse );
  ...
  @Test
  @PrepareForTest( { Encode.class } )
  public void testStopPipelineServletEscapesHtmlWhenPipelineFound() throws ServletException, IOException {
    HopLogStore.init();
    HttpServletRequest mockHttpServletRequest = mock( HttpServletRequest.class );
    HttpServletResponse mockHttpServletResponse = mock( HttpServletResponse.class );
  ...
  public void testWillStopInputTransformsOnly() throws ServletException, IOException {
    ...
    stopPipelineServlet.doGet( mockHttpServletRequest, mockHttpServletResponse );
    Mockito.verify( mockPipeline ).safeStop();
  }
}
