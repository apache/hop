...
package org.apache.hop.ui.pipeline.transforms.script;
...
import org.apache.hop.pipeline.transforms.script.ScriptAddedFunctions;
import org.apache.hop.pipeline.transforms.script.ScriptDummy;
import org.apache.hop.pipeline.transforms.script.ScriptMeta;
import org.apache.hop.pipeline.transforms.script.ScriptValuesScript;
...
public class ScriptDialog extends BaseTransformDialog implements TransformDialogInterface {
  ...
  public void getData() {
    ...
    org.apache.hop.pipeline.transforms.script.ScriptValuesScript[] jsScripts = input.getJSScripts();
