...
package org.apache.hop.ui.pipeline.transforms.sql;
...
public class ExecSQLDialog extends BaseTransformDialog implements TransformDialogInterface {
  ...
  private void checkCancel( ShellEvent e ) {
    if ( changedInDialog ) {
      int save = JobGraph.showChangedWarning( shell, wTransformName.getText() );
      if ( save == SWT.CANCEL ) {
        e.doit = false;
