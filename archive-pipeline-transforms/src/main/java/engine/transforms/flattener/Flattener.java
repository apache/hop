 ...
 * @since 17-jan-2006
 */
public class Flattener extends BaseTransform implements TransformInterface {
  ...
  public Flattener( TransformMeta transformMeta, TransformDataInterface transformDataInterface, int copyNr, PipelineMeta pipelineMeta,
                    Pipeline pipeline ) {
    super( transformMeta, transformDataInterface, copyNr, pipelineMeta, pipeline );

    meta = (FlattenerMeta) getTransformMeta().getTransformMetaInterface();
    data = (FlattenerData) transformDataInterface;
  }
