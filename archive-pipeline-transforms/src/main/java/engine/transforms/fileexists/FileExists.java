...
public class FileExists extends BaseTransform implements TransformInterface {
  ...
  public FileExists( TransformMeta transformMeta, TransformDataInterface transformDataInterface, int copyNr, PipelineMeta pipelineMeta,
                     Pipeline pipeline ) {
