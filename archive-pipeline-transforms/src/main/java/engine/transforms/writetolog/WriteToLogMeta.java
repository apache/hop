...
public class WriteToLogMeta extends BaseTransformMeta implements TransformMetaInterface {
  ...
  public TransformInterface getTransform( TransformMeta transformMeta, TransformDataInterface transformDataInterface, int cnr, PipelineMeta tr,
                                Pipeline pipeline ) {
    return new WriteToLog( transformMeta, transformDataInterface, cnr, tr, pipeline );
  }
