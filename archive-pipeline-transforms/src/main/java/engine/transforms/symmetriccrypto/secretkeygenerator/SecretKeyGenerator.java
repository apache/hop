 ...
 * @since 01-4-2011
 */
public class SecretKeyGenerator extends BaseTransform implements TransformInterface {
  ...
  public SecretKeyGenerator( TransformMeta transformMeta, TransformDataInterface transformDataInterface, int copyNr,
