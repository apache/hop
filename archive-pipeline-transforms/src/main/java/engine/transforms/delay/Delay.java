 ...
 * @since 27-06-2008
 */
public class Delay extends BaseTransform implements TransformInterface {
  ...
  public Delay( TransformMeta transformMeta, TransformDataInterface transformDataInterface, int copyNr, PipelineMeta pipelineMeta,
                Pipeline pipeline ) {
