...
public class WebServiceAvailable extends BaseTransform implements TransformInterface {
  ...
  public WebServiceAvailable( TransformMeta transformMeta, TransformDataInterface transformDataInterface, int copyNr,
