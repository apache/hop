...
public class SasInputMeta extends BaseTransformMeta implements TransformMetaInterface {
  ...
  public TransformInterface getTransform( TransformMeta transformMeta, TransformDataInterface transformDataInterface, int cnr, PipelineMeta tr,
                                Pipeline pipeline ) {
    return new SasInput( transformMeta, transformDataInterface, cnr, tr, pipeline );
  }
