 ...
 * @since 6-apr-2003
 */
public class SQLFileOutput extends BaseTransform implements TransformInterface {
  ...
  public SQLFileOutput( TransformMeta transformMeta, TransformDataInterface transformDataInterface, int copyNr, PipelineMeta pipelineMeta,
                        Pipeline pipeline ) {
