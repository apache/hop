...
public class UniqueRowsMeta extends BaseTransformMeta implements TransformMetaInterface {
  ...
  public TransformInterface getTransform( TransformMeta transformMeta, TransformDataInterface transformDataInterface, int cnr,
    ...
    return new UniqueRows( transformMeta, transformDataInterface, cnr, pipelineMeta, pipeline );
  }
