...
public class TableExists extends BaseTransform implements TransformInterface {
  ...
  public TableExists( TransformMeta transformMeta, TransformDataInterface transformDataInterface, int copyNr, PipelineMeta pipelineMeta,
                      Pipeline pipeline ) {
