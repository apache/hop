...
public class SFTPPutMeta extends BaseTransformMeta implements TransformMetaInterface {
  ...
  public TransformInterface getTransform( TransformMeta transformMeta, TransformDataInterface transformDataInterface, int cnr, PipelineMeta tr,
                                Pipeline pipeline ) {
    return new SFTPPut( transformMeta, transformDataInterface, cnr, tr, pipeline );
  }
