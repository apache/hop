...
public class SyslogMessageMeta extends BaseTransformMeta implements TransformMetaInterface {
  ...
  public TransformInterface getTransform( TransformMeta transformMeta, TransformDataInterface transformDataInterface, int cnr,
    ...
    return new SyslogMessage( transformMeta, transformDataInterface, cnr, pipelineMeta, pipeline );
  }
