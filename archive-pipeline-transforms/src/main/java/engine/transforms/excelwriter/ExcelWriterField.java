...
public class ExcelWriter Field implements Cloneable {
  private String name;
  private int type;
  ...
  public ExcelWriter Field( String name, int type, String format ) {
    this.name = name;
    this.type = type;
    this.format = format;
  }

  public ExcelWriter Field() {
  }

  public int compare( Object obj ) {
    ExcelWriter Field field = (ExcelWriter Field) obj;
