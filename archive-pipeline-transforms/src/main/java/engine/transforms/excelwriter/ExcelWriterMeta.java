...
public class ExcelWriterTransformMeta extends BaseTransformMeta implements TransformMetaInterface {
   ...
   * The output fields
   */
  private ExcelWriter Field[] outputFields;
   ...
   */
  public ExcelWriter Field[] getOutputFields() {
    return outputFields;
  }
   ...
   */
  public void setOutputFields( ExcelWriter Field[] outputFields ) {
  ...
  public void allocate( int nrFields ) {
    outputFields = new ExcelWriter Field[ nrFields ];
  }
  ...
  public Object clone() {
    ...
    for ( int i = 0; i < nrFields; i++ ) {
      retval.outputFields[ i ] = (ExcelWriter Field) outputFields[ i ].clone();
    }
  ...
  public String getXML() {
    ...
    for ( int i = 0; i < outputFields.length; i++ ) {
      ExcelWriter Field field = outputFields[ i ];
