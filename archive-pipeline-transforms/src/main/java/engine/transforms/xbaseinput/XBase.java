...
public class XBase {
  ...
  public void open() throws HopException {
    try {
      ...
      throw new HopException( "Error opening DBF metadata", e );
    } catch ( IOException e ) {
      throw new HopException( "Error reading DBF file", e );
    }
  }
  ...
  public IRowMeta getFields() throws HopException {
    ...
    try {
      ...
      throw new HopException( "Error reading DBF metadata (in part " + debug + ")", e );
    }
  ...
  public Object[] getRow( Object[] r ) throws HopException {
    try {
      ...
      error = true;
      throw new HopException( "Unable to read row from XBase file", e );
    } catch ( Exception e ) {
