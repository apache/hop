 ...
 * @since 01-4-2010
 */
public class RandomCCNumberGeneratorMeta extends BaseTransformMeta implements TransformMetaInterface {
  ...
  public TransformInterface getTransform( TransformMeta transformMeta, TransformDataInterface transformDataInterface, int cnr,
    ...
    return new RandomCCNumberGenerator( transformMeta, transformDataInterface, cnr, pipelineMeta, pipeline );
  }
