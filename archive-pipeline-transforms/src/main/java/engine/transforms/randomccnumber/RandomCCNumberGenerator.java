 ...
 * @since 01-4-2010
 */
public class RandomCCNumberGenerator extends BaseTransform implements TransformInterface {
  ...
  public RandomCCNumberGenerator( TransformMeta transformMeta, TransformDataInterface transformDataInterface, int copyNr,
