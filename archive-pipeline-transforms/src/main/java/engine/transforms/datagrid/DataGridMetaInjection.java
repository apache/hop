 ...
 * @author Matt
 */
public class DataGridMetaInjection implements TransformMetaInjectionInterface {
  ...
  public List<TransformInjectionMetaEntry> getTransformInjectionMetadataEntries() throws HopException {
    ...
    // Add the fields...
    //
    TransformInjectionMetaEntry fieldsEntry = new TransformInjectionMetaEntry( Entry.FIELDS.name(), Entry.FIELDS.getValueType(),
      Entry.FIELDS.getDescription() );
    all.add( fieldsEntry );

    TransformInjectionMetaEntry fieldEntry = new TransformInjectionMetaEntry( Entry.FIELD.name(), Entry.FIELD.getValueType(),
    ...
    // And the data fields
    //
    TransformInjectionMetaEntry sheetsEntry = new TransformInjectionMetaEntry( Entry.DATA_LINES.name(),
      Entry.DATA_LINES.getValueType(), Entry.DATA_LINES.getDescription() );
    all.add( sheetsEntry );

    TransformInjectionMetaEntry sheetEntry = new TransformInjectionMetaEntry( Entry.DATA_LINE.name(),
