...
public class NullIfMeta extends BaseTransformMeta implements TransformMetaInterface {
  ...
  public TransformInterface getTransform( TransformMeta transformMeta, TransformDataInterface transformDataInterface, int cnr, PipelineMeta pipelineMeta,
                                Pipeline pipeline ) {
    return new NullIf( transformMeta, transformDataInterface, cnr, pipelineMeta, pipeline );
  }
