...
public class SplitFieldToRowsMeta extends BaseTransformMeta implements TransformMetaInterface {
  ...
  public TransformInterface getTransform( TransformMeta transformMeta, TransformDataInterface transformDataInterface, int cnr,
    ...
    return new SplitFieldToRows( transformMeta, transformDataInterface, cnr, pipelineMeta, pipeline );
  }
