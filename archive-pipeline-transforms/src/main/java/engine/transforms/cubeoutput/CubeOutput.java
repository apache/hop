...
public class CubeOutput extends BaseTransform implements TransformInterface {
  ...
  public CubeOutput( TransformMeta transformMeta, TransformDataInterface transformDataInterface, int copyNr, PipelineMeta pipelineMeta,
                     Pipeline pipeline ) {
