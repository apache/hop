...
public class ExcelWriterTransformMetaTest {
  ...
  public void testRoundTrip() throws HopException {
    ...
    fieldLoadSaveValidatorTypeMap.put( ExcelWriter Field[].class.getCanonicalName(),
      new ArrayLoadSaveValidator<ExcelWriter Field>( new ExcelWriter FieldLoadSaveValidator() ) );
  ...
  public class ExcelWriter FieldLoadSaveValidator implements FieldLoadSaveValidator<ExcelWriter Field> {
    @Override
    public boolean validateTestObject( ExcelWriter Field testObject, Object actual ) {
      //Perform more-extensive test, as equals() method does check on "name" only
      ExcelWriter Field obj2 = (ExcelWriter Field) actual;
    ...
    @Override
    public ExcelWriter Field getTestObject() {
      ExcelWriter Field obj = new ExcelWriter Field();
