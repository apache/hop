...
public class FuzzyMatchTest {
  ...
  private class FuzzyMatchHandler extends FuzzyMatch {
    ...
    public FuzzyMatchHandler( TransformMeta transformMeta, ITransformData data, int copyNr, PipelineMeta pipelineMeta,
                              Pipeline pipeline ) {
     ...
     * @return the row set
     * @throws org.apache.hop.core.exception.HopTransformException the hop transform exception
     */
    @Override
