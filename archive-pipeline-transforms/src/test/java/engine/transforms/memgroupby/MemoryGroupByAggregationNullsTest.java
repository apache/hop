...
public class MemoryGroupByAggregationNullsTest {
  ...
  public void setUp() throws Exception {
    ...
    data.aggMeta = rmi;
    transform = new MemoryGroupBy( mockHelper.transformMeta, data, 0, mockHelper.pipelineMeta, mockHelper.pipeline );
  ...
  public void addToAggregateBinaryData() throws Exception {
    ...
    when( mockHelper.transformMeta.getITransform() ).thenReturn( memoryGroupByMeta );
