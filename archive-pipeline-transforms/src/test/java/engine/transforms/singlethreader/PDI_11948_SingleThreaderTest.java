...
/**
 * The PDI_11948_SimpleMappingTest class tests Single Threader transform of PDI-11948 bug. It's check if HttpServletResponse
 * object is null and call or not setServletReponse( HttpServletResponse response ) method of appropriate Pipeline object.
 *
 * @author Yury Bakhmutski
 * @see org.apache.hop.pipeline.transforms.simplemapping.SingleThreader
 */
public class PDI_11948_SingleThreaderTest extends PDI_11948_TransformsTestsParent<SingleThreader, SingleThreaderData> {

  @Override
  @Before
  public void init() throws Exception {
    super.init();
    transformMock = mock( SingleThreader.class );
    transformDataMock = mock( SingleThreaderData.class );
  }
