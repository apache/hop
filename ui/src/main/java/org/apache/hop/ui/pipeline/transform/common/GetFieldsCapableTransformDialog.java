 ...
 */
public interface GetFieldsCapableTransformDialog<TransformMetaType extends BaseTransformMeta> {
  Class<?> PKG = GetFieldsCapableTransformDialog.class; // for i18n purposes, needed by Translator!!

  LogChannel logger = new LogChannel( GetFieldsCapableTransformDialog.class );
