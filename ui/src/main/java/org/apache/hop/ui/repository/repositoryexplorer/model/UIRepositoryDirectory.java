...
public class UIRepositoryDirectory extends UIRepositoryObject {
  ...
  public UIRepositoryObjects getRepositoryObjects() throws HopException {
   ...
   * @throws HopException
   */
  public String checkDirNameExistsInRepo( String name ) throws HopException {
  ...
  public UIRepositoryDirectory createFolder( String name ) throws Exception {
    ...
    if ( !contains( directories, newDir ) ) {
      ...
      throw new HopException( "Unable to create folder with the same name [" + name + "]" );
    }
