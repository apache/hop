...
public class SpoonTransformationDelegate extends SpoonDelegate {
  ...
  public void executeTransformation( final TransMeta transMeta, final boolean local, final boolean remote,
    ...
    if ( execConfigAnswer ) {
      ...
      ExtensionPointHandler.callExtensionPoint( log, HopExtensionPoint.SpoonTransMetaExecutionStart.id, transMeta );
      ExtensionPointHandler.callExtensionPoint( log, HopExtensionPoint.SpoonTransExecutionConfiguration.id,
