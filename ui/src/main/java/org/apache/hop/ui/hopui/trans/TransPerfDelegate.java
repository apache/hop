...
public class TransPerfDelegate extends HopUiDelegate {
  ...
  public void setupContent() {
    ...
    fdDataListLabel.right = new FormAttachment( hopUi.props.getMiddlePct() / 2, Const.MARGIN );
    ...
    fdDataList.right = new FormAttachment( hopUi.props.getMiddlePct() / 2, Const.MARGIN );
    ...
    fdStepsListLabel.right = new FormAttachment( hopUi.props.getMiddlePct() / 2, Const.MARGIN );
    ...
    fdStepsList.right = new FormAttachment( hopUi.props.getMiddlePct() / 2, Const.MARGIN );
    ...
    fdCanvas.left = new FormAttachment( hopUi.props.getMiddlePct() / 2, Const.MARGIN );
