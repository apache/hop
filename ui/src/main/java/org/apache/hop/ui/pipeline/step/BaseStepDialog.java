...
package org.apache.hop.ui.pipeline.step;
...
public class BaseStepDialog extends Dialog {
   ...
   */
  public BaseStepDialog( Shell parent, BaseStepMeta baseStepMeta, PipelineMeta pipelineMeta, String stepname ) {
    super( parent, SWT.NONE );

    this.log = new LogChannel( baseStepMeta );
    this.pipelineMeta = pipelineMeta;
    this.stepname = stepname;
    this.stepMeta = pipelineMeta.findStep( stepname );
   ...
   * @param stepname     the step name
   */
  public BaseStepDialog( Shell parent, StepMetaInterface baseStepMeta, PipelineMeta pipelineMeta, String stepname ) {
    super( parent, SWT.NONE );
   ...
   */
  public BaseStepDialog( Shell parent, int nr, BaseStepMeta in, PipelineMeta tr ) {
   ...
   */
  public static final void getFieldsFromPrevious( PipelineMeta pipelineMeta, StepMeta stepMeta, TableView tableView,
                                                  int keyColumn, int[] nameColumn, int[] dataTypeColumn,
                                                  int lengthColumn, int precisionColumn,
                                                  TableItemInsertListener listener ) {
    try {
      RowMetaInterface row = pipelineMeta.getPrevStepFields( stepMeta );
      if ( row != null ) {
   ...
   * @param stepMeta  the step metadata
   */
  public static final void getFieldsFromPrevious( ComboVar comboVar, PipelineMeta pipelineMeta, StepMeta stepMeta ) {
    String selectedField = null;
    int indexField = -1;
    try {
      RowMetaInterface r = pipelineMeta.getPrevStepFields( stepMeta );
