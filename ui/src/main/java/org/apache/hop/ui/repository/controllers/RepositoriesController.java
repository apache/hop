...
package org.apache.hop.ui.repository.controllers;
...
import org.apache.hop.ui.repository.RepositoriesHelper;
...
public class RepositoriesController extends AbstractXulEventHandler {
  ...
  public void login() {
    ...
    HopWaitBox box;
    try {
      box = (HopWaitBox) document.createElement( "iconwaitbox" );
