...
import org.apache.hop.repository.ExportFeedback;
import org.apache.hop.repository.IRepositoryExporter;
import org.apache.hop.repository.IRepositoryExporterFeedback;
...
public class RepositoryExportProgressDialog {
  ...
  public static MessageBox checkIsFileIsAcceptable( Shell shell, LogChannelInterface log, String filename ) {
    ...
    try {
      ...
      FileObject output = HopVFS.getFileObject( filename );
      if ( output.exists() ) {
