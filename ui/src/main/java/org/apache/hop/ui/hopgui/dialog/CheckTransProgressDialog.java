...
public class CheckTransProgressDialog {
  private static Class<?> PKG = CheckTransProgressDialog.class; // for i18n purposes, needed by Translator!!
  ...
  public CheckTransProgressDialog( Shell shell, TransMeta transMeta, List<CheckResultInterface> remarks,
    ...
    this( shell, transMeta, remarks, onlySelected, transMeta, HopGui.getInstance().getMetaStore() );
  }
