...
public class MissingActionDialog extends ActionDialog {
  ...
  private String marketplaceSearchFilter() {
    if (mode != MISSING_ACTIONS) {
      return ((MissingAction) action).getMissingPluginId();
    }
    List<String> pluginIds =
        missingActions.stream().map(MissingAction::getMissingPluginId).distinct().toList();
  ...
  private void openMarketplace(String filter) {
    try {
      ...
      new ErrorDialog(
          getParent(),
          BaseMessages.getString(PKG, "MissingActionDialog.MissingPlugins"),
          BaseMessages.getString(PKG, "MissingActionDialog.SearchMarketplace.Error"),
          e);
    }
  }
  ...
  public IAction open() {
    ...
    if (ExtensionPointMap.getInstance()
      ...
      marketplaceButton.setText(
          BaseMessages.getString(PKG, "MissingActionDialog.SearchMarketplace"));
      marketplaceButton.setToolTipText(
          BaseMessages.getString(PKG, "MissingActionDialog.SearchMarketplace.Tooltip"));
