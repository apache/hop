...
public class JavaScriptStyledTextComp extends StyledTextVar {

  public JavaScriptStyledTextComp(IVariables variables, Composite parent, int style) {
  ...
  public JavaScriptStyledTextComp(
    ...
    super(variables, parent, style, varsSensitive, variableIconOnTop, true, STYLE_TYPE_JAVASCRIPT);
  }
