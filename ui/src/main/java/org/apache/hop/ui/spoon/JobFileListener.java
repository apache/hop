...
public class JobFileListener implements FileListener {
  ...
  public boolean open( Node jobNode, String fname, boolean importfile ) {
    ...
    try {
      ...
      ExtensionPointHandler.callExtensionPoint( spoon.getLog(), HopExtensionPoint.JobBeforeOpen.id, fname );
      ...
      ExtensionPointHandler.callExtensionPoint( spoon.getLog(), HopExtensionPoint.JobAfterOpen.id, jobMeta );
  ...
  public boolean save( EngineMetaInterface meta, String fname, boolean export ) {
    ...
    try {
      ExtensionPointHandler.callExtensionPoint( spoon.getLog(), HopExtensionPoint.JobBeforeSave.id, lmeta );
    } catch ( HopException e ) {
      // fails gracefully
    }
    ...
    if ( saveStatus ) {
      try {
        ExtensionPointHandler.callExtensionPoint( spoon.getLog(), HopExtensionPoint.JobAfterSave.id, lmeta );
      } catch ( HopException e ) {
        // fails gracefully
      }
    }
