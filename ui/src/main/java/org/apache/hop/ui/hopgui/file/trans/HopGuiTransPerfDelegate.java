...
public class HopGuiTransPerfDelegate  {
   ...
   * @param transGraph
   */
  public HopGuiTransPerfDelegate( HopGui hopUi, HopGuiTransGraph transGraph ) {
    this.hopUi = hopUi;
  ...
  private void showEmptyGraph() {
    ...
    button.addSelectionListener( new SelectionAdapter() {
      public void widgetSelected( SelectionEvent event ) {
        HopGuiTransGraph.editProperties( transGraph.getTransMeta(), hopUi, true, TransDialog.Tabs.MONITOR_TAB );
      }
    } );
