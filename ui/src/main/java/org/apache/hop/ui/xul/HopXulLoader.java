...
public class HopXulLoader extends SwtXulLoader {
  ...
  public HopXulLoader() throws XulException {
    parser.handlers.remove( "DIALOG" );
    parser.registerHandler( "DIALOG", org.apache.hop.ui.xul.HopDialog.class.getName() );

    parser.handlers.remove( "ICONWAITBOX" );
    parser.registerHandler( "ICONWAITBOX", org.apache.hop.ui.xul.HopWaitBox.class.getName() );
  }
