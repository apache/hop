...
import org.apache.hop.ui.spoon.wizards.RipDatabaseWizardPage1;
import org.apache.hop.ui.spoon.wizards.RipDatabaseWizardPage2;
import org.apache.hop.ui.spoon.wizards.RipDatabaseWizardPage3;
...
public class SpoonJobDelegate extends SpoonDelegate {
  ...
  public void executeJob( JobMeta jobMeta, boolean local, boolean remote, Date replayDate, boolean safe,
    ...
    if ( !jobMeta.isShowDialog() || dialog.open() ) {
      ...
      ExtensionPointHandler.callExtensionPoint( log, HopExtensionPoint.SpoonJobMetaExecutionStart.id, jobMeta );
      ExtensionPointHandler.callExtensionPoint( log, HopExtensionPoint.SpoonJobExecutionConfiguration.id,
