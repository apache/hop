...
//  private Image imageViewAsXml;
  ...
  private void loadCommonImages() {
    ...
    imageForward = loadAsResource(display, "ui/images/arrow-right.svg", ConstUi.SMALL_ICON_SIZE);
    ...
    imageBack = loadAsResource(display, "ui/images/arrow-left.svg", ConstUi.SMALL_ICON_SIZE);
