 ...
 */
public class HopWaitBox extends SwtWaitBox {

  private XulDomContainer container;
  private String icon;

  public HopWaitBox( Element self, XulComponent parent, XulDomContainer container, String tagName ) {
  ...
  @Override protected Shell createDialog() {
    ...
    Image[] images = HopImageUtil.loadImages( container, dialog.getShell(), icon );
