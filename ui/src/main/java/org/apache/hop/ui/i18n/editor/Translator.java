...
public class Translator {
  ...
  public void readFiles( String directory ) throws HopFileException {
    ...
    try {
      ...
      for ( String filename : files.keySet() ) {
        ...
        if ( locale.charAt( 2 ) != '_' ) {
          log.logError( "This i18n locale file is not conform the Hop standard: " + filename );
        }
      }
    } catch ( Exception e ) {
      throw new HopFileException( "Unable to get all files from directory [" + ROOT + "]", e );
    }
  }
  ...
  private String loadJava( String javaFile, String propertiesFilename, String entry ) throws HopFileException {
    ...
    try {
      ...
      throw new HopFileException( propertiesFilename
