...
package org.apache.hop.ui.pipeline.step.common;
...
/**
 * A common interface for all step dialogs aware of the csv input format, such as CSV Input and Text File Input Dialog
 */
public interface CsvInputAwareStepDialog {

  /**
   * @See {@link GetFieldsCapableStepDialog#getFieldNames(org.apache.hop.pipeline.step.BaseStepMeta)}
   */
