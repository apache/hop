...
import org.apache.hop.database.DatabaseConnectionDialog;
...
public class XulDatabaseDialog {
  ...
  private static final String MESSAGES = "org.apache.hop.ui.core.database.dialog.messages.messages";
  ...
  private static final String EXTENDED_WIDGET_CLASSNAME = "org.apache.hop.ui.core.database.dialog.tags.ExtTextbox";
  ...
  private void createDialog() {
    ...
    try {
       ...
       */
      container = databaseDialogInstance.getSwtInstance( new HopXulLoader(), parentShell );
