...
package org.apache.hop.ui.spoon.tree.provider;
...
import org.apache.hop.ui.spoon.DatabasesCollector;
    ...
    try {
      try {
        ...
        if ( e.getCause() instanceof HopRepositoryLostException ) {
          Spoon.getInstance().handleRepositoryLost( (HopRepositoryLostException) e.getCause() );
