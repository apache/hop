...
import org.apache.hop.ui.core.database.dialog.tags.ExtTextbox;
...
public class DataOverrideHandler extends DataHandler {
  ...
  @Override public void getControls() {
  ...
  @Override public void showMessage( String message, boolean scroll ) {
    Shell parent = getShell();
