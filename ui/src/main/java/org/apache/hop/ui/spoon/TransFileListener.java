...
public class TransFileListener implements FileListener {
  ...
  public boolean open( Node transNode, String fname, boolean importfile ) throws HopMissingPluginsException {
    ...
    try {
      ...
      ExtensionPointHandler.callExtensionPoint( spoon.getLog(), HopExtensionPoint.TransBeforeOpen.id, fname );
      ...
      ExtensionPointHandler.callExtensionPoint( spoon.getLog(), HopExtensionPoint.TransAfterOpen.id, transMeta );
  ...
  public boolean save( EngineMetaInterface meta, String fname, boolean export ) {
    ...
    try {
      ExtensionPointHandler.callExtensionPoint( spoon.getLog(), HopExtensionPoint.TransBeforeSave.id, lmeta );
    } catch ( HopException e ) {
      // fails gracefully
    }
    ...
    if ( saveStatus ) {
      try {
        ExtensionPointHandler.callExtensionPoint( spoon.getLog(), HopExtensionPoint.TransAfterSave.id, lmeta );
      } catch ( HopException e ) {
        // fails gracefully
      }
    }
