...
public class HopDialog extends SwtDialog {
  private final Map<String, Image[]> imagesCache = new HashMap<>();

  public HopDialog( Element self, XulComponent parent, XulDomContainer container, String tagName ) {
  ...
  public void hide() {
    ...
    // Save the window location & size in the Hop world...
    //
  ...
  public void setAppicon( String icon ) {
    ...
    if ( images == null ) {
      images = HopImageUtil.loadImages( domContainer, dialog.getShell(), icon );
      synchronized ( imagesCache ) {
