...
@HopFileTypePlugin(
    id = "YamlExplorerFileType",
    name = "YAML File Type",
    description = "YAML file handling in the explorer perspective",
    image = "ui/images/file.svg")
public class YamlExplorerFileType extends BaseTextExplorerFileType<YamlExplorerFileTypeHandler> {

  public YamlExplorerFileType() {
    super(
        "YAML File",
        ".yaml",
        new String[] {"*.yml", "*.yaml"},
  ...
  @Override
  public YamlExplorerFileTypeHandler createFileTypeHandler(
      HopGui hopGui, ExplorerPerspective perspective, ExplorerFile file) {
    return new YamlExplorerFileTypeHandler(hopGui, perspective, file);
  }
