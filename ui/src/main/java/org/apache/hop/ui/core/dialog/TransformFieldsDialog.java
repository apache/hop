...
public class TransformFieldsDialog extends Dialog {
  ...
  public Object open() {
    ...
    ColumnInfo[] colinf =
      new ColumnInfo[] {
        new ColumnInfo(
          BaseMessages.getString( PKG, "TransformFieldsDialog.TableCol.Fieldname" ), ColumnInfo.COLUMN_TYPE_TEXT,
          false, true ),
        new ColumnInfo(
        ...
        new ColumnInfo(
          ...
          false, true ),
        new ColumnInfo(
          BaseMessages.getString( PKG, "TransformFieldsDialog.TableCol.Precision" ), ColumnInfo.COLUMN_TYPE_TEXT,
          false, true ),
        new ColumnInfo(
          BaseMessages.getString( PKG, "TransformFieldsDialog.TableCol.Origin" ), ColumnInfo.COLUMN_TYPE_TEXT,
          false, true ),
        new ColumnInfo(
        ...
        new ColumnInfo(
          ...
          false, true ),
        new ColumnInfo(
          BaseMessages.getString( PKG, "TransformFieldsDialog.TableCol.Decimal" ), ColumnInfo.COLUMN_TYPE_TEXT,
          false, true ),
        new ColumnInfo(
          BaseMessages.getString( PKG, "TransformFieldsDialog.TableCol.Group" ), ColumnInfo.COLUMN_TYPE_TEXT,
          false, true ),
        new ColumnInfo(
          BaseMessages.getString( PKG, "TransformFieldsDialog.TableCol.TrimType" ), ColumnInfo.COLUMN_TYPE_TEXT,
          false, true ),
        new ColumnInfo(
          BaseMessages.getString( PKG, "TransformFieldsDialog.TableCol.Comments" ), ColumnInfo.COLUMN_TYPE_TEXT,
          false, true ), };
