...
package org.apache.hop.ui.pipeline.steps.dummy;
...
public class DummyDialog extends BaseStepDialog implements StepDialogInterface {
  private static Class<?> PKG = DummyMeta.class; // for i18n purposes, needed by Translator!!

  private DummyMeta input;

  public DummyDialog( Shell parent, Object in, PipelineMeta tr, String sname ) {
  ...
  public String open() {
    ...
    wlStepname.setText( BaseMessages.getString( PKG, "DummyDialog.Stepname.Label" ) );
