...
public class HopUiBrowser implements TabItemInterface, XulEventHandler {
  ...
  private static final Class<?> PKG = HopUiBrowser.class;
  ...
  public HopUiBrowser( Composite parent, final HopUi hopUi, final String stringUrl, boolean isURL ) throws SWTError {
    this( parent, hopUi, stringUrl, isURL, true, null );
  }

  public HopUiBrowser( Composite parent, final HopUi hopUi, final String stringUrl, boolean isURL,
                       LocationListener listener ) throws SWTError {
    this( parent, hopUi, stringUrl, isURL, true, listener );
  }
