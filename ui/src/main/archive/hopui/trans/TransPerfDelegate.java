...
public class TransPerfDelegate extends HopUiDelegate {
   ...
   * @param transGraph
   */
  public TransPerfDelegate( HopUi hopUi, TransGraph transGraph ) {
    super( hopUi );
  ...
  public void addTransPerf() {
    ...
    hopUi.props.setLook( perfComposite );
  ...
  public void setupContent() {
    ...
    hopUi.props.setLook( dataListLabel );
    FormData fdDataListLabel = new FormData();

    fdDataListLabel.left = new FormAttachment( 0, 0 );
    fdDataListLabel.right = new FormAttachment( hopUi.props.getMiddlePct() / 2, props.getMargin() );
    ...
    fdDataList.right = new FormAttachment( hopUi.props.getMiddlePct() / 2, props.getMargin() );
    ...
    hopUi.props.setLook( stepsListLabel );

    FormData fdStepsListLabel = new FormData();
    fdStepsListLabel.left = new FormAttachment( 0, 0 );
    fdStepsListLabel.right = new FormAttachment( hopUi.props.getMiddlePct() / 2, props.getMargin() );
    ...
    fdStepsList.right = new FormAttachment( hopUi.props.getMiddlePct() / 2, props.getMargin() );
    ...
    hopUi.props.setLook( canvas );
    FormData fdCanvas = new FormData();
    fdCanvas.left = new FormAttachment( hopUi.props.getMiddlePct() / 2, props.getMargin() );
