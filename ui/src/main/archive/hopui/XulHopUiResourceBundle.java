 ...
 * @author nbaker
 */
public class XulHopUiResourceBundle extends ResourceBundle {
  private static Class<?> BASE_PKG = HopUi.class;
  private Class<?> PKG;

  public XulHopUiResourceBundle( final Class<?> PKG ) {
    this.PKG = PKG;
  }

  public XulHopUiResourceBundle() {
    this.PKG = BASE_PKG;
  }
