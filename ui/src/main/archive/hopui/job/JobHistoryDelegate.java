...
public class JobHistoryDelegate extends HopUiDelegate implements XulEventHandler {
  ...
  public void addJobHistory() {
    ...
    jobHistoryTab.setText( BaseMessages.getString( PKG, "HopGui.TransGraph.HistoryTab.Name" ) );
    ...
    hopUi.props.setLook( jobHistoryComposite );
  ...
  private void addLogTableTabs() {
    ...
    hopUi.props.setLook( tabFolder, Props.WIDGET_STYLE_TAB );
  ...
  private void refreshHistory( final int index, final Mode fetchMode ) {
    new Thread( new Runnable() {
      ...
      public void run() {
        // do gui stuff here
        hopUi.getDisplay().syncExec( new Runnable() {
          @Override
          public void run() {
  ...
  class JobHistoryLogTab extends CTabItem {
    ...
    public JobHistoryLogTab( CTabFolder tabFolder, LogTableInterface logTable ) {
      ...
      hopUi.props.setLook( logTableComposite );
      ...
      if ( logTable.getLogField() != null ) {
        ...
        hopUi.props.setLook( logDisplayText );
